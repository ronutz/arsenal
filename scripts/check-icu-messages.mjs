...
const RAW_LITERAL_KEYS = new Set([
  ...
  "tools.do-explainer-validator.inputPlaceholder", // DO JSON sample: literal braces, rendered with t.raw()
  "tools.telemetry-streaming-explainer.inputPlaceholder", // TS JSON sample: literal braces, rendered with t.raw() // AS3 declaration JSON sample: literal braces, rendered with t.raw()
