      ...
      <body>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html:
              "(function(){try{var t=localStorage.getItem('ronutz-theme');if(t&&t!=='obsidian'){document.documentElement.setAttribute('data-theme',t);}var g=localStorage.getItem('ronutz-glossary-hints');if(g==='off'||g==='all'){document.documentElement.setAttribute('data-glossary-hints',g);}}catch(e){}})();",
          }}
        />
