// ============================================================================
// src/app/[locale]/industry/history/page.tsx
// ----------------------------------------------------------------------------
...
// /industry/history/ sub-section (canon D-45). Statically generated per locale.
// ============================================================================
        ...
        <section className="section">
          <div className="container">
            ...
            <ol className="history-eras">
              {ERAS.map((era, i) => (
                <li key={era.slug}>
                  <Link href={`/industry/history/${era.slug}`} className="history-era-card">
