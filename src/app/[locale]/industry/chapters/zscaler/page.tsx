// ============================================================================
// /industry/chapters/zscaler - CAREER CHAPTER
//
// Rodolfo's passage through this company. The company's own history lives at
// /industry/zscaler and is reached from a card below; it is deliberately not
// repeated here.
// ============================================================================
...
export async function generateMetadata({
  ...
  return {
    title: `${t("zscaler.name")} - ${t("careerMetaSuffix")}`,
    description: t("zscaler.tagline"),
  };
}
