...
export const manifest = Object.freeze({
  ...
  sources: [
    ...
    { id: "f5-asm-policy-building", label: "F5 BIG-IP ASM: Changing How a Security Policy is Built (automatic vs manual learning; the system accepts and enforces at a 100% learning score; tighten rules apply only in automatic learning)", url: "https://techdocs.f5.com/en-us/bigip-17-0-0/big-ip-asm-implementations/changing-how-a-security-policy-is-built.html" },
  ],
});
