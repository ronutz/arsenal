...
export const tools: ToolEntry[] = [
  ...
  { id: "ja4-fingerprint-decoder", href: "/tools/ja4-fingerprint-decoder", category: "security", vendors: ["zscaler", "ping"], available: true },
  { id: "ja3-tls-fingerprint", href: "/tools/ja3-tls-fingerprint", category: "security", vendors: ["zscaler", "ping"], available: true },
