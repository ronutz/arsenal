...
export const tools: ToolEntry[] = [
  ...
  { id: "voss-fabric-id", sub: "voss", href: "/tools/voss-fabric-id", category: "networking", vendors: ["extreme"], available: true },
  { id: "voss-exos-translator", sub: "voss", href: "/tools/voss-exos-translator", category: "networking", vendors: ["extreme"], available: true },
  { id: "fortios-cli-config-explainer", sub: "fortigate", href: "/tools/fortios-cli-config-explainer", category: "operations", vendors: ["fortinet"], available: true },
  { id: "fortigate-policy-match-order", sub: "fortigate", href: "/tools/fortigate-policy-match-order", category: "security", vendors: ["fortinet"], available: true },
  { id: "fortios-flow-debug-builder", sub: "fortigate", href: "/tools/fortios-flow-debug-builder", category: "security", vendors: ["fortinet"], available: true },
  { id: "network-os-comparer", sub: "other", href: "/tools/network-os-comparer", category: "operations", vendors: [], available: true },
  { id: "terminal-stack-explainer", sub: "other", href: "/tools/terminal-stack-explainer", category: "operations", vendors: [], available: true },
  { id: "extreme-switch-os-mapper", sub: "extreme", href: "/tools/extreme-switch-os-mapper", category: "operations", vendors: ["extreme"], available: true },
  { id: "fabric-connect-spb-explainer", sub: "extreme", href: "/tools/fabric-connect-spb-explainer", category: "networking", vendors: ["extreme"], available: true },
  { id: "netskope-steering-explainer", sub: "netskope", href: "/tools/netskope-steering-explainer", category: "networking", vendors: ["netskope"], available: true },
  { id: "sse-architecture-explainer", sub: "netskope", href: "/tools/sse-architecture-explainer", category: "security", vendors: ["netskope"], available: true },
  { id: "f5-eth-trailer-decoder", sub: "f5", href: "/tools/f5-eth-trailer-decoder", category: "networking", vendors: ["f5"], available: true },
  { id: "icontrol-rest-stats-decoder", sub: "f5", href: "/tools/icontrol-rest-stats-decoder", category: "networking", vendors: ["f5"], available: true },
  { id: "icontrol-rest-path-explainer", sub: "f5", href: "/tools/icontrol-rest-path-explainer", category: "networking", vendors: ["f5"], available: true },
  ...
  { id: "checkpoint-policy-layer-evaluator", href: "/tools/checkpoint-policy-layer-evaluator", category: "security", vendors: ["checkpoint"], sub: "quantum", available: true },
  { id: "nginx-location-matcher", href: "/tools/nginx-location-matcher", category: "networking", vendors: ["nginx"], sub: "core", available: true },
  { id: "nginx-proxy-pass-rewriter", href: "/tools/nginx-proxy-pass-rewriter", category: "networking", vendors: ["nginx"], sub: "core", available: true },
  { id: "nginx-proxy-cache-decision", href: "/tools/nginx-proxy-cache-decision", category: "networking", vendors: ["nginx"], sub: "core", available: true },
  { id: "extreme-spbm-multicast-mac", href: "/tools/extreme-spbm-multicast-mac", category: "networking", vendors: ["extreme"], sub: "fabric", available: true },
  { id: "checkpoint-nat-proxy-arp", href: "/tools/checkpoint-nat-proxy-arp", category: "security", vendors: ["checkpoint"], sub: "quantum", available: true },
  { id: "netskope-dlp-match-predictor", href: "/tools/netskope-dlp-match-predictor", category: "security", vendors: ["netskope"], sub: "dlp", available: true },
