...
export const BOSS_SCREEN_META: BossScreenMeta[] = [
  ...
  { kind: "tk90x", name: "Microdigital TK90X", year: "1985", blurb: "Brazil's ZX Spectrum clone, where many Brazilians first typed real programs in colour. It boots to its own name: TK90X - Color Computer." },
  { kind: "tk95", name: "Microdigital TK95", year: "1986", blurb: "The TK90X's successor: a Plus/4-style case and a better keyboard. Its only ROM change was the boot line, which now reads TK Color Computer." },
