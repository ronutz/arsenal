...
export const BOSS_SCREEN_META: BossScreenMeta[] = [
  ...
  { kind: "snifferconficker", name: "Sniffer: Conficker (2008)", year: "2008", blurb: "A decoded capture in the Sniffer's three-pane view: a TCP SYN scan to port 445, the SMB flow Conficker rode via MS08-067. Header bytes only, no exploit payload." },
  { kind: "snifferhttp420", name: "Sniffer: HTTP 420 Enhance Your Calm", year: "2009", blurb: "A full HTTP decode in the Sniffer: Twitter's non-standard 420 Enhance your calm rate-limit response, headers and JSON body and all, the way the analyzer would show it." },
  { kind: "snifferiloveyou", name: "Sniffer: ILOVEYOU (2000)", year: "2000", blurb: "An SMTP decode of the LoveLetter worm's mail envelope: the ILOVEYOU subject line and its infamous attachment name. Mail headers only, no script." },
  { kind: "sniffermirai", name: "Sniffer: Mirai (2016)", year: "2016", blurb: "A decoded Telnet session to port 23, the credential-guessing vector the Mirai botnet used against IoT devices. Connection metadata only, no credential list." },
  { kind: "sniffermorris", name: "Sniffer: Morris Worm (1988)", year: "1988", blurb: "A decoded capture showing the fingerd (port 79) and sendmail (port 25) flows the 1988 Internet Worm rode. Protocol headers only, no exploit code." },
  { kind: "snifferpetya", name: "Sniffer: NotPetya (2017)", year: "2017", blurb: "A decoded SMB flow to port 445, the EternalBlue / MS17-010 vector NotPetya shared with WannaCry. Header bytes only, no exploit payload." },
  { kind: "snifferstuxnet", name: "Sniffer: Stuxnet (2010)", year: "2010", blurb: "A decoded SMB print-spooler flow to port 445, one of the vectors (MS10-061) Stuxnet used to reach Siemens WinCC systems. Headers only, no payload." },
  { kind: "snifferwannacry", name: "Sniffer: WannaCry (2017)", year: "2017", blurb: "A decoded SMB flow to port 445, the EternalBlue / MS17-010 vector WannaCry rode across flat networks in May 2017. Header bytes only, no exploit payload." },
