...
export const BOSS_SCREEN_META: BossScreenMeta[] = [
  ...
  { kind: "tk90x", name: "Microdigital TK90X", year: "1985", blurb: "Brazil's ZX Spectrum clone with a tweaked ROM, where many Brazilians (this one's author included) first typed code." },
