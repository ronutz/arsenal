...
// ============================================================================
// src/components/CurlCommandExplainerTool.tsx
// ----------------------------------------------------------------------------
...
import { parseCurl, type KV } from "@/lib/tools/curl-command-explainer";
...
export default function CurlCommandExplainerTool() {
  const t = useTranslations("tools.curl-command-explainer");
