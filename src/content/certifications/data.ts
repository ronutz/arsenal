...
export const instructorAuthorizations: Credential[] = [
  ...
  { name: "Fortinet Certified Trainer (FCT)", issuer: "Fortinet", detail: "Cybersecurity", period: "to 2027", evidence: { pdf: P("fortinet-fct"), credly: C("a3bf6c7b-d24c-476c-8914-d948164dd099") } },
...
export const currentCertifications: Credential[] = [
  { name: "F5 Certified Solution Expert, Security", issuer: "F5", detail: "F5-CSE Security", period: "2022 – 2028", evidence: { pdf: P("f5-cse-security"), credly: C("34f1810f-1bd6-46cb-bde8-4667c726f5d9") } },
  { name: "F5 Certified Solution Expert, Cloud", issuer: "F5", detail: "F5-CSE Cloud", period: "2021 – 2027", evidence: { pdf: P("f5-cse-cloud"), credly: C("39b5961c-6b76-4daf-aef6-1c6baf6fc346") } },
  ...
  { name: "F5 Certified Technology Specialist, BIG-IP ASM", issuer: "F5", detail: "Application Security Manager", period: "2020 – 2028", evidence: { pdf: P("f5-cts-asm"), credly: C("feb68de0-b61c-4174-965d-fc5886d21374"), verifyUrl: F5_VERIFY, verifyId: "HQGHCERC1JF1Q632", candidateId: F5_CANDIDATE } },
  { name: "F5 Certified Technology Specialist, BIG-IP DNS", issuer: "F5", detail: "DNS", period: "2017 – 2027", evidence: { pdf: P("f5-cts-dns"), credly: C("8a429d74-1366-4c5b-ba1c-25c3247b7418"), verifyUrl: F5_VERIFY, verifyId: "QDXKFZGCCFBEQ69Z", candidateId: F5_CANDIDATE } },
  ...
  { name: "Fortinet Certified Professional, Network Security", issuer: "Fortinet", detail: "FCP-NS", period: "2024 – 2026", evidence: { pdf: P("fortinet-fcp-ns"), credly: C("0c227058-ebc9-488f-8362-566ffaf994cd") } },
  { name: "Fortinet Certified Associate, Cybersecurity", issuer: "Fortinet", detail: "FCA", period: "2024 – 2026", evidence: { pdf: P("fortinet-fca"), credly: C("ae612b30-cdfc-4925-a417-b066558f01fe") } },
  { name: "Fortinet Certified Fundamentals, Cybersecurity", issuer: "Fortinet", detail: "FCF", period: "2024 – 2026", evidence: { pdf: P("fortinet-fcf"), credly: C("4eb15e06-d410-4e3d-83ec-f23870ded229") } },
...
export const historical: HistoricalGroup[] = [
  {
    vendor: "F5",
    items: [
      { name: "F5 Certified Technical Professional, Sales (F5-CTP)", issuer: "F5", period: "2019", note: "Expired 2025.", evidence: { pdf: P("f5-ctp-sales"), credly: C("7ba0b660-d06a-42fc-82df-65d8a3629c78") } },
  ...
  },
  {
    ...
    items: [
      { name: "Fortinet Certified Professional, Security Operations", issuer: "Fortinet", detail: "FCP-SO", period: "2024", note: "Expired 2026.", evidence: { pdf: P("fortinet-fcp-so"), credly: C("85a6e67d-6fe7-4c5c-9cc4-3dad553f64d1") } },
      { name: "Fortinet FortiGate 7.4 Administrator", issuer: "Fortinet", period: "2024", evidence: { credly: C("cc71bb44-1e3e-4f1a-bebe-301262152b19") } },
      { name: "Fortinet FortiGate 7.2 Administrator", issuer: "Fortinet", period: "2023", evidence: { credly: C("d99f54c6-ea5b-48c3-af7c-c1e4919cc8b3") } },
      { name: "Fortinet FortiGate 7.4 Operator", issuer: "Fortinet", period: "2023", evidence: { credly: C("b2e0e422-5ec2-4ffe-93b7-cb40f95f4586") } },
      { name: "Fortinet FortiAnalyzer 7.4 Analyst", issuer: "Fortinet", period: "2024", evidence: { credly: C("89818e4f-e0a3-4ecf-b56b-17229b348511") } },
      { name: "Fortinet FortiAnalyzer 7.4 Administrator", issuer: "Fortinet", period: "2024", evidence: { credly: C("0a695156-e4bf-43c9-811e-9ab5bb7971a3") } },
      { name: "Fortinet FortiManager 7.2 Administrator", issuer: "Fortinet", period: "2024", evidence: { credly: C("d4436fa8-46c8-4410-be60-b55936ec8dff") } },
      { name: "Fortinet FortiAuthenticator 6.5 Administrator", issuer: "Fortinet", period: "2024", evidence: { credly: C("a1ae8d56-515a-452c-bcd3-f0c614311859") } },
      { name: "NSE Trainer Assessment, Professional Level 7.4", issuer: "Fortinet", period: "2025", evidence: { credly: C("4c3c0aea-426e-4165-b391-5ea201c0b4e9") } },
      ...
      { name: "Getting Started in Cybersecurity 1.0", issuer: "Fortinet", period: "2022", evidence: { credly: C("13d844c1-9371-403b-a45f-806194c6f026") } },
      { name: "Introduction to the Threat Landscape 1.0", issuer: "Fortinet", period: "2022", evidence: { credly: C("5662c537-2b16-4fbc-8886-1856f4e7acf7") } },
    ],
  },
  {
