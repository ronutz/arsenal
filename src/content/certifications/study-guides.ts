...
export interface StudyGuide {
  ...
  /** Rendered caveat about whether the exam can be sat AT ALL, e.g. Fortinet's
   *  "to be added in Q3 2026" exams which are published in the program
   *  structure but not yet available. This was a source COMMENT until
   *  2026-07-25, which meant a candidate browsing the guide had no way to know
   *  the exam does not exist yet. A caveat that does not render is not a
   *  caveat. Null when the exam is sittable today. */
  availabilityNote?: string | null;
  /** Set when a VERSION of this exam is being withdrawn. PRIME 2026-07-26:
   *  do NOT flag "not yet available" — a candidate prepares regardless — but
   *  DO flag retirement, because a retiring exam has a deadline and usually a
  ...
  /** Set when the VENDOR's own published blueprint is defective and the
   *  transcription had to work around it. Distinct from availabilityNote,
   *  which is about whether the exam can be sat: this is about whether the
   *  objectives below faithfully reflect a sound source. Renders on PUBLISHED
   *  guides, where availabilityNote does not. The explanatory text lives in
   *  i18n so it is localised like everything else. (2026-07-26) */
  sourceCaveat?: "truncated-blueprint" | "course-objectives" | null;
...
export interface Certification {
  ...
  examSlugs: string[];
  /** How the listed exams combine into the credential.
   *  "all"  = every listed exam is required (F5-CA's five; Ping's single-exam
   *           credentials). This is the DEFAULT when omitted, so every
   *           pre-existing certification keeps its current meaning.
   *  "one"  = passing ANY ONE of the listed exams earns the level.
   *  "custom" = neither fits and `requirementNote` carries the whole rule.
   *           NSE 8 is the case: Core practical AND one of three electives,
   *           which is two exams out of four listed. Generating "all 4" there
   *           would contradict the note directly below it. This is the
   *           Fortinet NSE 5/6/7 shape, where a track offers several
   *           product-specific exams and one of them earns the certification.
   *  Getting this wrong would tell a candidate to sit eight exams when one
   *  suffices, so it is modelled explicitly rather than inferred from count. */
  requirementMode?: "all" | "one" | "custom";
  /** Certifications that must be ACTIVE before this one can be earned, as
   *  display strings in the vendor's own wording (e.g. "NSE 4 certification").
   *  Rendered under the certification level per PRIME 2026-07-25. */
  prerequisites?: string[];
  /** Official wording for any requirement the two fields above cannot express,
   *  e.g. NSE 8's "pass the Core practical exam AND one elective". */
...
export const certifications: Certification[] = [
  ...
  },
  {
    ...
    vendor: "checkpoint",
    examSlugs: ["checkpoint-ccas-r8120"],
    prerequisites: [],
    requirementNote:
  ...
  },
  {
    ...
    vendor: "checkpoint",
    examSlugs: ["checkpoint-cccs-r8120"],
    prerequisites: [],
    requirementNote:
      "An Infinity Specialist Accreditation. Valid for two years and not itself extendable, though it may be retaken within six months of expiry for a fresh two-year term. Passed after a valid CCSE it extends that certification by a year; a second one awards the CCSM.",
    renewalNote:
  ...
  },
  {
    ...
    vendor: "checkpoint",
    examSlugs: ["checkpoint-cces-r8120"],
    prerequisites: [],
    requirementNote:
      "An Infinity Specialist Accreditation. Valid for two years and not itself extendable, though it may be retaken within six months of expiry for a fresh two-year term. Passed after a valid CCSE it extends that certification by a year; a second one awards the CCSM.",
    renewalNote:
  ...
  },
  {
    ...
    vendor: "checkpoint",
    requirementMode: "one",
    examSlugs: ["checkpoint-ccta-r82", "checkpoint-ccta-r8120"],
  ...
  },
  {
    ...
    vendor: "checkpoint",
    requirementMode: "one",
    examSlugs: ["checkpoint-ccte-r82", "checkpoint-ccte-r8120"],
  ...
  },
  {
    key: "fortinet-nse-1",
    code: "NSE 1",
    name: "NSE 1: Cybersecurity",
    vendor: "fortinet",
    examSlugs: [
      "fortinet-nse-1-cybersecurity-cloud-fundamentals",
    ],
    requirementMode: "all",
    requirementNote:
      "Complete the online course and test.",
    renewalNote:
      "Valid two years. Automatically renewed by earning NSE 2 through NSE 8.",
    sourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=nse_1",
  },
  {
    key: "fortinet-nse-2",
    code: "NSE 2",
    name: "NSE 2: Cybersecurity",
    vendor: "fortinet",
    examSlugs: [
      "fortinet-nse-2-intro-ngfw",
    ],
    requirementMode: "all",
    requirementNote:
      "Complete the online course and test.",
    renewalNote:
      "Valid two years. Renews NSE 1. Automatically renewed by earning NSE 3 or above.",
    sourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=nse_2",
  },
  {
    key: "fortinet-nse-3",
    code: "NSE 3",
    name: "NSE 3: Cybersecurity",
    vendor: "fortinet",
    examSlugs: [
      "fortinet-nse-3-fortigate-operator",
    ],
    requirementMode: "all",
    requirementNote:
      "Complete the online course AND pass the online exam.",
    renewalNote:
      "Valid two years. Renews NSE 1 and NSE 2.",
    sourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=nse_3",
  },
  {
    key: "fortinet-nse-4",
    code: "NSE 4",
    ...
    requirementMode: "all",
    requirementNote:
      "Pass the NSE 4 proctored exam. No prerequisite certifications.",
    renewalNote:
      "Valid two years. Renews NSE 1, 2 and 3.",
    sourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=nse_4",
  },
  {
    ...
    vendor: "fortinet",
    examSlugs: [
      "fortinet-nse-5-fortiswitch-administrator",
      "fortinet-nse-5-sdwan-core-administrator",
      "fortinet-nse-5-secure-wireless-lan-administrator",
    ],
    requirementMode: "one",
    prerequisites: ["NSE 4 certification"],
    requirementNote:
      "Pass ONE of the NSE 5 Secure Networking proctored exams.",
    renewalNote:
      "Valid two years. Renews NSE 1, 2 and 3.",
    sourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=nse_5_secure_networking",
  },
  {
    ...
    vendor: "fortinet",
    examSlugs: [
      "fortinet-nse-5-sase-sdwan-core-administrator",
    ],
    requirementMode: "all",
    prerequisites: ["NSE 4 certification"],
    requirementNote:
      "Pass the NSE 5 SASE proctored exam.",
    renewalNote:
      "Valid two years. Renews NSE 1, 2 and 3.",
    sourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=nse_5_sase",
  },
  {
    ...
    vendor: "fortinet",
    examSlugs: [
      "fortinet-nse-5-fortiappsec-administrator",
      "fortinet-nse-5-fortiadc-administrator",
      "fortinet-nse-5-fortiweb-administrator",
    ],
    requirementMode: "one",
    prerequisites: ["NSE 4 certification"],
    requirementNote:
      "Pass ONE of the NSE 5 Cloud Security proctored exams.",
    renewalNote:
      "Valid two years. Renews NSE 1, 2 and 3.",
    sourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=nse_5_cloud_security",
  },
  {
    ...
    prerequisites: ["NSE 4 certification"],
    requirementNote:
      "Pass the NSE 5 Security Operations proctored exam.",
    renewalNote:
      "Valid two years. Renews NSE 1, 2 and 3.",
    sourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=nse_5_security_operations",
  },
  {
    ...
    examSlugs: [
      ...
      "fortinet-nse-6-fortimanager-administrator",
      "fortinet-nse-6-fortinac-administrator",
      "fortinet-nse-6-fortivoice-administrator",
    ],
    requirementMode: "one",
    prerequisites: ["NSE 4 certification"],
    requirementNote:
      "Pass ONE of the NSE 6 Secure Networking proctored exams.",
    renewalNote:
      "Valid two years. Renews NSE 1, 2 and 3.",
    sourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=nse_6_secure_networking",
  },
  {
    ...
    vendor: "fortinet",
    examSlugs: [
      "fortinet-nse-6-forticlient-ems-administrator",
      "fortinet-nse-6-fortidlp-administrator",
      "fortinet-nse-6-fortiedr-administrator",
    ],
    requirementMode: "one",
    prerequisites: ["NSE 4 certification"],
    requirementNote:
      "Pass ONE of the NSE 6 SASE proctored exams.",
    renewalNote:
      "Valid two years. Renews NSE 1, 2 and 3.",
    sourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=nse_6_sase",
  },
  {
    ...
    vendor: "fortinet",
    examSlugs: [
      "fortinet-nse-6-forticnapp-analyst",
      "fortinet-nse-6-fortiddos-administrator",
      "fortinet-nse-6-fortimail-administrator",
      "fortinet-nse-6-fortimail-workspace-administrator",
    ],
    requirementMode: "one",
    prerequisites: ["NSE 4 certification"],
    requirementNote:
      "Pass ONE of the NSE 6 Cloud Security proctored exams.",
    renewalNote:
      "Valid two years. Renews NSE 1, 2 and 3.",
    sourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=nse_6_cloud_security",
  },
  {
    ...
    vendor: "fortinet",
    examSlugs: [
      "fortinet-nse-6-fortideceptor-administrator",
      "fortinet-nse-6-fortindr-cloud-analyst",
      "fortinet-nse-6-fortirecon-analyst",
      "fortinet-nse-6-fortisiem-analyst",
      "fortinet-nse-6-fortisoar-analyst",
    ],
    requirementMode: "one",
    prerequisites: ["NSE 4 certification"],
    requirementNote:
      "Pass ONE of the NSE 6 Security Operations proctored exams.",
    renewalNote:
      "Valid two years. Renews NSE 1, 2 and 3.",
    sourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=nse_6_security_operations",
  },
  {
    ...
    requirementMode: "all",
    prerequisites: ["NSE 4 certification", "NSE 5 or NSE 6 certification in Secure Networking"],
    requirementNote:
      "Pass the NSE 7 Secure Networking proctored exam.",
    renewalNote:
      "Valid two years. Renews NSE 1, 2, 3, 4, and NSE 5 and 6 in the same track.",
    sourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=nse_7_secure_networking",
  },
  {
    ...
    vendor: "fortinet",
    examSlugs: [
      "fortinet-nse-7-sase-architect",
    ],
    requirementMode: "all",
    prerequisites: ["NSE 4 certification", "NSE 5 or NSE 6 certification in SASE"],
    requirementNote:
      "Pass the NSE 7 SASE proctored exam.",
    renewalNote:
      "Valid two years. Renews NSE 1, 2, 3, 4, and NSE 5 and 6 in the same track.",
    sourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=nse_7_sase",
  },
  {
    ...
    vendor: "fortinet",
    examSlugs: [
      "fortinet-nse-7-public-cloud-security-architect",
    ],
    requirementMode: "all",
    prerequisites: ["NSE 4 certification", "NSE 5 or NSE 6 certification in Cloud Security"],
    requirementNote:
      "Pass the NSE 7 Cloud Security proctored exam.",
    renewalNote:
      "Valid two years. Renews NSE 1, 2, 3, 4, and NSE 5 and 6 in the same track.",
    sourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=nse_7_cloud_security",
  },
  {
    ...
    requirementMode: "all",
    prerequisites: ["NSE 5 or NSE 6 certification in Security Operations"],
    requirementNote:
      "Pass the NSE 7 Security Operations proctored exam. Fortinet's certification table lists only the NSE 5 or NSE 6 prerequisite for this track, without the NSE 4 requirement shown on the other three; transcribed as published.",
    renewalNote:
      "Valid two years. Renews NSE 1, 2, 3, 4, and NSE 5 and 6 in the same track.",
    sourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=nse_7_security_operations",
  },
  {
    key: "fortinet-nse-8",
    code: "NSE 8",
    ...
    examSlugs: [
      ...
      "fortinet-nse-8-application-security",
      "fortinet-nse-8-security-operations",
    ],
    requirementMode: "custom",
    prerequisites: ["NSE 4 certification", "NSE 5 or NSE 6 certification", "NSE 7 certification (same track as the NSE 5 or NSE 6)"],
    requirementNote:
      "Pass the NSE 8 core exam AND pass one of the NSE 8 elective exams.",
    renewalNote:
      "Valid two years, renewed by accumulating activity points. Passing any NSE 8 practical exam renews all active NSE 1 to 7 certifications.",
    sourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=nse_8",
  },
  {
    key: "fortinet-industry-mssp-security",
    code: "MSSP Security",
    name: "Industry Certification: MSSP Security",
    vendor: "fortinet",
    examSlugs: [
      "fortinet-industry-mssp-security-administrator",
    ],
    requirementMode: "all",
    prerequisites: ["NSE 4 certification", "NSE 5 or NSE 6 certification", "NSE 7 certification (same track as the NSE 5 or NSE 6)"],
    requirementNote:
      "Pass the proctored exam. Sits outside the eight-level structure.",
    renewalNote:
      "Valid two years. Does not renew other certifications.",
    sourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=nse_mssp_security",
  },
  {
    key: "fortinet-industry-ot-security",
    code: "OT Security",
    name: "Industry Certification: OT Security",
    vendor: "fortinet",
    examSlugs: [
      "fortinet-industry-ot-security-administrator",
    ],
    requirementMode: "all",
    prerequisites: ["NSE 4 certification", "NSE 5 or NSE 6 certification", "NSE 7 certification (same track as the NSE 5 or NSE 6)"],
    requirementNote:
    ...
    renewalNote:
      "Valid two years. Does not renew other certifications.",
    sourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=nse_ot_security",
  },
];
...
export const studyGuides: StudyGuide[] = [
    ...
    sections: [
      {
        ...
        objectives: [
          ...
          },
          {
            ...
            relatedTools: ["ldap-filter-explainer", "curl-command-builder", "curl-command-explainer"],
            manualLinks: [],
            keyPoints: [
    ...
    sections: [
      ...
      { id: "int-mgmt", title: "Netskope Platform Management", objectives: [
          ...
          },
          {
            ...
            relatedArticles: ["http-methods-the-verbs", "http-status-codes-the-five-families"],
            relatedTools: ["curl-command-explainer", "http-status-code-explainer"],
            manualLinks: [],
            keyPoints: [],
          },
        ],
  ...
  {
    slug: "fortinet-nse-1-cybersecurity-cloud-fundamentals",
    examCode: "NSE 1",
    examName: "Cybersecurity and Cloud Fundamentals",
    vendor: "fortinet",
    certification: "fortinet-nse-1",
    targetVersion: null,
    blueprintSourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=library_cybersecurity-and-cloud-fundamentals",
    blueprintSourceLabel: "Fortinet Training Institute course page (course objectives)",
    status: "published",
    sourceCaveat: "course-objectives",
    examFacts: null,
    sections: [
      ...
      {
        id: "1.01",
        text: "Identify the types of bad actors, their methods, and countermeasures used against them",
        relatedArticles: ["fortinet-soc-architecture-and-adversary-behaviour"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.02",
        text: "Explain how to secure a network using cryptography and effective endpoint security",
        relatedArticles: ["fortinet-ssl-inspection-modes", "forticlient-ems-endpoint-security-ztna-and-troubleshooting"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.03",
        text: "List ways to secure any type of endpoint using authentication and host hardening techniques",
        relatedArticles: ["forticlient-ems-architecture-and-deployment", "fortigate-authentication-and-fsso"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.04",
        text: "Explain how secure network models and technologies like Firewalls, Web Application Firewalls, and Network Access Control can enhance cybersecurity",
        relatedArticles: ["fortigate-firewall-policy-and-nat", "fortiweb-deployment-policies-and-delivery", "fortinac-device-modeling-and-profiling"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.05",
        text: "Describe the differences involved in securing physical on-premises, virtual, and cloud computing networks and endpoints",
  ...
  {
    slug: "fortinet-nse-2-intro-ngfw",
    examCode: "NSE 2",
    examName: "Introduction to Next Generation Firewall",
    vendor: "fortinet",
    certification: "fortinet-nse-2",
    targetVersion: null,
    blueprintSourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=library_introduction-to-next-generation-firewall",
    blueprintSourceLabel: "Fortinet Training Institute course page (course objectives)",
    status: "published",
    sourceCaveat: "course-objectives",
    examFacts: null,
    sections: [
      ...
      {
        id: "1.01",
        text: "Describe what a Next Generation Firewall is and how it is used to protect networks, applications, and services",
        relatedArticles: ["fortigate-firewall-policy-and-nat"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.02",
        text: "Explain how the main features of a Next Generation Firewall work",
        relatedArticles: ["fortigate-security-profiles-flow-vs-proxy", "fortinet-ssl-inspection-modes"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.03",
        text: "Explain how secure network models and technologies like SD-WAN and SASE can enhance cybersecurity",
        relatedArticles: ["fortigate-routing-and-sdwan-selection", "fortigate-cloud-deployments-and-fortisase"],
        relatedTools: [],
        manualLinks: [],
      },
        ],
  ...
  {
    slug: "fortinet-nse-3-fortigate-operator",
    examCode: "NSE 3",
    examName: "FortiGate Operator",
    vendor: "fortinet",
    certification: "fortinet-nse-3",
    targetVersion: null,
    blueprintSourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=library_fortigate-operator",
    blueprintSourceLabel: "Fortinet Training Institute course page (course objectives)",
    status: "published",
    sourceCaveat: "course-objectives",
    examFacts: null,
    sections: [
      ...
      {
        id: "1.01",
        text: "Configure the most common and high-level features on FortiGate devices",
      ...
      {
        id: "1.02",
        text: "Connect remote users to the corporate network securely using VPNs",
        relatedArticles: ["fortigate-ipsec-vpn-topologies"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.03",
        text: "Restrict access to network resources",
        relatedArticles: ["fortigate-firewall-policy-and-nat", "fortigate-authentication-and-fsso"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.04",
        text: "Monitor essential indicators and logs on FortiGate devices",
        relatedArticles: ["fortigate-logging-and-diagnostics"],
        relatedTools: ["fortigate-session-table-explainer"],
        manualLinks: [],
      },
      {
        id: "1.05",
        text: "Perform basic system maintenance",
        relatedArticles: ["fortigate-initial-configuration-and-operation-modes", "fortigate-logging-and-diagnostics"],
        relatedTools: [],
        manualLinks: [],
      },
        ],
  ...
  {
    slug: "fortinet-nse-4-fortios-administrator",
    examCode: "NSE 4",
    examName: "FortiOS Administrator",
    vendor: "fortinet",
    certification: "fortinet-nse-4",
    targetVersion: "FortiOS 7.6.0",
    blueprintSourceUrl:
      "https://training.fortinet.com/local/staticpage/view.php?page=fortios_administrator_exam",
    blueprintSourceLabel:
      "Fortinet Training Institute, FortiOS Administrator Exam page (objectives transcribed verbatim 2026-07-25)",
    status: "published",
    examFacts: {
      questions: "50–55 questions",
      minutes: 90,
      passMark: "Pass or fail. A score report is available from your Pearson VUE account.",
      cost: "See Pearson VUE for current pricing",
      note: "Time allowed: 80–90 minutes. Language: English and Japanese. Product version: FortiOS 7.6.0.",
    },
    sections: [
      {
        id: "section-1",
        title: "Deployment and system configuration (20–25% of the exam)",
        objectives: [
      {
        id: "1.01",
        text: "Perform initial configuration",
        relatedArticles: ["fortigate-initial-configuration-and-operation-modes"],
        relatedTools: [],
        manualLinks: [{ label: "FortiOS 7.6.0—Administration Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.0/administration-guide", version: null }, { label: "FortiOS 7.6.0—New Features", url: "https://docs.fortinet.com/document/fortigate/7.6.0/new-features", version: null }, { label: "FortiSASE—Administration Guide", url: "https://docs.fortinet.com/document/fortisase/latest/mature-administration-guide", version: null }, { label: "FortiGate CNF—Administration Guide", url: "https://docs.fortinet.com/document/fortigate-cnf/latest/administration-guide ", version: null }],
      },
      {
        id: "1.02",
        text: "Configure log settings and diagnose problems using the logs",
        relatedArticles: ["fortigate-logging-and-diagnostics"],
        relatedTools: ["fortigate-session-table-explainer"],
        manualLinks: [{ label: "FortiOS 7.6.0—Administration Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.0/administration-guide", version: null }, { label: "FortiOS 7.6.0—New Features", url: "https://docs.fortinet.com/document/fortigate/7.6.0/new-features", version: null }, { label: "FortiSASE—Administration Guide", url: "https://docs.fortinet.com/document/fortisase/latest/mature-administration-guide", version: null }, { label: "FortiGate CNF—Administration Guide", url: "https://docs.fortinet.com/document/fortigate-cnf/latest/administration-guide ", version: null }],
      },
      {
        id: "1.03",
        text: "Configure FortiGate Clustering Protocol (FGCP) high-availability (HA) cluster",
        relatedArticles: ["fortigate-fgcp-ha-clustering"],
        relatedTools: ["fortigate-ha-failover-simulator"],
        manualLinks: [{ label: "FortiOS 7.6.0—Administration Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.0/administration-guide", version: null }, { label: "FortiOS 7.6.0—New Features", url: "https://docs.fortinet.com/document/fortigate/7.6.0/new-features", version: null }, { label: "FortiSASE—Administration Guide", url: "https://docs.fortinet.com/document/fortisase/latest/mature-administration-guide", version: null }, { label: "FortiGate CNF—Administration Guide", url: "https://docs.fortinet.com/document/fortigate-cnf/latest/administration-guide ", version: null }],
      },
      {
        id: "1.04",
        text: "Diagnose resource and connectivity problems",
        relatedArticles: ["fortigate-logging-and-diagnostics"],
      ...
      {
        id: "1.05",
        text: "Describe FortiGate Cloud-Native Firewall (CNF) and FortiGate VMs in the public cloud",
        relatedArticles: ["fortigate-cloud-deployments-and-fortisase"],
        relatedTools: [],
        manualLinks: [{ label: "FortiOS 7.6.0—Administration Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.0/administration-guide", version: null }, { label: "FortiOS 7.6.0—New Features", url: "https://docs.fortinet.com/document/fortigate/7.6.0/new-features", version: null }, { label: "FortiSASE—Administration Guide", url: "https://docs.fortinet.com/document/fortisase/latest/mature-administration-guide", version: null }, { label: "FortiGate CNF—Administration Guide", url: "https://docs.fortinet.com/document/fortigate-cnf/latest/administration-guide ", version: null }],
      },
      {
        id: "1.06",
        text: "Explain FortiSASE administration and user onboarding methods",
        relatedArticles: ["fortigate-cloud-deployments-and-fortisase"],
        relatedTools: [],
        manualLinks: [{ label: "FortiOS 7.6.0—Administration Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.0/administration-guide", version: null }, { label: "FortiOS 7.6.0—New Features", url: "https://docs.fortinet.com/document/fortigate/7.6.0/new-features", version: null }, { label: "FortiSASE—Administration Guide", url: "https://docs.fortinet.com/document/fortisase/latest/mature-administration-guide", version: null }, { label: "FortiGate CNF—Administration Guide", url: "https://docs.fortinet.com/document/fortigate-cnf/latest/administration-guide ", version: null }],
      },
      ...
      {
        id: "section-2",
        title: "Firewall policies and authentication (20–25% of the exam)",
        objectives: [
      {
        id: "2.01",
        text: "Configure firewall policies",
        relatedArticles: ["fortigate-firewall-policy-and-nat"],
      ...
      {
        id: "2.02",
        text: "Configure source network address translation (SNAT) and destination network address translation (DNAT) options in firewall policies",
        relatedArticles: ["fortigate-firewall-policy-and-nat"],
        relatedTools: ["fortigate-policy-lookup-explainer"],
        manualLinks: [{ label: "FortiOS 7.6.0—Administration Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.0/administration-guide", version: null }, { label: "FortiOS 7.6.0—New Features", url: "https://docs.fortinet.com/document/fortigate/7.6.0/new-features", version: null }, { label: "FortiSASE—Administration Guide", url: "https://docs.fortinet.com/document/fortisase/latest/mature-administration-guide", version: null }, { label: "FortiGate CNF—Administration Guide", url: "https://docs.fortinet.com/document/fortigate-cnf/latest/administration-guide ", version: null }],
      },
      {
        id: "2.03",
        text: "Configure different methods of firewall authentication",
        relatedArticles: ["fortigate-authentication-and-fsso"],
        relatedTools: [],
        manualLinks: [{ label: "FortiOS 7.6.0—Administration Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.0/administration-guide", version: null }, { label: "FortiOS 7.6.0—New Features", url: "https://docs.fortinet.com/document/fortigate/7.6.0/new-features", version: null }, { label: "FortiSASE—Administration Guide", url: "https://docs.fortinet.com/document/fortisase/latest/mature-administration-guide", version: null }, { label: "FortiGate CNF—Administration Guide", url: "https://docs.fortinet.com/document/fortigate-cnf/latest/administration-guide ", version: null }],
      },
      {
        id: "2.04",
        text: "Explain how to deploy and configure Fortinet Single Sign-On (FSSO)",
        relatedArticles: ["fortigate-authentication-and-fsso"],
        relatedTools: [],
        manualLinks: [{ label: "FortiOS 7.6.0—Administration Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.0/administration-guide", version: null }, { label: "FortiOS 7.6.0—New Features", url: "https://docs.fortinet.com/document/fortigate/7.6.0/new-features", version: null }, { label: "FortiSASE—Administration Guide", url: "https://docs.fortinet.com/document/fortisase/latest/mature-administration-guide", version: null }, { label: "FortiGate CNF—Administration Guide", url: "https://docs.fortinet.com/document/fortigate-cnf/latest/administration-guide ", version: null }],
      },
      ...
      {
        id: "section-3",
        title: "Content inspection (25–30% of the exam)",
        objectives: [
      {
        id: "3.01",
        text: "Explain and inspect encrypted traffic using certificates",
        relatedArticles: ["fortinet-ssl-inspection-modes", "fortigate-security-profiles-flow-vs-proxy", "fortigate-acme-certificate-automation"],
        relatedTools: ["fortigate-security-profile-coverage-checker"],
        manualLinks: [{ label: "FortiOS 7.6.0—Administration Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.0/administration-guide", version: null }, { label: "FortiOS 7.6.0—New Features", url: "https://docs.fortinet.com/document/fortigate/7.6.0/new-features", version: null }, { label: "FortiSASE—Administration Guide", url: "https://docs.fortinet.com/document/fortisase/latest/mature-administration-guide", version: null }, { label: "FortiGate CNF—Administration Guide", url: "https://docs.fortinet.com/document/fortigate-cnf/latest/administration-guide ", version: null }],
      },
      {
        id: "3.02",
        text: "Identify FortiGate inspection modes and configure web filtering",
        relatedArticles: ["fortigate-security-profiles-flow-vs-proxy", "fortinet-ssl-inspection-modes"],
        relatedTools: ["fortigate-security-profile-coverage-checker"],
        manualLinks: [{ label: "FortiOS 7.6.0—Administration Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.0/administration-guide", version: null }, { label: "FortiOS 7.6.0—New Features", url: "https://docs.fortinet.com/document/fortigate/7.6.0/new-features", version: null }, { label: "FortiSASE—Administration Guide", url: "https://docs.fortinet.com/document/fortisase/latest/mature-administration-guide", version: null }, { label: "FortiGate CNF—Administration Guide", url: "https://docs.fortinet.com/document/fortigate-cnf/latest/administration-guide ", version: null }],
      },
      {
        id: "3.03",
        text: "Configure application control to monitor and control network applications",
        relatedArticles: ["fortigate-security-profiles-flow-vs-proxy"],
        relatedTools: ["fortigate-security-profile-coverage-checker"],
        manualLinks: [{ label: "FortiOS 7.6.0—Administration Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.0/administration-guide", version: null }, { label: "FortiOS 7.6.0—New Features", url: "https://docs.fortinet.com/document/fortigate/7.6.0/new-features", version: null }, { label: "FortiSASE—Administration Guide", url: "https://docs.fortinet.com/document/fortisase/latest/mature-administration-guide", version: null }, { label: "FortiGate CNF—Administration Guide", url: "https://docs.fortinet.com/document/fortigate-cnf/latest/administration-guide ", version: null }],
      },
      {
        id: "3.04",
        text: "Configure antivirus scanning modes to neutralize malware threats",
        relatedArticles: ["fortigate-security-profiles-flow-vs-proxy"],
        relatedTools: ["fortigate-security-profile-coverage-checker"],
        manualLinks: [{ label: "FortiOS 7.6.0—Administration Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.0/administration-guide", version: null }, { label: "FortiOS 7.6.0—New Features", url: "https://docs.fortinet.com/document/fortigate/7.6.0/new-features", version: null }, { label: "FortiSASE—Administration Guide", url: "https://docs.fortinet.com/document/fortisase/latest/mature-administration-guide", version: null }, { label: "FortiGate CNF—Administration Guide", url: "https://docs.fortinet.com/document/fortigate-cnf/latest/administration-guide ", version: null }],
      },
      {
        id: "3.05",
        text: "Configure an intrusion prevention system (IPS) to protect a network from threats and vulnerabilities",
        relatedArticles: ["fortigate-security-profiles-flow-vs-proxy"],
        relatedTools: ["fortigate-security-profile-coverage-checker"],
        manualLinks: [{ label: "FortiOS 7.6.0—Administration Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.0/administration-guide", version: null }, { label: "FortiOS 7.6.0—New Features", url: "https://docs.fortinet.com/document/fortigate/7.6.0/new-features", version: null }, { label: "FortiSASE—Administration Guide", url: "https://docs.fortinet.com/document/fortisase/latest/mature-administration-guide", version: null }, { label: "FortiGate CNF—Administration Guide", url: "https://docs.fortinet.com/document/fortigate-cnf/latest/administration-guide ", version: null }],
      },
      ...
      {
        id: "section-4",
        title: "Routing (10–15% of the exam)",
        objectives: [
      {
        id: "4.01",
        text: "Configure and route packets using static routes",
        relatedArticles: ["fortigate-routing-and-sdwan-selection"],
        relatedTools: ["fortigate-route-selection-explainer"],
        manualLinks: [{ label: "FortiOS 7.6.0—Administration Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.0/administration-guide", version: null }, { label: "FortiOS 7.6.0—New Features", url: "https://docs.fortinet.com/document/fortigate/7.6.0/new-features", version: null }, { label: "FortiSASE—Administration Guide", url: "https://docs.fortinet.com/document/fortisase/latest/mature-administration-guide", version: null }, { label: "FortiGate CNF—Administration Guide", url: "https://docs.fortinet.com/document/fortigate-cnf/latest/administration-guide ", version: null }],
      },
      {
        id: "4.02",
        text: "Configure SD-WAN to load balance traffic between multiple WAN links effectively",
        relatedArticles: ["fortigate-routing-and-sdwan-selection"],
        relatedTools: ["fortigate-route-selection-explainer"],
        manualLinks: [{ label: "FortiOS 7.6.0—Administration Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.0/administration-guide", version: null }, { label: "FortiOS 7.6.0—New Features", url: "https://docs.fortinet.com/document/fortigate/7.6.0/new-features", version: null }, { label: "FortiSASE—Administration Guide", url: "https://docs.fortinet.com/document/fortisase/latest/mature-administration-guide", version: null }, { label: "FortiGate CNF—Administration Guide", url: "https://docs.fortinet.com/document/fortigate-cnf/latest/administration-guide ", version: null }],
      },
      ...
      {
        id: "section-5",
        title: "VPNs (10–15% of the exam)",
        objectives: [
      {
        id: "5.01",
        text: "Implement a meshed or partially redundant IPsec VPN",
        relatedArticles: ["fortigate-ipsec-vpn-topologies"],
  ...
  {
    slug: "fortinet-nse-5-fortiswitch-administrator",
    examCode: "NSE 5",
    examName: "FortiSwitch Administrator",
    vendor: "fortinet",
    certification: "fortinet-nse-5-secure-networking",
    targetVersion: "FortiSwitchOS 7.6, FortiOS 7.6",
    blueprintSourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=fortiswitch_administrator_exam",
    blueprintSourceLabel: "Fortinet NSE Certification Program, effective 15 July 2026",
    status: "published",
    examFacts: {
      ...
      passMark: "Pass or fail. A score report is available from your Pearson VUE account.",
      cost: "See Pearson VUE for current pricing",
      note: "Time allowed: 60-70 minutes. Language: English and Japanese. Product version: FortiSwitchOS 7.6, FortiOS 7.6.",
    },
    sections: [
      {
        id: "section-1",
        title: "FortiSwitch concepts",
        objectives: [
      {
        id: "1.01",
        text: "Configure VLANs using FortiSwitch",
        relatedArticles: ["fortiswitch-vlans-stp-ports-and-qos"],
        relatedTools: [],
        manualLinks: [{ label: "FortiSwitch 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortiswitchos-administration-guide", version: null }, { label: "FortiLink Guide 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortilink-guide", version: null }, { label: "FortiSwitchOS 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortiswitchos-cli-reference ", version: null }],
      },
      {
        id: "1.02",
        text: "Use QoS and LLDP-MED on FortiSwitch",
        relatedArticles: ["fortiswitch-vlans-stp-ports-and-qos"],
        relatedTools: [],
        manualLinks: [{ label: "FortiSwitch 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortiswitchos-administration-guide", version: null }, { label: "FortiLink Guide 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortilink-guide", version: null }, { label: "FortiSwitchOS 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortiswitchos-cli-reference ", version: null }],
      },
      {
        id: "1.03",
        text: "Configure the ports required for stack deployment",
        relatedArticles: ["fortiswitch-fortilink-provisioning-and-topologies"],
        relatedTools: [],
        manualLinks: [{ label: "FortiSwitch 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortiswitchos-administration-guide", version: null }, { label: "FortiLink Guide 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortilink-guide", version: null }, { label: "FortiSwitchOS 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortiswitchos-cli-reference ", version: null }],
      },
      {
        id: "1.04",
        text: "Configure switching and routing on FortiSwitch",
        relatedArticles: ["fortigate-routing-and-sdwan-selection"],
        relatedTools: ["fortigate-route-selection-explainer"],
        manualLinks: [{ label: "FortiSwitch 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortiswitchos-administration-guide", version: null }, { label: "FortiLink Guide 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortilink-guide", version: null }, { label: "FortiSwitchOS 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortiswitchos-cli-reference ", version: null }],
      },
      {
        id: "1.05",
        text: "Configure STP to prevent network loops",
        relatedArticles: ["fortiswitch-vlans-stp-ports-and-qos"],
        relatedTools: [],
        manualLinks: [{ label: "FortiSwitch 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortiswitchos-administration-guide", version: null }, { label: "FortiLink Guide 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortilink-guide", version: null }, { label: "FortiSwitchOS 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortiswitchos-cli-reference ", version: null }],
      },
      {
        id: "1.06",
        text: "Configure switch ports, split port, and available transceivers",
        relatedArticles: ["fortiswitch-vlans-stp-ports-and-qos"],
        relatedTools: [],
        manualLinks: [{ label: "FortiSwitch 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortiswitchos-administration-guide", version: null }, { label: "FortiLink Guide 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortilink-guide", version: null }, { label: "FortiSwitchOS 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortiswitchos-cli-reference ", version: null }],
      },
      ...
      {
        id: "2.01",
        text: "Configure and provision FortiSwitch",
        relatedArticles: ["fortiswitch-fortilink-provisioning-and-topologies"],
        relatedTools: [],
        manualLinks: [{ label: "FortiSwitch 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortiswitchos-administration-guide", version: null }, { label: "FortiLink Guide 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortilink-guide", version: null }, { label: "FortiSwitchOS 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortiswitchos-cli-reference ", version: null }],
      },
      {
        id: "2.02",
        text: "Deploy FortiSwitch supported deployment topologies",
        relatedArticles: ["fortiswitch-fortilink-provisioning-and-topologies"],
        relatedTools: [],
        manualLinks: [{ label: "FortiSwitch 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortiswitchos-administration-guide", version: null }, { label: "FortiLink Guide 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortilink-guide", version: null }, { label: "FortiSwitchOS 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortiswitchos-cli-reference ", version: null }],
      },
      {
        id: "2.03",
        text: "Deploy and configure FortiSwitch in a multi-tenancy environment",
        relatedArticles: ["fortiswitch-fortilink-provisioning-and-topologies"],
        relatedTools: [],
        manualLinks: [{ label: "FortiSwitch 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortiswitchos-administration-guide", version: null }, { label: "FortiLink Guide 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortilink-guide", version: null }, { label: "FortiSwitchOS 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortiswitchos-cli-reference ", version: null }],
      },
      ...
      {
        id: "section-3",
        title: "Layer 2 control and security",
        objectives: [
      {
        id: "3.01",
        text: "Use port security options on FortiSwitch",
        relatedArticles: ["fortiswitch-port-security-and-diagnostics"],
        relatedTools: [],
        manualLinks: [{ label: "FortiSwitch 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortiswitchos-administration-guide", version: null }, { label: "FortiLink Guide 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortilink-guide", version: null }, { label: "FortiSwitchOS 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortiswitchos-cli-reference ", version: null }],
      },
      {
        id: "3.02",
        text: "Use filtering and antispoofing techniques on FortiSwitch",
        relatedArticles: ["fortiswitch-port-security-and-diagnostics"],
        relatedTools: [],
        manualLinks: [{ label: "FortiSwitch 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortiswitchos-administration-guide", version: null }, { label: "FortiLink Guide 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortilink-guide", version: null }, { label: "FortiSwitchOS 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortiswitchos-cli-reference ", version: null }],
      },
      {
        id: "3.03",
        text: "Use ACLs, security profiles, and VLAN security mechanisms on FortiSwitch",
        relatedArticles: ["fortigate-security-profiles-flow-vs-proxy"],
        relatedTools: ["fortigate-security-profile-coverage-checker"],
        manualLinks: [{ label: "FortiSwitch 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortiswitchos-administration-guide", version: null }, { label: "FortiLink Guide 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortilink-guide", version: null }, { label: "FortiSwitchOS 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortiswitchos-cli-reference ", version: null }],
      },
      ...
      {
        id: "4.01",
        text: "Use packet capturing methods to monitor and troubleshoot traffic issues",
        relatedArticles: ["reading-a-fortigate-sniffer-trace"],
        relatedTools: ["fortios-sniffer-builder"],
        manualLinks: [{ label: "FortiSwitch 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortiswitchos-administration-guide", version: null }, { label: "FortiLink Guide 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortilink-guide", version: null }, { label: "FortiSwitchOS 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortiswitchos-cli-reference ", version: null }],
      },
      {
        id: "4.02",
        text: "Troubleshoot FortiLink issues",
        relatedArticles: ["fortiswitch-fortilink-provisioning-and-topologies"],
        relatedTools: [],
        manualLinks: [{ label: "FortiSwitch 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortiswitchos-administration-guide", version: null }, { label: "FortiLink Guide 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortilink-guide", version: null }, { label: "FortiSwitchOS 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortiswitchos-cli-reference ", version: null }],
      },
      {
        id: "4.03",
        text: "Use tools to view and extract network information from FortiSwitch",
        relatedArticles: ["fortiswitch-port-security-and-diagnostics"],
        relatedTools: ["fortios-sniffer-builder"],
        manualLinks: [{ label: "FortiSwitch 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortiswitchos-administration-guide", version: null }, { label: "FortiLink Guide 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortilink-guide", version: null }, { label: "FortiSwitchOS 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortiswitch/7.6.1/fortiswitchos-cli-reference ", version: null }],
      },
  ...
  {
    slug: "fortinet-nse-5-sdwan-core-administrator",
    examCode: "NSE 5",
    examName: "SD-WAN Core Administrator",
    vendor: "fortinet",
    certification: "fortinet-nse-5-secure-networking",
    targetVersion: null,
    blueprintSourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=library_sd-wan-core-administrator",
    blueprintSourceLabel: "Fortinet Training Institute course page (course objectives)",
    status: "published",
    sourceCaveat: "course-objectives",
    examFacts: null,
    sections: [
      ...
      {
        id: "1.01",
        text: "Describe the capabilities of the Fortinet Secure SD-WAN solution",
        relatedArticles: ["fortigate-routing-and-sdwan-selection"],
        relatedTools: ["fortigate-route-selection-explainer"],
        manualLinks: [],
      },
      {
        id: "1.02",
        text: "Implement FortiOS SD-WAN solutions with FortiGate for a single device solution or small topologies",
        relatedArticles: ["fortigate-routing-and-sdwan-selection"],
        relatedTools: ["fortigate-route-selection-explainer"],
        manualLinks: [],
      },
      {
        id: "1.03",
        text: "Configure basic and advanced SD-WAN features",
        relatedArticles: ["fortigate-routing-and-sdwan-selection"],
        relatedTools: ["fortigate-route-selection-explainer"],
        manualLinks: [],
      },
      {
        id: "1.04",
        text: "Explain the SD-WAN route and rule lookup process",
        relatedArticles: ["fortigate-routing-and-sdwan-selection"],
        relatedTools: ["fortigate-route-selection-explainer"],
        manualLinks: [],
      },
      {
        id: "1.05",
        text: "Use the different rule criteria and strategies available to steer traffic using SD-WAN",
        relatedArticles: ["fortigate-routing-and-sdwan-selection"],
        relatedTools: ["fortigate-route-selection-explainer"],
        manualLinks: [],
      },
      {
        id: "1.06",
        text: "Examine how SD-WAN responds to changing link conditions",
        relatedArticles: ["fortigate-routing-and-sdwan-selection"],
        relatedTools: ["fortigate-route-selection-explainer"],
        manualLinks: [],
      },
      {
        id: "1.07",
        text: "Troubleshoot SD-WAN routing and rule matching issues",
        relatedArticles: ["fortigate-routing-and-sdwan-selection"],
        relatedTools: ["fortigate-route-selection-explainer"],
        manualLinks: [],
      },
      {
        id: "1.08",
        text: "Manage simple FortiOS SD-WAN solutions with FortiManager",
        relatedArticles: ["fortigate-routing-and-sdwan-selection"],
        relatedTools: ["fortigate-route-selection-explainer"],
        manualLinks: [],
      },
  ...
  {
    slug: "fortinet-nse-5-secure-wireless-lan-administrator",
    examCode: "NSE 5",
    examName: "Secure Wireless LAN Administrator",
    vendor: "fortinet",
    certification: "fortinet-nse-5-secure-networking",
    targetVersion: "FortiGate 7.6, FortiAP 7.6, and FortiPresence 2.0",
    blueprintSourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=secure_wireless_lan_administrator_exam",
    blueprintSourceLabel: "Fortinet NSE Certification Program, effective 15 July 2026",
    status: "published",
    retirement: {
    ...
    examFacts: {
      ...
      passMark: "Pass or fail. A score report is available from your Pearson VUE account.",
      cost: "See Pearson VUE for current pricing",
      note: "Time allowed: 70 minutes. Language: English. Product version: FortiGate 7.6, FortiAP 7.6, and FortiPresence 2.0.",
    },
    sections: [
      {
        id: "section-1",
        title: "Wireless fundamentals and FortiAP management",
        objectives: [
      {
        id: "1.01",
        text: "Explain wireless fundamentals and technology standards",
        relatedArticles: ["fortiap-wireless-fundamentals-and-deployment"],
        relatedTools: [],
        manualLinks: [{ label: "FortiWiFi and FortiAP 7.6—Configuration Guide", url: "https://docs.fortinet.com/document/fortiap/7.6.0/fortiwifi-and-fortiap-configuration-guide", version: null }, { label: "FortiGate/FortiOS 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortigate/7.6.0/cli-reference", version: null }, { label: "FortiGate/FortiOS 7.6—Administartion Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.0/administration-guide ", version: null }],
      },
      {
        id: "1.02",
        text: "Deploy FortiAP devices using the FortiOS integrated wireless controller",
        relatedArticles: ["fortiap-wireless-fundamentals-and-deployment"],
        relatedTools: [],
        manualLinks: [{ label: "FortiWiFi and FortiAP 7.6—Configuration Guide", url: "https://docs.fortinet.com/document/fortiap/7.6.0/fortiwifi-and-fortiap-configuration-guide", version: null }, { label: "FortiGate/FortiOS 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortigate/7.6.0/cli-reference", version: null }, { label: "FortiGate/FortiOS 7.6—Administartion Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.0/administration-guide ", version: null }],
      },
      {
        id: "1.03",
        text: "Use custom access point profiles to configure FortiAP devices",
        relatedArticles: ["fortiap-wireless-fundamentals-and-deployment"],
        relatedTools: [],
        manualLinks: [{ label: "FortiWiFi and FortiAP 7.6—Configuration Guide", url: "https://docs.fortinet.com/document/fortiap/7.6.0/fortiwifi-and-fortiap-configuration-guide", version: null }, { label: "FortiGate/FortiOS 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortigate/7.6.0/cli-reference", version: null }, { label: "FortiGate/FortiOS 7.6—Administartion Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.0/administration-guide ", version: null }],
      },
      ...
      {
        id: "section-2",
        title: "Wireless network security and access",
        objectives: [
      {
        id: "2.01",
        text: "Describe the implementation of a secure wireless LAN using FortiAP devices",
        relatedArticles: ["fortiap-secure-wireless-access-and-segmentation"],
        relatedTools: [],
        manualLinks: [{ label: "FortiWiFi and FortiAP 7.6—Configuration Guide", url: "https://docs.fortinet.com/document/fortiap/7.6.0/fortiwifi-and-fortiap-configuration-guide", version: null }, { label: "FortiGate/FortiOS 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortigate/7.6.0/cli-reference", version: null }, { label: "FortiGate/FortiOS 7.6—Administartion Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.0/administration-guide ", version: null }],
      },
      {
        id: "2.02",
        text: "Configure secure wireless access",
        relatedArticles: ["fortiap-secure-wireless-access-and-segmentation"],
        relatedTools: [],
        manualLinks: [{ label: "FortiWiFi and FortiAP 7.6—Configuration Guide", url: "https://docs.fortinet.com/document/fortiap/7.6.0/fortiwifi-and-fortiap-configuration-guide", version: null }, { label: "FortiGate/FortiOS 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortigate/7.6.0/cli-reference", version: null }, { label: "FortiGate/FortiOS 7.6—Administartion Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.0/administration-guide ", version: null }],
      },
      {
        id: "2.03",
        text: "Deploy VLANs and network access control (NAC) for wireless segmentation",
        relatedArticles: ["fortiap-secure-wireless-access-and-segmentation"],
        relatedTools: [],
        manualLinks: [{ label: "FortiWiFi and FortiAP 7.6—Configuration Guide", url: "https://docs.fortinet.com/document/fortiap/7.6.0/fortiwifi-and-fortiap-configuration-guide", version: null }, { label: "FortiGate/FortiOS 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortigate/7.6.0/cli-reference", version: null }, { label: "FortiGate/FortiOS 7.6—Administartion Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.0/administration-guide ", version: null }],
      },
      ...
      {
        id: "section-3",
        title: "Wireless monitoring and protection",
        objectives: [
      {
        id: "3.01",
        text: "Identify wireless threats and malicious activities",
        relatedArticles: ["fortiap-monitoring-threats-and-troubleshooting"],
        relatedTools: [],
        manualLinks: [{ label: "FortiWiFi and FortiAP 7.6—Configuration Guide", url: "https://docs.fortinet.com/document/fortiap/7.6.0/fortiwifi-and-fortiap-configuration-guide", version: null }, { label: "FortiGate/FortiOS 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortigate/7.6.0/cli-reference", version: null }, { label: "FortiGate/FortiOS 7.6—Administartion Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.0/administration-guide ", version: null }],
      },
      {
        id: "3.02",
        text: "Monitor access point health and performance",
        relatedArticles: ["fortiap-monitoring-threats-and-troubleshooting"],
        relatedTools: [],
        manualLinks: [{ label: "FortiWiFi and FortiAP 7.6—Configuration Guide", url: "https://docs.fortinet.com/document/fortiap/7.6.0/fortiwifi-and-fortiap-configuration-guide", version: null }, { label: "FortiGate/FortiOS 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortigate/7.6.0/cli-reference", version: null }, { label: "FortiGate/FortiOS 7.6—Administartion Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.0/administration-guide ", version: null }],
      },
      {
        id: "3.03",
        text: "Explain the integration of artificial intelligence for IT operations (AIOps) with FortiGate",
        relatedArticles: ["fortiap-monitoring-threats-and-troubleshooting"],
        relatedTools: [],
        manualLinks: [{ label: "FortiWiFi and FortiAP 7.6—Configuration Guide", url: "https://docs.fortinet.com/document/fortiap/7.6.0/fortiwifi-and-fortiap-configuration-guide", version: null }, { label: "FortiGate/FortiOS 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortigate/7.6.0/cli-reference", version: null }, { label: "FortiGate/FortiOS 7.6—Administartion Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.0/administration-guide ", version: null }],
      },
      ...
      {
        id: "section-4",
        title: "Wireless diagnostics and analytics",
        objectives: [
      {
        id: "4.01",
        text: "Interpret information about clients and wireless components",
        relatedArticles: ["fortiap-monitoring-threats-and-troubleshooting"],
        relatedTools: [],
        manualLinks: [{ label: "FortiWiFi and FortiAP 7.6—Configuration Guide", url: "https://docs.fortinet.com/document/fortiap/7.6.0/fortiwifi-and-fortiap-configuration-guide", version: null }, { label: "FortiGate/FortiOS 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortigate/7.6.0/cli-reference", version: null }, { label: "FortiGate/FortiOS 7.6—Administartion Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.0/administration-guide ", version: null }],
      },
      {
        id: "4.02",
        text: "Troubleshoot common wireless issues and apply remediation",
        relatedArticles: ["fortiap-monitoring-threats-and-troubleshooting"],
        relatedTools: [],
        manualLinks: [{ label: "FortiWiFi and FortiAP 7.6—Configuration Guide", url: "https://docs.fortinet.com/document/fortiap/7.6.0/fortiwifi-and-fortiap-configuration-guide", version: null }, { label: "FortiGate/FortiOS 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortigate/7.6.0/cli-reference", version: null }, { label: "FortiGate/FortiOS 7.6—Administartion Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.0/administration-guide ", version: null }],
      },
      {
        id: "4.03",
        text: "Analyze wireless logs and debugs",
        relatedArticles: ["fortiap-monitoring-threats-and-troubleshooting"],
        relatedTools: [],
        manualLinks: [{ label: "FortiWiFi and FortiAP 7.6—Configuration Guide", url: "https://docs.fortinet.com/document/fortiap/7.6.0/fortiwifi-and-fortiap-configuration-guide", version: null }, { label: "FortiGate/FortiOS 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortigate/7.6.0/cli-reference", version: null }, { label: "FortiGate/FortiOS 7.6—Administartion Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.0/administration-guide ", version: null }],
      },
  ...
  {
    slug: "fortinet-nse-5-sase-sdwan-core-administrator",
    examCode: "NSE 5",
    examName: "SASE and SD-WAN Core Administrator",
    vendor: "fortinet",
    certification: "fortinet-nse-5-sase",
    targetVersion: "FortiSASE 25, FortiOS 7.6, FortiClient 7.0, FortiAuthenticator 6.5, FortiManager 7.6",
    blueprintSourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=fortisase_and_sd-wan_core_administrator_exam",
    blueprintSourceLabel: "Fortinet NSE Certification Program, effective 15 July 2026",
    status: "published",
    retirement: {
    ...
    examFacts: {
      ...
      passMark: "Pass or fail. A score report is available from your Pearson VUE account.",
      cost: "See Pearson VUE for current pricing",
      note: "Time allowed: 65 minutes. Language: English. Product version: FortiSASE 25, FortiOS 7.6, FortiClient 7.0, FortiAuthenticator 6.5, FortiManager 7.6.",
    },
    sections: [
      {
        id: "section-1",
        title: "Decentralized SD-WAN",
        objectives: [
      {
        id: "1.01",
        text: "Implement a basic SD-WAN setup",
        relatedArticles: ["fortigate-routing-and-sdwan-selection"],
        relatedTools: ["fortigate-route-selection-explainer"],
        manualLinks: [{ label: "FortiSASE—Administration Guide", url: "https://docs.fortinet.com/product/fortisase", version: null }, { label: "FortiSASE—Reference Guide", url: "https://docs.fortinet.com/document/fortisase/latest/reference-guide/259974/introduction", version: null }, { label: "FortiSASE—Architecture Guide", url: "https://docs.fortinet.com/document/fortisase/latest/architecture-guide/891466/common-fortisase-use-cases", version: null }, { label: "FortiOS—Administration Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.4/administration-guide/954635/getting-started", version: null }],
      },
      {
        id: "1.02",
        text: "Configure SD-WAN members and zones",
        relatedArticles: ["fortigate-routing-and-sdwan-selection"],
        relatedTools: ["fortigate-route-selection-explainer"],
        manualLinks: [{ label: "FortiSASE—Administration Guide", url: "https://docs.fortinet.com/product/fortisase", version: null }, { label: "FortiSASE—Reference Guide", url: "https://docs.fortinet.com/document/fortisase/latest/reference-guide/259974/introduction", version: null }, { label: "FortiSASE—Architecture Guide", url: "https://docs.fortinet.com/document/fortisase/latest/architecture-guide/891466/common-fortisase-use-cases", version: null }, { label: "FortiOS—Administration Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.4/administration-guide/954635/getting-started", version: null }],
      },
      {
        id: "1.03",
        text: "Configure performance service-level agreements (SLA)",
        relatedArticles: ["fortigate-routing-and-sdwan-selection", "fortisase-operations-onboarding-and-reporting"],
        relatedTools: [],
        manualLinks: [{ label: "FortiSASE—Administration Guide", url: "https://docs.fortinet.com/product/fortisase", version: null }, { label: "FortiSASE—Reference Guide", url: "https://docs.fortinet.com/document/fortisase/latest/reference-guide/259974/introduction", version: null }, { label: "FortiSASE—Architecture Guide", url: "https://docs.fortinet.com/document/fortisase/latest/architecture-guide/891466/common-fortisase-use-cases", version: null }, { label: "FortiOS—Administration Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.4/administration-guide/954635/getting-started", version: null }],
      },
        ],
      ...
      {
        id: "section-3",
        title: "SASE deployment",
        objectives: [
      {
        id: "3.01",
        text: "Configure SASE administration settings",
        relatedArticles: ["fortigate-cloud-deployments-and-fortisase"],
        relatedTools: [],
        manualLinks: [{ label: "FortiSASE—Administration Guide", url: "https://docs.fortinet.com/product/fortisase", version: null }, { label: "FortiSASE—Reference Guide", url: "https://docs.fortinet.com/document/fortisase/latest/reference-guide/259974/introduction", version: null }, { label: "FortiSASE—Architecture Guide", url: "https://docs.fortinet.com/document/fortisase/latest/architecture-guide/891466/common-fortisase-use-cases", version: null }, { label: "FortiOS—Administration Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.4/administration-guide/954635/getting-started", version: null }],
      },
      {
        id: "3.02",
        text: "Use available user onboarding methods",
        relatedArticles: ["fortisase-operations-onboarding-and-reporting", "fortigate-cloud-deployments-and-fortisase"],
        relatedTools: [],
        manualLinks: [{ label: "FortiSASE—Administration Guide", url: "https://docs.fortinet.com/product/fortisase", version: null }, { label: "FortiSASE—Reference Guide", url: "https://docs.fortinet.com/document/fortisase/latest/reference-guide/259974/introduction", version: null }, { label: "FortiSASE—Architecture Guide", url: "https://docs.fortinet.com/document/fortisase/latest/architecture-guide/891466/common-fortisase-use-cases", version: null }, { label: "FortiOS—Administration Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.4/administration-guide/954635/getting-started", version: null }],
      },
      {
        id: "3.03",
        text: "Integrate FortiSASE with SD-WAN",
        relatedArticles: ["fortigate-routing-and-sdwan-selection", "fortigate-cloud-deployments-and-fortisase"],
        relatedTools: ["fortigate-route-selection-explainer"],
        manualLinks: [{ label: "FortiSASE—Administration Guide", url: "https://docs.fortinet.com/product/fortisase", version: null }, { label: "FortiSASE—Reference Guide", url: "https://docs.fortinet.com/document/fortisase/latest/reference-guide/259974/introduction", version: null }, { label: "FortiSASE—Architecture Guide", url: "https://docs.fortinet.com/document/fortisase/latest/architecture-guide/891466/common-fortisase-use-cases", version: null }, { label: "FortiOS—Administration Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.4/administration-guide/954635/getting-started", version: null }],
      },
      ...
      {
        id: "section-4",
        title: "Secure internet access (SIA) and secure SaaS access (SSA)",
        objectives: [
      {
        id: "4.01",
        text: "Implement security profiles to perform content inspection",
        relatedArticles: ["fortigate-security-profiles-flow-vs-proxy"],
        relatedTools: ["fortigate-security-profile-coverage-checker"],
        manualLinks: [{ label: "FortiSASE—Administration Guide", url: "https://docs.fortinet.com/product/fortisase", version: null }, { label: "FortiSASE—Reference Guide", url: "https://docs.fortinet.com/document/fortisase/latest/reference-guide/259974/introduction", version: null }, { label: "FortiSASE—Architecture Guide", url: "https://docs.fortinet.com/document/fortisase/latest/architecture-guide/891466/common-fortisase-use-cases", version: null }, { label: "FortiOS—Administration Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.4/administration-guide/954635/getting-started", version: null }],
      },
      {
        id: "4.02",
        text: "Deploy compliance rules to managed endpoints",
        relatedArticles: ["fortisase-operations-onboarding-and-reporting", "forticlient-ems-architecture-and-deployment"],
        relatedTools: [],
        manualLinks: [{ label: "FortiSASE—Administration Guide", url: "https://docs.fortinet.com/product/fortisase", version: null }, { label: "FortiSASE—Reference Guide", url: "https://docs.fortinet.com/document/fortisase/latest/reference-guide/259974/introduction", version: null }, { label: "FortiSASE—Architecture Guide", url: "https://docs.fortinet.com/document/fortisase/latest/architecture-guide/891466/common-fortisase-use-cases", version: null }, { label: "FortiOS—Administration Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.4/administration-guide/954635/getting-started", version: null }],
      },
        ],
      ...
      {
        id: "5.01",
        text: "Analyze SD-WAN logs to monitor rule and session behavior",
        relatedArticles: ["fortigate-routing-and-sdwan-selection"],
        relatedTools: ["fortigate-route-selection-explainer"],
        manualLinks: [{ label: "FortiSASE—Administration Guide", url: "https://docs.fortinet.com/product/fortisase", version: null }, { label: "FortiSASE—Reference Guide", url: "https://docs.fortinet.com/document/fortisase/latest/reference-guide/259974/introduction", version: null }, { label: "FortiSASE—Architecture Guide", url: "https://docs.fortinet.com/document/fortisase/latest/architecture-guide/891466/common-fortisase-use-cases", version: null }, { label: "FortiOS—Administration Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.4/administration-guide/954635/getting-started", version: null }],
      },
      {
        id: "5.02",
        text: "Identify potential security threats using FortiSASE logs",
        relatedArticles: ["fortigate-cloud-deployments-and-fortisase"],
        relatedTools: [],
        manualLinks: [{ label: "FortiSASE—Administration Guide", url: "https://docs.fortinet.com/product/fortisase", version: null }, { label: "FortiSASE—Reference Guide", url: "https://docs.fortinet.com/document/fortisase/latest/reference-guide/259974/introduction", version: null }, { label: "FortiSASE—Architecture Guide", url: "https://docs.fortinet.com/document/fortisase/latest/architecture-guide/891466/common-fortisase-use-cases", version: null }, { label: "FortiOS—Administration Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.4/administration-guide/954635/getting-started", version: null }],
      },
      {
        id: "5.03",
        text: "Analyze reports for user traffic and security issues",
        relatedArticles: ["fortisase-operations-onboarding-and-reporting", "fortianalyzer-reports-datasets-and-charts"],
        relatedTools: [],
        manualLinks: [{ label: "FortiSASE—Administration Guide", url: "https://docs.fortinet.com/product/fortisase", version: null }, { label: "FortiSASE—Reference Guide", url: "https://docs.fortinet.com/document/fortisase/latest/reference-guide/259974/introduction", version: null }, { label: "FortiSASE—Architecture Guide", url: "https://docs.fortinet.com/document/fortisase/latest/architecture-guide/891466/common-fortisase-use-cases", version: null }, { label: "FortiOS—Administration Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.4/administration-guide/954635/getting-started", version: null }],
      },
        ],
  ...
  {
    slug: "fortinet-nse-5-fortiappsec-administrator",
    examCode: "NSE 5",
    examName: "FortiAppSec Administrator",
    vendor: "fortinet",
    certification: "fortinet-nse-5-cloud-security",
    targetVersion: null,
    blueprintSourceUrl:
      "https://training.fortinet.com/local/staticpage/view.php?page=library_fortiappsec-cloud-administrator",
    blueprintSourceLabel: "Fortinet Training Institute course page (course objectives)",
    status: "published",
    sourceCaveat: "course-objectives",
    // Fortinet's page for this exam publishes literal "xx" placeholders for
    // time, questions, language and product version, so there are no facts to
    // transcribe yet. Transcribing placeholders as data would present nonsense
    // as fact, which is worse than showing the honest in-preparation state.
    examFacts: null,
    sections: [
      {
        id: "section-1",
      ...
      {
        id: "1.01",
        text: "Define the shared responsibility model",
        relatedArticles: [],
        relatedTools: [],
        manualLinks: [],
        gap: true,
      ...
      {
        id: "1.02",
        text: "Describe the FortiAppSec platform architecture",
      ...
      {
        id: "1.03",
        text: "Differentiate among licensing models",
        relatedArticles: ["fortiappsec-cloud-waf-and-managed-delivery"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.04",
        text: "Integrate your web application",
        relatedArticles: ["fortiappsec-cloud-waf-and-managed-delivery"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "1.06",
        text: "Restrict direct-to-IP traffic",
        relatedArticles: ["fortiappsec-cloud-waf-and-managed-delivery"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        ...
        relatedArticles: ["fortiappsec-cloud-waf-and-managed-delivery", "fortiddos-detection-modes-and-mitigation"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.08",
        text: "Define web application firewall (WAF) security rules",
        relatedArticles: ["fortiweb-deployment-policies-and-delivery", "fortiweb-application-security-bots-api-and-dos"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.09",
        text: "Explain OpenAPI validation",
        relatedArticles: ["fortiappsec-advanced-protection-and-availability", "fortiweb-application-security-bots-api-and-dos"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.10",
        text: "Distinguish among the various API protections",
        relatedArticles: ["fortiweb-deployment-policies-and-delivery", "fortiweb-application-security-bots-api-and-dos"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.11",
        text: "Configure machine-learning (ML) based API protection",
        relatedArticles: ["fortiweb-deployment-policies-and-delivery", "fortiweb-application-security-bots-api-and-dos"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.12",
        text: "Manage unauthorized or high-risk scripts and domains",
        relatedArticles: ["fortimanager-adoms-and-device-registration", "fortimanager-policy-packages-and-installs"],
        relatedTools: ["fortios-config-diff-explainer"],
        manualLinks: [],
      },
      {
        id: "1.13",
        text: "Navigate the Client-Side Protection portal",
        relatedArticles: ["fortiappsec-advanced-protection-and-availability"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.14",
        text: "Differentiate between good, bad, and sophisticated bots",
        relatedArticles: ["fortiweb-deployment-policies-and-delivery", "fortiweb-application-security-bots-api-and-dos"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.15",
        text: "Describe behavior-based detection and biometric attributes",
        relatedArticles: ["fortiappsec-advanced-protection-and-availability"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.16",
        text: "Explain AI-based threat detection",
        relatedArticles: ["fortiappsec-advanced-protection-and-availability"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.17",
        text: "Configure Advanced Bot Protection (ABP) applications",
        relatedArticles: ["fortiweb-deployment-policies-and-delivery", "fortiweb-application-security-bots-api-and-dos"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.18",
        text: "Apply ABP protection features",
        relatedArticles: ["fortiappsec-advanced-protection-and-availability"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.19",
        text: "Integrate FortiAppSec Cloud ABP with the Fortinet Security Fabric",
        relatedArticles: ["fortigate-firewall-policy-and-nat"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.20",
        text: "Define core global server load balancing (GSLB) objects and components",
        relatedArticles: ["fortiweb-deployment-policies-and-delivery", "fortiweb-application-security-bots-api-and-dos"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "1.22",
        text: "Configure health checks",
        relatedArticles: ["fortiappsec-advanced-protection-and-availability", "fortiadc-application-delivery-and-load-balancing"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.23",
        text: "Implement synthetic testing to monitor application availability globally",
        relatedArticles: ["fortiappsec-advanced-protection-and-availability"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.24",
        text: "Describe various load balancing methods",
        relatedArticles: ["fortiweb-deployment-policies-and-delivery", "fortiweb-application-security-bots-api-and-dos"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.25",
        text: "Integrate FortiAppSec Cloud GSLB with the Security Fabric",
        relatedArticles: ["fortigate-firewall-policy-and-nat"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "1.27",
        text: "Describe FortiAI Assistant capabilities and limitations",
        relatedArticles: ["fortiappsec-advanced-protection-and-availability"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.28",
        text: "Gain threat insights using widgets",
        relatedArticles: ["fortiappsec-advanced-protection-and-availability", "fortiappsec-cloud-waf-and-managed-delivery"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.29",
        text: "Correlate security events with incidents",
        relatedArticles: ["fortianalyzer-log-ingestion-and-storage", "fortianalyzer-soc-events-incidents-playbooks"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.30",
        text: "Analyze threats using FortiAI",
        relatedArticles: ["fortiappsec-advanced-protection-and-availability"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.31",
        text: "Integrate FortiAppSec cloud threat analytics with the Security Fabric",
        relatedArticles: ["fortigate-firewall-policy-and-nat"],
        relatedTools: [],
        manualLinks: [],
      },
  ...
  {
    slug: "fortinet-nse-5-fortiadc-administrator",
    examCode: "NSE 5",
    examName: "FortiADC Administrator",
    vendor: "fortinet",
    certification: "fortinet-nse-5-cloud-security",
    targetVersion: null,
    blueprintSourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=library_fortiadc-administrator",
    blueprintSourceLabel: "Fortinet Training Institute course page (course objectives)",
    status: "published",
    sourceCaveat: "course-objectives",
    examFacts: null,
    sections: [
      ...
      {
        id: "1.01",
        text: "Describe the characteristics and components of an application delivery network",
        relatedArticles: ["fortiweb-deployment-policies-and-delivery", "fortiweb-application-security-bots-api-and-dos"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.02",
        text: "Identify the security challenges faced in an application delivery network",
        relatedArticles: ["fortiweb-deployment-policies-and-delivery", "fortiweb-application-security-bots-api-and-dos"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.03",
        text: "Evaluate deployment options",
        relatedArticles: ["fortiadc-server-load-balancing-and-application-delivery"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.04",
        text: "Configure initial network and system settings",
        relatedArticles: ["fortiadc-server-load-balancing-and-application-delivery"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.05",
        text: "Manage administrator accounts",
        relatedArticles: ["fortiadc-server-load-balancing-and-application-delivery"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.06",
        text: "Configure virtual servers, real servers, and server pools",
        relatedArticles: ["fortiadc-server-load-balancing-and-application-delivery"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.07",
        text: "Configure application profiles",
        relatedArticles: ["fortiadc-server-load-balancing-and-application-delivery"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.08",
        text: "Configure page speed optimization",
        relatedArticles: ["fortiadc-server-load-balancing-and-application-delivery"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.09",
        text: "Configure layer 7 compression offloading",
        relatedArticles: ["fortiadc-server-load-balancing-and-application-delivery"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.10",
        text: "Configure content routing and content rewrite",
        relatedArticles: ["fortigate-routing-and-sdwan-selection"],
        relatedTools: ["fortigate-route-selection-explainer"],
        manualLinks: [],
      },
      {
        id: "1.11",
        text: "Configure link load balancing",
        relatedArticles: ["fortiweb-deployment-policies-and-delivery", "fortiweb-application-security-bots-api-and-dos"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.12",
        text: "Create virtual tunnels and link groups",
        relatedArticles: ["fortigate-ipsec-vpn-topologies"],
        relatedTools: ["fortigate-ipsec-phase-mismatch-analyzer"],
        manualLinks: [],
      },
      {
        id: "1.13",
        text: "Configure policy routing, QoS, and NAT features",
        relatedArticles: ["fortigate-firewall-policy-and-nat", "fortigate-routing-and-sdwan-selection"],
        relatedTools: ["fortigate-policy-lookup-explainer", "fortigate-route-selection-explainer"],
        manualLinks: [],
      },
      {
        id: "1.14",
        text: "Configure BGP and OSPF routing",
        relatedArticles: ["fortigate-routing-and-sdwan-selection"],
        relatedTools: ["fortigate-route-selection-explainer"],
        manualLinks: [],
      },
      {
        id: "1.15",
        text: "Configure DNS services and policies",
        relatedArticles: ["fortiadc-security-dns-and-troubleshooting"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.16",
        text: "Configure global load balancing",
        relatedArticles: ["fortiweb-deployment-policies-and-delivery", "fortiweb-application-security-bots-api-and-dos"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.17",
        text: "Configure the web application firewall (WAF)",
        relatedArticles: ["fortiweb-deployment-policies-and-delivery", "fortiweb-application-security-bots-api-and-dos"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.18",
        text: "Configure and manage adaptive learning",
        relatedArticles: ["fortiadc-security-dns-and-troubleshooting"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.19",
        text: "Configure bot mitigation and API gateway policies",
        relatedArticles: ["fortiweb-deployment-policies-and-delivery", "fortiweb-application-security-bots-api-and-dos"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.20",
        text: "Configure VDOMs and high availability (HA)",
        relatedArticles: ["fortigate-fgcp-ha-clustering"],
        relatedTools: ["fortigate-ha-failover-simulator"],
        manualLinks: [],
      },
      {
        id: "1.21",
        text: "Create automated action scripts using the REST API",
        relatedArticles: ["fortimanager-adoms-and-device-registration", "fortimanager-policy-packages-and-installs"],
        relatedTools: ["fortios-config-diff-explainer"],
        manualLinks: [],
      },
      {
        id: "1.22",
        text: "Configure OWASP Top 10 profile",
        relatedArticles: ["fortiadc-security-dns-and-troubleshooting"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "1.24",
        text: "Configure advanced bot protection",
        relatedArticles: ["fortiweb-deployment-policies-and-delivery", "fortiweb-application-security-bots-api-and-dos"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.25",
        text: "Configure firewall policies and connection limits",
        relatedArticles: ["fortigate-firewall-policy-and-nat"],
        relatedTools: ["fortigate-policy-lookup-explainer"],
        manualLinks: [],
      },
      {
        id: "1.26",
        text: "Protect against DoS attacks",
        relatedArticles: ["fortiadc-security-dns-and-troubleshooting"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.27",
        text: "Configure ZTNA integration",
        relatedArticles: ["forticlient-ems-endpoint-security-ztna-and-troubleshooting", "fortigate-cloud-deployments-and-fortisase"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.28",
        text: "Configure local logging, remote logging, and alert emails",
        relatedArticles: ["fortianalyzer-log-ingestion-and-storage", "fortianalyzer-soc-events-incidents-playbooks", "fortimail-smtp-fundamentals-and-deployment"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.29",
        text: "Configure SNMP monitoring",
        relatedArticles: ["fortiadc-security-dns-and-troubleshooting"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.30",
        text: "Use diagnostic commands available through the CLI",
        relatedArticles: ["fortigate-logging-and-diagnostics"],
      ...
      {
        id: "1.31",
        text: "Identify the most common issues",
        relatedArticles: ["fortiadc-security-dns-and-troubleshooting"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.32",
        text: "Back up and restore the system configuration",
        relatedArticles: ["fortiadc-security-dns-and-troubleshooting"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.33",
        text: "Upgrade the firmware",
        relatedArticles: ["fortiadc-application-delivery-and-load-balancing"],
        relatedTools: [],
        manualLinks: [],
      },
        ],
  ...
  {
    slug: "fortinet-nse-5-fortiweb-administrator",
    examCode: "NSE 5",
    examName: "FortiWeb Administrator",
    vendor: "fortinet",
    certification: "fortinet-nse-5-cloud-security",
    targetVersion: "FortiWeb 8.0",
    blueprintSourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=fortiweb_administrator_exam",
    blueprintSourceLabel: "Fortinet NSE Certification Program, effective 15 July 2026",
    status: "published",
    examFacts: {
      questions: "35-40 questions",
      ...
      passMark: "Pass or fail. A score report is available from your Pearson VUE account.",
      cost: "See Pearson VUE for current pricing",
      note: "Time allowed: 75 minutes. Language: English and Japanese. Product version: FortiWeb 8.0.",
    },
    sections: [
      {
        id: "section-1",
      ...
      {
        id: "1.01",
        text: "Understand FortiWeb deployment and basic administration",
        relatedArticles: ["fortiweb-deployment-policies-and-delivery"],
        relatedTools: [],
        manualLinks: [{ label: "FortiWeb 8.0—Administration Guide", url: "https://docs.fortinet.com/document/fortiweb/8.0.0/administration-guide/60895/introduction", version: null }, { label: "FortiWeb 8.0—CLI Reference", url: "https://docs.fortinet.com/document/fortiweb/8.0.0/cli-reference/403892/introduction", version: null }, { label: "FortiWeb 8.0—WAF Concept Guide", url: "https://docs.fortinet.com/document/fortiweb/8.0.0/waf-concept-guide/542417/what-is-web-application-firewall", version: null }, { label: "FortiWeb 8.0—Troubleshooting Guide", url: "https://docs.fortinet.com/document/fortiweb/8.0.0/troubleshooting-guide/77284/introduction", version: null }],
      },
      {
        id: "1.02",
        text: "Configure server objects and policies",
        relatedArticles: ["fortiweb-deployment-policies-and-delivery"],
        relatedTools: [],
        manualLinks: [{ label: "FortiWeb 8.0—Administration Guide", url: "https://docs.fortinet.com/document/fortiweb/8.0.0/administration-guide/60895/introduction", version: null }, { label: "FortiWeb 8.0—CLI Reference", url: "https://docs.fortinet.com/document/fortiweb/8.0.0/cli-reference/403892/introduction", version: null }, { label: "FortiWeb 8.0—WAF Concept Guide", url: "https://docs.fortinet.com/document/fortiweb/8.0.0/waf-concept-guide/542417/what-is-web-application-firewall", version: null }, { label: "FortiWeb 8.0—Troubleshooting Guide", url: "https://docs.fortinet.com/document/fortiweb/8.0.0/troubleshooting-guide/77284/introduction", version: null }],
      },
      {
        id: "1.03",
        text: "Implement SSL inspection, offloading, and high availability (HA)",
        relatedArticles: ["fortinet-ssl-inspection-modes", "fortigate-security-profiles-flow-vs-proxy", "fortigate-fgcp-ha-clustering"],
        relatedTools: ["fortigate-security-profile-coverage-checker", "fortigate-ha-failover-simulator"],
        manualLinks: [{ label: "FortiWeb 8.0—Administration Guide", url: "https://docs.fortinet.com/document/fortiweb/8.0.0/administration-guide/60895/introduction", version: null }, { label: "FortiWeb 8.0—CLI Reference", url: "https://docs.fortinet.com/document/fortiweb/8.0.0/cli-reference/403892/introduction", version: null }, { label: "FortiWeb 8.0—WAF Concept Guide", url: "https://docs.fortinet.com/document/fortiweb/8.0.0/waf-concept-guide/542417/what-is-web-application-firewall", version: null }, { label: "FortiWeb 8.0—Troubleshooting Guide", url: "https://docs.fortinet.com/document/fortiweb/8.0.0/troubleshooting-guide/77284/introduction", version: null }],
      },
        ],
      },
      {
        id: "section-2",
        title: "Web application and API security with botnet mitigation",
        objectives: [
      {
        id: "2.01",
        text: "Apply web application security",
        relatedArticles: ["fortiweb-application-security-bots-api-and-dos"],
        relatedTools: [],
        manualLinks: [{ label: "FortiWeb 8.0—Administration Guide", url: "https://docs.fortinet.com/document/fortiweb/8.0.0/administration-guide/60895/introduction", version: null }, { label: "FortiWeb 8.0—CLI Reference", url: "https://docs.fortinet.com/document/fortiweb/8.0.0/cli-reference/403892/introduction", version: null }, { label: "FortiWeb 8.0—WAF Concept Guide", url: "https://docs.fortinet.com/document/fortiweb/8.0.0/waf-concept-guide/542417/what-is-web-application-firewall", version: null }, { label: "FortiWeb 8.0—Troubleshooting Guide", url: "https://docs.fortinet.com/document/fortiweb/8.0.0/troubleshooting-guide/77284/introduction", version: null }],
      },
      {
        id: "2.02",
        text: "Configure API discovery and protection",
        relatedArticles: ["fortiweb-application-security-bots-api-and-dos"],
        relatedTools: [],
        manualLinks: [{ label: "FortiWeb 8.0—Administration Guide", url: "https://docs.fortinet.com/document/fortiweb/8.0.0/administration-guide/60895/introduction", version: null }, { label: "FortiWeb 8.0—CLI Reference", url: "https://docs.fortinet.com/document/fortiweb/8.0.0/cli-reference/403892/introduction", version: null }, { label: "FortiWeb 8.0—WAF Concept Guide", url: "https://docs.fortinet.com/document/fortiweb/8.0.0/waf-concept-guide/542417/what-is-web-application-firewall", version: null }, { label: "FortiWeb 8.0—Troubleshooting Guide", url: "https://docs.fortinet.com/document/fortiweb/8.0.0/troubleshooting-guide/77284/introduction", version: null }],
      },
      ...
      {
        id: "section-3",
        title: "Application delivery and additional configuration",
        objectives: [
      {
        id: "3.01",
        text: "Optimize application delivery",
        relatedArticles: ["fortiweb-deployment-policies-and-delivery"],
        relatedTools: [],
        manualLinks: [{ label: "FortiWeb 8.0—Administration Guide", url: "https://docs.fortinet.com/document/fortiweb/8.0.0/administration-guide/60895/introduction", version: null }, { label: "FortiWeb 8.0—CLI Reference", url: "https://docs.fortinet.com/document/fortiweb/8.0.0/cli-reference/403892/introduction", version: null }, { label: "FortiWeb 8.0—WAF Concept Guide", url: "https://docs.fortinet.com/document/fortiweb/8.0.0/waf-concept-guide/542417/what-is-web-application-firewall", version: null }, { label: "FortiWeb 8.0—Troubleshooting Guide", url: "https://docs.fortinet.com/document/fortiweb/8.0.0/troubleshooting-guide/77284/introduction", version: null }],
      },
      {
        id: "3.02",
        text: "Implement denial of service (DoS), logging, and FortiAI",
        relatedArticles: ["fortiweb-application-security-bots-api-and-dos"],
        relatedTools: [],
        manualLinks: [{ label: "FortiWeb 8.0—Administration Guide", url: "https://docs.fortinet.com/document/fortiweb/8.0.0/administration-guide/60895/introduction", version: null }, { label: "FortiWeb 8.0—CLI Reference", url: "https://docs.fortinet.com/document/fortiweb/8.0.0/cli-reference/403892/introduction", version: null }, { label: "FortiWeb 8.0—WAF Concept Guide", url: "https://docs.fortinet.com/document/fortiweb/8.0.0/waf-concept-guide/542417/what-is-web-application-firewall", version: null }, { label: "FortiWeb 8.0—Troubleshooting Guide", url: "https://docs.fortinet.com/document/fortiweb/8.0.0/troubleshooting-guide/77284/introduction", version: null }],
      },
      ...
      {
        id: "section-4",
        title: "Compliance and troubleshooting",
        objectives: [
      {
        id: "4.01",
        text: "Troubleshoot deployment and system-related issues",
        relatedArticles: ["fortiweb-deployment-policies-and-delivery"],
        relatedTools: [],
        manualLinks: [{ label: "FortiWeb 8.0—Administration Guide", url: "https://docs.fortinet.com/document/fortiweb/8.0.0/administration-guide/60895/introduction", version: null }, { label: "FortiWeb 8.0—CLI Reference", url: "https://docs.fortinet.com/document/fortiweb/8.0.0/cli-reference/403892/introduction", version: null }, { label: "FortiWeb 8.0—WAF Concept Guide", url: "https://docs.fortinet.com/document/fortiweb/8.0.0/waf-concept-guide/542417/what-is-web-application-firewall", version: null }, { label: "FortiWeb 8.0—Troubleshooting Guide", url: "https://docs.fortinet.com/document/fortiweb/8.0.0/troubleshooting-guide/77284/introduction", version: null }],
      },
      {
        id: "4.02",
        text: "Implement web vulnerability scans",
        relatedArticles: ["fortiweb-application-security-bots-api-and-dos"],
        relatedTools: [],
        manualLinks: [{ label: "FortiWeb 8.0—Administration Guide", url: "https://docs.fortinet.com/document/fortiweb/8.0.0/administration-guide/60895/introduction", version: null }, { label: "FortiWeb 8.0—CLI Reference", url: "https://docs.fortinet.com/document/fortiweb/8.0.0/cli-reference/403892/introduction", version: null }, { label: "FortiWeb 8.0—WAF Concept Guide", url: "https://docs.fortinet.com/document/fortiweb/8.0.0/waf-concept-guide/542417/what-is-web-application-firewall", version: null }, { label: "FortiWeb 8.0—Troubleshooting Guide", url: "https://docs.fortinet.com/document/fortiweb/8.0.0/troubleshooting-guide/77284/introduction", version: null }],
      },
  ...
  {
    slug: "fortinet-nse-5-fortianalyzer-analyst",
    examCode: "NSE 5",
    examName: "FortiAnalyzer Analyst",
    vendor: "fortinet",
    certification: "fortinet-nse-5-security-operations",
    targetVersion: "FortiAnalyzer 7.6",
    blueprintSourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=fortianalyzer_analyst_exam",
    blueprintSourceLabel: "Fortinet NSE Certification Program, effective 15 July 2026",
    status: "published",
    examFacts: {
      questions: "30–35 questions",
      ...
      passMark: "Pass or fail. A score report is available from your Pearson VUE account.",
      cost: "See Pearson VUE for current pricing",
      note: "Time allowed: 65 minutes. Language: English, Japanese. Product version: FortiAnalyzer 7.6.",
    },
    sections: [
      {
        id: "section-1",
      ...
      {
        id: "1.01",
        text: "Explain Fabric integration and log collection",
        relatedArticles: ["fortianalyzer-log-ingestion-and-storage"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.02",
        text: "Explain log data flow, normalization, and parsing",
        relatedArticles: ["fortianalyzer-log-ingestion-and-storage"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.03",
        text: "Explain SOC features on FortiAnalyzer",
        relatedArticles: ["fortianalyzer-soc-events-incidents-playbooks"],
        relatedTools: [],
        manualLinks: [],
      },
        ],
      ...
      {
        id: "2.01",
        text: "Analyze logs, events, and incidents",
        relatedArticles: ["fortianalyzer-soc-events-incidents-playbooks", "fortianalyzer-log-ingestion-and-storage"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "2.02",
        text: "Analyze FortiView dashboards and widgets",
        relatedArticles: ["fortianalyzer-soc-events-incidents-playbooks", "fortianalyzer-log-ingestion-and-storage"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "2.03",
        text: "Diagnose and troubleshoot report generation issues",
        relatedArticles: ["fortianalyzer-reports-datasets-and-charts"],
        relatedTools: [],
        manualLinks: [],
      },
        ],
      ...
      {
        id: "section-3",
        title: "SOC operation and automation",
        objectives: [
      {
        id: "3.01",
        text: "Configure and manage events and event handlers",
        relatedArticles: ["fortianalyzer-soc-events-incidents-playbooks"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "3.02",
        text: "Configure incidents and indicators",
        relatedArticles: ["fortianalyzer-soc-events-incidents-playbooks"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "3.03",
        text: "Configure playbooks and fabric automation",
        relatedArticles: ["fortianalyzer-soc-events-incidents-playbooks"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "3.04",
        text: "Troubleshoot playbook and fabric automation issues",
        relatedArticles: ["fortianalyzer-soc-events-incidents-playbooks"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "4.01",
        text: "Explain the use of reports, charts, and datasets",
        relatedArticles: ["fortianalyzer-reports-datasets-and-charts"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "4.03",
        text: "Troubleshoot report generation",
        relatedArticles: ["fortianalyzer-reports-datasets-and-charts"],
        relatedTools: [],
        manualLinks: [],
      },
  ...
  {
    slug: "fortinet-nse-6-fortianalyzer-administrator",
    examCode: "NSE 6",
    examName: "FortiAnalyzer Administrator",
    vendor: "fortinet",
    certification: "fortinet-nse-6-secure-networking",
    targetVersion: null,
    blueprintSourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=library_fortianalyzer-administrator",
    blueprintSourceLabel: "Fortinet Training Institute course page (course objectives)",
    status: "published",
    sourceCaveat: "course-objectives",
    examFacts: null,
    sections: [
      ...
      {
        id: "1.01",
        text: "Describe the purpose of FortiAnalyzer",
        relatedArticles: ["fortianalyzer-log-ingestion-and-storage", "fortianalyzer-soc-events-incidents-playbooks"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.02",
        text: "Describe the FortiAnalyzer operating modes",
        relatedArticles: ["fortianalyzer-log-ingestion-and-storage", "fortianalyzer-soc-events-incidents-playbooks"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.03",
        text: "Describe logging in a Fortinet Security Fabric environment",
        relatedArticles: ["fortigate-firewall-policy-and-nat"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.04",
        text: "Describe the FortiAnalyzer Fabric",
        relatedArticles: ["fortianalyzer-log-ingestion-and-storage", "fortianalyzer-soc-events-incidents-playbooks"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.05",
        text: "Describe the log file workflow",
        relatedArticles: ["fortianalyzer-log-ingestion-and-storage", "fortianalyzer-soc-events-incidents-playbooks"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.06",
        text: "Manage administrative domains (ADOMs)",
        relatedArticles: ["fortimanager-adoms-and-device-registration", "fortimanager-policy-packages-and-installs"],
        relatedTools: ["fortios-config-diff-explainer"],
        manualLinks: [],
      },
      ...
      {
        id: "1.08",
        text: "Configure secure administrative access",
        relatedArticles: ["fortigate-initial-configuration-and-operation-modes"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "1.10",
        text: "Monitor administrative events",
        relatedArticles: ["fortianalyzer-soc-events-incidents-playbooks", "fortianalyzer-log-ingestion-and-storage"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.11",
        text: "Register and manage devices",
        relatedArticles: ["fortianalyzer-log-ingestion-and-storage"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.12",
        text: "Perform a system configuration backup",
        relatedArticles: ["fortianalyzer-log-ingestion-and-storage"],
        relatedTools: ["fortios-config-diff-explainer"],
        manualLinks: [],
      },
      ...
      {
        id: "1.15",
        text: "Describe Fabric connectors",
        relatedArticles: ["fortisoar-playbooks-jinja-and-connectors", "fortisoar-incident-workflow-and-troubleshooting", "fortigate-firewall-policy-and-nat"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.16",
        text: "Configure log redundancy and encryption",
        relatedArticles: ["fortianalyzer-log-ingestion-and-storage", "fortianalyzer-soc-events-incidents-playbooks"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.17",
        text: "Configure log rollover and retention policies",
        relatedArticles: ["fortianalyzer-log-ingestion-and-storage", "fortianalyzer-soc-events-incidents-playbooks"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "1.20",
        text: "Configure and manage high-availability clusters",
        relatedArticles: ["fortigate-fgcp-ha-clustering"],
        relatedTools: ["fortigate-ha-failover-simulator"],
        manualLinks: [],
      },
      {
        id: "1.21",
        text: "Perform system maintenance tasks",
        relatedArticles: ["fortianalyzer-log-ingestion-and-storage"],
        relatedTools: [],
        manualLinks: [],
      },
  ...
  {
    slug: "fortinet-nse-6-fortimanager-administrator",
    examCode: "NSE 6",
    examName: "FortiManager Administrator",
    vendor: "fortinet",
    certification: "fortinet-nse-6-secure-networking",
    targetVersion: "FortiManager 7.6.1, FortiOS 7.6",
    blueprintSourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=fortimanager_administrator_exam",
    blueprintSourceLabel: "Fortinet NSE Certification Program, effective 15 July 2026",
    status: "published",
    examFacts: {
      questions: "30-40 questions",
      ...
      passMark: "Pass or fail. A score report is available from your Pearson VUE account.",
      cost: "See Pearson VUE for current pricing",
      note: "Time allowed: 70 minutes. Language: English, Japanese. Product version: FortiManager 7.6.1, FortiOS 7.6.",
    },
    sections: [
      {
        id: "section-1",
        title: "Administration (15–25% of the exam)",
        objectives: [
      {
        id: "1.01",
        text: "Describe FortiManager features",
        relatedArticles: ["fortimanager-adoms-and-device-registration"],
        relatedTools: [],
        manualLinks: [{ label: "FortiManager 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortimanager/7.6.7/administration-guide/512210/setting-up-fortimanager", version: null }, { label: "FortiManager 7.6—New Features Guide", url: "https://docs.fortinet.com/document/fortimanager/7.6.0/new-features/380910/overview", version: null }, { label: "FortiManager 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortimanager/7.6.7/cli-reference/23811/introduction", version: null }],
      },
      {
        id: "1.02",
        text: "Perform initial configuration",
      ...
      {
        id: "section-2",
        title: "Device manager (20–30% of the exam)",
        objectives: [
      {
        id: "2.01",
        text: "Register devices in ADOMs",
        relatedArticles: ["fortimanager-adoms-and-device-registration"],
        relatedTools: [],
        manualLinks: [{ label: "FortiManager 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortimanager/7.6.7/administration-guide/512210/setting-up-fortimanager", version: null }, { label: "FortiManager 7.6—New Features Guide", url: "https://docs.fortinet.com/document/fortimanager/7.6.0/new-features/380910/overview", version: null }, { label: "FortiManager 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortimanager/7.6.7/cli-reference/23811/introduction", version: null }],
      },
      {
        id: "2.02",
        text: "Install configuration changes using scripts",
        relatedArticles: ["fortimanager-scripts-revisions-and-troubleshooting"],
        relatedTools: [],
        manualLinks: [{ label: "FortiManager 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortimanager/7.6.7/administration-guide/512210/setting-up-fortimanager", version: null }, { label: "FortiManager 7.6—New Features Guide", url: "https://docs.fortinet.com/document/fortimanager/7.6.0/new-features/380910/overview", version: null }, { label: "FortiManager 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortimanager/7.6.7/cli-reference/23811/introduction", version: null }],
      },
      {
        id: "2.03",
        text: "Diagnose issues using configuration and the revision history",
        relatedArticles: ["fortimanager-scripts-revisions-and-troubleshooting"],
        relatedTools: ["fortios-config-diff-explainer"],
        manualLinks: [{ label: "FortiManager 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortimanager/7.6.7/administration-guide/512210/setting-up-fortimanager", version: null }, { label: "FortiManager 7.6—New Features Guide", url: "https://docs.fortinet.com/document/fortimanager/7.6.0/new-features/380910/overview", version: null }, { label: "FortiManager 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortimanager/7.6.7/cli-reference/23811/introduction", version: null }],
      },
      ...
      {
        id: "section-3",
        title: "Policy and objects (25–35% of the exam)",
        objectives: [
      {
        id: "3.01",
        text: "Perform policy and object management",
        relatedArticles: ["fortimanager-policy-packages-and-installs"],
        relatedTools: [],
        manualLinks: [{ label: "FortiManager 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortimanager/7.6.7/administration-guide/512210/setting-up-fortimanager", version: null }, { label: "FortiManager 7.6—New Features Guide", url: "https://docs.fortinet.com/document/fortimanager/7.6.0/new-features/380910/overview", version: null }, { label: "FortiManager 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortimanager/7.6.7/cli-reference/23811/introduction", version: null }],
      },
      {
        id: "3.02",
        text: "Manage ADOM revisions",
        relatedArticles: ["fortimanager-adoms-and-device-registration", "fortimanager-scripts-revisions-and-troubleshooting"],
        relatedTools: ["fortios-config-diff-explainer"],
        manualLinks: [{ label: "FortiManager 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortimanager/7.6.7/administration-guide/512210/setting-up-fortimanager", version: null }, { label: "FortiManager 7.6—New Features Guide", url: "https://docs.fortinet.com/document/fortimanager/7.6.0/new-features/380910/overview", version: null }, { label: "FortiManager 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortimanager/7.6.7/cli-reference/23811/introduction", version: null }],
      },
      {
        id: "3.03",
        text: "Configure workspace mode",
        relatedArticles: ["fortimanager-policy-packages-and-installs"],
        relatedTools: [],
        manualLinks: [{ label: "FortiManager 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortimanager/7.6.7/administration-guide/512210/setting-up-fortimanager", version: null }, { label: "FortiManager 7.6—New Features Guide", url: "https://docs.fortinet.com/document/fortimanager/7.6.0/new-features/380910/overview", version: null }, { label: "FortiManager 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortimanager/7.6.7/cli-reference/23811/introduction", version: null }],
      },
      {
        id: "3.04",
        text: "Perform policy imports and installations",
        relatedArticles: ["fortimanager-policy-packages-and-installs"],
        relatedTools: [],
        manualLinks: [{ label: "FortiManager 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortimanager/7.6.7/administration-guide/512210/setting-up-fortimanager", version: null }, { label: "FortiManager 7.6—New Features Guide", url: "https://docs.fortinet.com/document/fortimanager/7.6.0/new-features/380910/overview", version: null }, { label: "FortiManager 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortimanager/7.6.7/cli-reference/23811/introduction", version: null }],
      },
      ...
      {
        id: "section-4",
        title: "Advanced configuration (10–20% of the exam)",
        objectives: [
      {
        id: "4.01",
        text: "Describe FortiManager high availability (HA)",
        relatedArticles: ["fortigate-fgcp-ha-clustering"],
        relatedTools: ["fortigate-ha-failover-simulator"],
        manualLinks: [{ label: "FortiManager 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortimanager/7.6.7/administration-guide/512210/setting-up-fortimanager", version: null }, { label: "FortiManager 7.6—New Features Guide", url: "https://docs.fortinet.com/document/fortimanager/7.6.0/new-features/380910/overview", version: null }, { label: "FortiManager 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortimanager/7.6.7/cli-reference/23811/introduction", version: null }],
      },
      {
        id: "4.02",
        text: "Configure FortiGuard services",
        relatedArticles: ["fortimanager-policy-packages-and-installs"],
        relatedTools: [],
        manualLinks: [{ label: "FortiManager 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortimanager/7.6.7/administration-guide/512210/setting-up-fortimanager", version: null }, { label: "FortiManager 7.6—New Features Guide", url: "https://docs.fortinet.com/document/fortimanager/7.6.0/new-features/380910/overview", version: null }, { label: "FortiManager 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortimanager/7.6.7/cli-reference/23811/introduction", version: null }],
      },
      {
        id: "4.03",
        text: "Configure the global database ADOM",
        relatedArticles: ["fortimanager-adoms-and-device-registration"],
        relatedTools: [],
        manualLinks: [{ label: "FortiManager 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortimanager/7.6.7/administration-guide/512210/setting-up-fortimanager", version: null }, { label: "FortiManager 7.6—New Features Guide", url: "https://docs.fortinet.com/document/fortimanager/7.6.0/new-features/380910/overview", version: null }, { label: "FortiManager 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortimanager/7.6.7/cli-reference/23811/introduction", version: null }],
      },
      ...
      {
        id: "section-5",
        title: "Troubleshooting (20–30% of the exam)",
        objectives: [
      {
        id: "5.01",
        text: "Describe FortiManager deployment scenarios",
        relatedArticles: ["fortimanager-adoms-and-device-registration"],
        relatedTools: [],
        manualLinks: [{ label: "FortiManager 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortimanager/7.6.7/administration-guide/512210/setting-up-fortimanager", version: null }, { label: "FortiManager 7.6—New Features Guide", url: "https://docs.fortinet.com/document/fortimanager/7.6.0/new-features/380910/overview", version: null }, { label: "FortiManager 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortimanager/7.6.7/cli-reference/23811/introduction", version: null }],
      },
      {
        id: "5.02",
        text: "Troubleshoot import and installation issues",
        relatedArticles: ["fortimanager-scripts-revisions-and-troubleshooting"],
        relatedTools: [],
        manualLinks: [{ label: "FortiManager 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortimanager/7.6.7/administration-guide/512210/setting-up-fortimanager", version: null }, { label: "FortiManager 7.6—New Features Guide", url: "https://docs.fortinet.com/document/fortimanager/7.6.0/new-features/380910/overview", version: null }, { label: "FortiManager 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortimanager/7.6.7/cli-reference/23811/introduction", version: null }],
      },
      {
        id: "5.03",
        text: "Troubleshoot device-level and ADOM-level issues",
        relatedArticles: ["fortimanager-scripts-revisions-and-troubleshooting"],
        relatedTools: [],
        manualLinks: [{ label: "FortiManager 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortimanager/7.6.7/administration-guide/512210/setting-up-fortimanager", version: null }, { label: "FortiManager 7.6—New Features Guide", url: "https://docs.fortinet.com/document/fortimanager/7.6.0/new-features/380910/overview", version: null }, { label: "FortiManager 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortimanager/7.6.7/cli-reference/23811/introduction", version: null }],
      },
      {
        id: "5.04",
        text: "Troubleshoot system issues",
        relatedArticles: ["fortimanager-scripts-revisions-and-troubleshooting"],
        relatedTools: [],
        manualLinks: [{ label: "FortiManager 7.6—Administration Guide", url: "https://docs.fortinet.com/document/fortimanager/7.6.7/administration-guide/512210/setting-up-fortimanager", version: null }, { label: "FortiManager 7.6—New Features Guide", url: "https://docs.fortinet.com/document/fortimanager/7.6.0/new-features/380910/overview", version: null }, { label: "FortiManager 7.6—CLI Reference", url: "https://docs.fortinet.com/document/fortimanager/7.6.7/cli-reference/23811/introduction", version: null }],
      },
  ...
  {
    slug: "fortinet-nse-6-fortinac-administrator",
    examCode: "NSE 6",
    examName: "FortiNAC Administrator",
    vendor: "fortinet",
    certification: "fortinet-nse-6-secure-networking",
    targetVersion: "FortiNAC-F 7.6, FortiOS 7.6",
    blueprintSourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=fortinac_administrator_exam",
    blueprintSourceLabel: "Fortinet NSE Certification Program, effective 15 July 2026",
    status: "published",
    examFacts: {
      questions: "30–35 questions",
      ...
      passMark: "Pass or fail. A score report is available from your Pearson VUE account.",
      cost: "See Pearson VUE for current pricing",
      note: "Time allowed: 60–70 minutes. Language: English. Product version: FortiNAC-F 7.6, FortiOS 7.6.",
    },
    sections: [
      {
        id: "section-1",
        title: "Concepts and initial configuration (10–20% of the exam)",
        objectives: [
      {
        id: "1.01",
        text: "Model and organize infrastructure devices",
        relatedArticles: ["fortinac-device-modeling-and-profiling"],
        relatedTools: [],
        manualLinks: [{ label: "FortiNAC-F—Administration Guide 7.6", url: "https://docs.fortinet.com/document/fortinac-f/7.6.0/administration-guide", version: null }, { label: "FortiNAC-F—Deployment Guide 7.6", url: "https://docs.fortinet.com/document/fortinac-f/7.6.0/fortinac-deployment-guide", version: null }, { label: "FortiNAC-F—Manager 7.6", url: "https://docs.fortinet.com/document/fortinac-f/7.6.0/fortinac-manager", version: null }],
      },
      {
        id: "1.02",
        text: "Explain isolation networks and the configuration wizard",
        relatedArticles: ["fortinac-isolation-access-control-and-onboarding"],
        relatedTools: [],
        manualLinks: [{ label: "FortiNAC-F—Administration Guide 7.6", url: "https://docs.fortinet.com/document/fortinac-f/7.6.0/administration-guide", version: null }, { label: "FortiNAC-F—Deployment Guide 7.6", url: "https://docs.fortinet.com/document/fortinac-f/7.6.0/fortinac-deployment-guide", version: null }, { label: "FortiNAC-F—Manager 7.6", url: "https://docs.fortinet.com/document/fortinac-f/7.6.0/fortinac-manager", version: null }],
      },
        ],
      ...
      {
        id: "section-2",
        title: "Deployment and provisioning (30–40% of the exam)",
        objectives: [
      {
        id: "2.01",
        text: "Configure security automation",
        relatedArticles: ["fortinac-isolation-access-control-and-onboarding"],
        relatedTools: [],
        manualLinks: [{ label: "FortiNAC-F—Administration Guide 7.6", url: "https://docs.fortinet.com/document/fortinac-f/7.6.0/administration-guide", version: null }, { label: "FortiNAC-F—Deployment Guide 7.6", url: "https://docs.fortinet.com/document/fortinac-f/7.6.0/fortinac-deployment-guide", version: null }, { label: "FortiNAC-F—Manager 7.6", url: "https://docs.fortinet.com/document/fortinac-f/7.6.0/fortinac-manager", version: null }],
      },
      {
        id: "2.02",
        text: "Configure access control on FortiNAC-F",
        relatedArticles: ["fortinac-isolation-access-control-and-onboarding"],
        relatedTools: [],
        manualLinks: [{ label: "FortiNAC-F—Administration Guide 7.6", url: "https://docs.fortinet.com/document/fortinac-f/7.6.0/administration-guide", version: null }, { label: "FortiNAC-F—Deployment Guide 7.6", url: "https://docs.fortinet.com/document/fortinac-f/7.6.0/fortinac-deployment-guide", version: null }, { label: "FortiNAC-F—Manager 7.6", url: "https://docs.fortinet.com/document/fortinac-f/7.6.0/fortinac-manager", version: null }],
      },
      {
        id: "2.03",
        text: "Configure and monitor high availability (HA)",
        relatedArticles: ["fortigate-fgcp-ha-clustering"],
        relatedTools: ["fortigate-ha-failover-simulator"],
        manualLinks: [{ label: "FortiNAC-F—Administration Guide 7.6", url: "https://docs.fortinet.com/document/fortinac-f/7.6.0/administration-guide", version: null }, { label: "FortiNAC-F—Deployment Guide 7.6", url: "https://docs.fortinet.com/document/fortinac-f/7.6.0/fortinac-deployment-guide", version: null }, { label: "FortiNAC-F—Manager 7.6", url: "https://docs.fortinet.com/document/fortinac-f/7.6.0/fortinac-manager", version: null }],
      },
      {
        id: "2.04",
        text: "Configure FortiNAC-F security policies",
        relatedArticles: ["fortigate-firewall-policy-and-nat"],
        relatedTools: ["fortigate-policy-lookup-explainer"],
        manualLinks: [{ label: "FortiNAC-F—Administration Guide 7.6", url: "https://docs.fortinet.com/document/fortinac-f/7.6.0/administration-guide", version: null }, { label: "FortiNAC-F—Deployment Guide 7.6", url: "https://docs.fortinet.com/document/fortinac-f/7.6.0/fortinac-deployment-guide", version: null }, { label: "FortiNAC-F—Manager 7.6", url: "https://docs.fortinet.com/document/fortinac-f/7.6.0/fortinac-manager", version: null }],
      },
      ...
      {
        id: "section-3",
        title: "Integration (15–25% of the exam)",
        objectives: [
      {
        id: "3.01",
        text: "Integrate with third-party devices using syslog and SNMP trap input",
        relatedArticles: ["fortinac-isolation-access-control-and-onboarding"],
        relatedTools: [],
        manualLinks: [{ label: "FortiNAC-F—Administration Guide 7.6", url: "https://docs.fortinet.com/document/fortinac-f/7.6.0/administration-guide", version: null }, { label: "FortiNAC-F—Deployment Guide 7.6", url: "https://docs.fortinet.com/document/fortinac-f/7.6.0/fortinac-deployment-guide", version: null }, { label: "FortiNAC-F—Manager 7.6", url: "https://docs.fortinet.com/document/fortinac-f/7.6.0/fortinac-manager", version: null }],
      },
      {
        id: "3.02",
        text: "Configure and use FortiNAC-F Manager",
        relatedArticles: ["fortinac-device-modeling-and-profiling"],
        relatedTools: [],
        manualLinks: [{ label: "FortiNAC-F—Administration Guide 7.6", url: "https://docs.fortinet.com/document/fortinac-f/7.6.0/administration-guide", version: null }, { label: "FortiNAC-F—Deployment Guide 7.6", url: "https://docs.fortinet.com/document/fortinac-f/7.6.0/fortinac-deployment-guide", version: null }, { label: "FortiNAC-F—Manager 7.6", url: "https://docs.fortinet.com/document/fortinac-f/7.6.0/fortinac-manager", version: null }],
      },
      {
        id: "3.03",
        text: "Configure FortiGate VPN integration with FortiNAC-F",
        relatedArticles: ["fortigate-ipsec-vpn-topologies"],
        relatedTools: ["fortigate-ipsec-phase-mismatch-analyzer"],
        manualLinks: [{ label: "FortiNAC-F—Administration Guide 7.6", url: "https://docs.fortinet.com/document/fortinac-f/7.6.0/administration-guide", version: null }, { label: "FortiNAC-F—Deployment Guide 7.6", url: "https://docs.fortinet.com/document/fortinac-f/7.6.0/fortinac-deployment-guide", version: null }, { label: "FortiNAC-F—Manager 7.6", url: "https://docs.fortinet.com/document/fortinac-f/7.6.0/fortinac-manager", version: null }],
      },
      {
        id: "3.04",
        text: "Explain and configure MDM integration",
        relatedArticles: ["fortinac-isolation-access-control-and-onboarding"],
        relatedTools: [],
        manualLinks: [{ label: "FortiNAC-F—Administration Guide 7.6", url: "https://docs.fortinet.com/document/fortinac-f/7.6.0/administration-guide", version: null }, { label: "FortiNAC-F—Deployment Guide 7.6", url: "https://docs.fortinet.com/document/fortinac-f/7.6.0/fortinac-deployment-guide", version: null }, { label: "FortiNAC-F—Manager 7.6", url: "https://docs.fortinet.com/document/fortinac-f/7.6.0/fortinac-manager", version: null }],
      },
      ...
      {
        id: "section-4",
        title: "Network visibility and monitoring (25–35% of the exam)",
        objectives: [
      {
        id: "4.01",
        text: "Configure guests and contractors",
        relatedArticles: ["fortinac-isolation-access-control-and-onboarding"],
        relatedTools: [],
        manualLinks: [{ label: "FortiNAC-F—Administration Guide 7.6", url: "https://docs.fortinet.com/document/fortinac-f/7.6.0/administration-guide", version: null }, { label: "FortiNAC-F—Deployment Guide 7.6", url: "https://docs.fortinet.com/document/fortinac-f/7.6.0/fortinac-deployment-guide", version: null }, { label: "FortiNAC-F—Manager 7.6", url: "https://docs.fortinet.com/document/fortinac-f/7.6.0/fortinac-manager", version: null }],
      },
      {
        id: "4.02",
        text: "Explain and configure device profiling",
        relatedArticles: ["fortinac-device-modeling-and-profiling"],
        relatedTools: [],
        manualLinks: [{ label: "FortiNAC-F—Administration Guide 7.6", url: "https://docs.fortinet.com/document/fortinac-f/7.6.0/administration-guide", version: null }, { label: "FortiNAC-F—Deployment Guide 7.6", url: "https://docs.fortinet.com/document/fortinac-f/7.6.0/fortinac-deployment-guide", version: null }, { label: "FortiNAC-F—Manager 7.6", url: "https://docs.fortinet.com/document/fortinac-f/7.6.0/fortinac-manager", version: null }],
      },
      {
        id: "4.03",
        text: "Troubleshoot network devices and device status",
        relatedArticles: ["fortinac-device-modeling-and-profiling"],
        relatedTools: [],
        manualLinks: [{ label: "FortiNAC-F—Administration Guide 7.6", url: "https://docs.fortinet.com/document/fortinac-f/7.6.0/administration-guide", version: null }, { label: "FortiNAC-F—Deployment Guide 7.6", url: "https://docs.fortinet.com/document/fortinac-f/7.6.0/fortinac-deployment-guide", version: null }, { label: "FortiNAC-F—Manager 7.6", url: "https://docs.fortinet.com/document/fortinac-f/7.6.0/fortinac-manager", version: null }],
      },
  ...
  {
    slug: "fortinet-nse-6-fortivoice-administrator",
    examCode: "NSE 6",
    examName: "FortiVoice Administrator",
    vendor: "fortinet",
    certification: "fortinet-nse-6-secure-networking",
    targetVersion: null,
    blueprintSourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=fortivoice_administrator_exam",
    blueprintSourceLabel: "Fortinet NSE Certification Program, effective 15 July 2026",
    status: "preparing",
    examFacts: null,
    sections: [],
  ...
  {
    slug: "fortinet-nse-6-forticlient-ems-administrator",
    examCode: "NSE 6",
    examName: "FortiClient EMS Administrator",
    vendor: "fortinet",
    certification: "fortinet-nse-6-sase",
    targetVersion: "FortiClient EMS 7.4, FortiGate 7.6, FortiClient 7.4",
    blueprintSourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=forticlient_ems_administrator_exam",
    blueprintSourceLabel: "Fortinet NSE Certification Program, effective 15 July 2026",
    status: "published",
    retirement: {
    ...
    examFacts: {
      ...
      passMark: "Pass or fail. A score report is available from your Pearson VUE account.",
      cost: "See Pearson VUE for current pricing",
      note: "Time allowed: 60–70 minutes. Language: English, Japanese. Product version: FortiClient EMS 7.4, FortiGate 7.6, FortiClient 7.4.",
    },
    sections: [
      {
        id: "section-1",
        title: "FortiClient EMS design and deployment",
        objectives: [
      {
        id: "1.01",
        text: "Describe FortiClient EMS architecture, components, and deployment modes",
        relatedArticles: ["forticlient-ems-architecture-and-deployment"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.02",
        text: "Perform installation and configuration of FortiClient EMS",
        relatedArticles: ["forticlient-ems-architecture-and-deployment"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "section-2",
        title: "FortiClient provisioning and deployment",
        objectives: [
      {
        id: "2.01",
        text: "Deploy FortiClient on endpoint devices",
        relatedArticles: ["forticlient-ems-architecture-and-deployment"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "2.02",
        text: "Configure endpoint profiles to provision endpoint devices",
        relatedArticles: ["forticlient-ems-architecture-and-deployment"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "2.03",
        text: "Implement endpoint security",
        relatedArticles: ["forticlient-ems-endpoint-security-ztna-and-troubleshooting"],
        relatedTools: [],
        manualLinks: [],
      },
        ],
      ...
      {
        id: "section-3",
        title: "Zero trust and Security Fabric integration",
        objectives: [
      {
        id: "3.01",
        text: "Configure Security Fabric integration",
        relatedArticles: ["fortigate-firewall-policy-and-nat"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "3.02",
        text: "Set up quarantine for compromised endpoints",
        relatedArticles: ["forticlient-ems-endpoint-security-ztna-and-troubleshooting"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "3.03",
        text: "Implement zero trust network access for endpoints",
        relatedArticles: ["forticlient-ems-endpoint-security-ztna-and-troubleshooting"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "4.01",
        text: "Analyze diagnostic information to troubleshoot EMS and endpoint issues",
        relatedArticles: ["forticlient-ems-endpoint-security-ztna-and-troubleshooting"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "4.02",
        text: "Resolve common deployment and configuration issues",
        relatedArticles: ["forticlient-ems-endpoint-security-ztna-and-troubleshooting", "forticlient-ems-architecture-and-deployment"],
        relatedTools: [],
        manualLinks: [],
      },
        ],
  ...
  {
    slug: "fortinet-nse-6-fortidlp-administrator",
    examCode: "NSE 6",
    examName: "FortiDLP Administrator",
    vendor: "fortinet",
    certification: "fortinet-nse-6-sase",
    targetVersion: "FortiDLP 26",
    blueprintSourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=fortidlp_administrator_exam",
    blueprintSourceLabel: "Fortinet NSE Certification Program, effective 15 July 2026",
    status: "published",
    examFacts: {
      questions: "30–40 questions",
      ...
      passMark: "Pass or fail. A score report is available from your Pearson VUE account.",
      cost: "See Pearson VUE for current pricing",
      note: "Time allowed: 60–70 minutes. Language: English. Product version: FortiDLP 26.",
    },
    sections: [
      {
        id: "section-1",
        title: "FortiDLP fundamentals and deployment (25-35% of the exam)",
        objectives: [
      {
        id: "1.01",
        text: "Explain FortiDLP concepts and architecture",
        relatedArticles: ["fortidlp-architecture-and-deployment"],
        relatedTools: [],
        manualLinks: [{ label: "FortiDLP—Administration Guide", url: "https://docs.fortinet.com/document/fortidlp/latest/fortidlp-administration-guide", version: null }, { label: "FortiDLP Console—User Guide", url: "https://docs.fortinet.com/document/fortidlp/latest/fortidlp-console-user-guide", version: null }, { label: "FortiDLP LDAP Sync Tool—Administration Guide", url: "https://docs.fortinet.com/document/fortidlp/latest/fortidlp-ldap-sync-tool-administration-guide", version: null }, { label: "FortiDLP Agent 12.4.2—Deployment Guide", url: "https://docs.fortinet.com/document/fortidlp/latest/fortidlp-agent-deployment-guide", version: null }],
      },
      {
        id: "1.02",
        text: "Deploy FortiDLP tenants and agents",
        relatedArticles: ["fortidlp-architecture-and-deployment"],
        relatedTools: [],
        manualLinks: [{ label: "FortiDLP—Administration Guide", url: "https://docs.fortinet.com/document/fortidlp/latest/fortidlp-administration-guide", version: null }, { label: "FortiDLP Console—User Guide", url: "https://docs.fortinet.com/document/fortidlp/latest/fortidlp-console-user-guide", version: null }, { label: "FortiDLP LDAP Sync Tool—Administration Guide", url: "https://docs.fortinet.com/document/fortidlp/latest/fortidlp-ldap-sync-tool-administration-guide", version: null }, { label: "FortiDLP Agent 12.4.2—Deployment Guide", url: "https://docs.fortinet.com/document/fortidlp/latest/fortidlp-agent-deployment-guide", version: null }],
      },
      {
        id: "1.03",
        text: "Integrate FortiDLP with Software-as-a-Service (SaaS)",
        relatedArticles: ["fortidlp-architecture-and-deployment"],
        relatedTools: [],
        manualLinks: [{ label: "FortiDLP—Administration Guide", url: "https://docs.fortinet.com/document/fortidlp/latest/fortidlp-administration-guide", version: null }, { label: "FortiDLP Console—User Guide", url: "https://docs.fortinet.com/document/fortidlp/latest/fortidlp-console-user-guide", version: null }, { label: "FortiDLP LDAP Sync Tool—Administration Guide", url: "https://docs.fortinet.com/document/fortidlp/latest/fortidlp-ldap-sync-tool-administration-guide", version: null }, { label: "FortiDLP Agent 12.4.2—Deployment Guide", url: "https://docs.fortinet.com/document/fortidlp/latest/fortidlp-agent-deployment-guide", version: null }],
      },
      ...
      {
        id: "section-2",
        title: "Data identification and enforcement (20-30% of exam)",
        objectives: [
      {
        id: "2.01",
        text: "Create and manage DLP policies",
        relatedArticles: ["fortigate-security-profiles-flow-vs-proxy"],
        relatedTools: ["fortigate-security-profile-coverage-checker"],
        manualLinks: [{ label: "FortiDLP—Administration Guide", url: "https://docs.fortinet.com/document/fortidlp/latest/fortidlp-administration-guide", version: null }, { label: "FortiDLP Console—User Guide", url: "https://docs.fortinet.com/document/fortidlp/latest/fortidlp-console-user-guide", version: null }, { label: "FortiDLP LDAP Sync Tool—Administration Guide", url: "https://docs.fortinet.com/document/fortidlp/latest/fortidlp-ldap-sync-tool-administration-guide", version: null }, { label: "FortiDLP Agent 12.4.2—Deployment Guide", url: "https://docs.fortinet.com/document/fortidlp/latest/fortidlp-agent-deployment-guide", version: null }],
      },
      {
        id: "2.02",
        text: "Configure actions and data protection",
        relatedArticles: ["fortidlp-detection-investigation-and-troubleshooting"],
        relatedTools: [],
        manualLinks: [{ label: "FortiDLP—Administration Guide", url: "https://docs.fortinet.com/document/fortidlp/latest/fortidlp-administration-guide", version: null }, { label: "FortiDLP Console—User Guide", url: "https://docs.fortinet.com/document/fortidlp/latest/fortidlp-console-user-guide", version: null }, { label: "FortiDLP LDAP Sync Tool—Administration Guide", url: "https://docs.fortinet.com/document/fortidlp/latest/fortidlp-ldap-sync-tool-administration-guide", version: null }, { label: "FortiDLP Agent 12.4.2—Deployment Guide", url: "https://docs.fortinet.com/document/fortidlp/latest/fortidlp-agent-deployment-guide", version: null }],
      },
      {
        id: "2.03",
        text: "Manage assets, nodes, and user activity",
        relatedArticles: ["fortidlp-architecture-and-deployment"],
        relatedTools: [],
        manualLinks: [{ label: "FortiDLP—Administration Guide", url: "https://docs.fortinet.com/document/fortidlp/latest/fortidlp-administration-guide", version: null }, { label: "FortiDLP Console—User Guide", url: "https://docs.fortinet.com/document/fortidlp/latest/fortidlp-console-user-guide", version: null }, { label: "FortiDLP LDAP Sync Tool—Administration Guide", url: "https://docs.fortinet.com/document/fortidlp/latest/fortidlp-ldap-sync-tool-administration-guide", version: null }, { label: "FortiDLP Agent 12.4.2—Deployment Guide", url: "https://docs.fortinet.com/document/fortidlp/latest/fortidlp-agent-deployment-guide", version: null }],
      },
      ...
      {
        id: "section-3",
        title: "Detection and investigation (15-25% of exam)",
        objectives: [
      {
        id: "3.01",
        text: "Investigate events, cases, and incidents",
        relatedArticles: ["fortidlp-detection-investigation-and-troubleshooting"],
        relatedTools: [],
        manualLinks: [{ label: "FortiDLP—Administration Guide", url: "https://docs.fortinet.com/document/fortidlp/latest/fortidlp-administration-guide", version: null }, { label: "FortiDLP Console—User Guide", url: "https://docs.fortinet.com/document/fortidlp/latest/fortidlp-console-user-guide", version: null }, { label: "FortiDLP LDAP Sync Tool—Administration Guide", url: "https://docs.fortinet.com/document/fortidlp/latest/fortidlp-ldap-sync-tool-administration-guide", version: null }, { label: "FortiDLP Agent 12.4.2—Deployment Guide", url: "https://docs.fortinet.com/document/fortidlp/latest/fortidlp-agent-deployment-guide", version: null }],
      },
      {
        id: "3.02",
        text: "Monitor event visibility and behavior analytics",
        relatedArticles: ["fortidlp-detection-investigation-and-troubleshooting"],
        relatedTools: [],
        manualLinks: [{ label: "FortiDLP—Administration Guide", url: "https://docs.fortinet.com/document/fortidlp/latest/fortidlp-administration-guide", version: null }, { label: "FortiDLP Console—User Guide", url: "https://docs.fortinet.com/document/fortidlp/latest/fortidlp-console-user-guide", version: null }, { label: "FortiDLP LDAP Sync Tool—Administration Guide", url: "https://docs.fortinet.com/document/fortidlp/latest/fortidlp-ldap-sync-tool-administration-guide", version: null }, { label: "FortiDLP Agent 12.4.2—Deployment Guide", url: "https://docs.fortinet.com/document/fortidlp/latest/fortidlp-agent-deployment-guide", version: null }],
      },
      ...
      {
        id: "section-4",
        title: "Troubleshooting (15-25% of exam)",
        objectives: [
      {
        id: "4.01",
        text: "Troubleshoot agent issues",
        relatedArticles: ["fortidlp-detection-investigation-and-troubleshooting"],
        relatedTools: [],
        manualLinks: [{ label: "FortiDLP—Administration Guide", url: "https://docs.fortinet.com/document/fortidlp/latest/fortidlp-administration-guide", version: null }, { label: "FortiDLP Console—User Guide", url: "https://docs.fortinet.com/document/fortidlp/latest/fortidlp-console-user-guide", version: null }, { label: "FortiDLP LDAP Sync Tool—Administration Guide", url: "https://docs.fortinet.com/document/fortidlp/latest/fortidlp-ldap-sync-tool-administration-guide", version: null }, { label: "FortiDLP Agent 12.4.2—Deployment Guide", url: "https://docs.fortinet.com/document/fortidlp/latest/fortidlp-agent-deployment-guide", version: null }],
      },
      {
        id: "4.02",
        text: "Analyze audit logs, debug logs, and performance reports",
        relatedArticles: ["fortidlp-detection-investigation-and-troubleshooting"],
        relatedTools: [],
        manualLinks: [{ label: "FortiDLP—Administration Guide", url: "https://docs.fortinet.com/document/fortidlp/latest/fortidlp-administration-guide", version: null }, { label: "FortiDLP Console—User Guide", url: "https://docs.fortinet.com/document/fortidlp/latest/fortidlp-console-user-guide", version: null }, { label: "FortiDLP LDAP Sync Tool—Administration Guide", url: "https://docs.fortinet.com/document/fortidlp/latest/fortidlp-ldap-sync-tool-administration-guide", version: null }, { label: "FortiDLP Agent 12.4.2—Deployment Guide", url: "https://docs.fortinet.com/document/fortidlp/latest/fortidlp-agent-deployment-guide", version: null }],
      },
  ...
  {
    slug: "fortinet-nse-6-fortiedr-administrator",
    examCode: "NSE 6",
    examName: "FortiEDR Administrator",
    vendor: "fortinet",
    certification: "fortinet-nse-6-sase",
    targetVersion: "FortiEDR 7.0",
    blueprintSourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=fortiedr_administrator_exam",
    blueprintSourceLabel: "Fortinet NSE Certification Program, effective 15 July 2026",
    status: "published",
    examFacts: {
      questions: "30–35 questions",
      ...
      passMark: "Pass or fail. A score report is available from your Pearson VUE account.",
      cost: "See Pearson VUE for current pricing",
      note: "Time allowed: 60–70 minutes. Language: English. Product version: FortiEDR 7.0.",
    },
    sections: [
      {
        id: "section-1",
        title: "FortiEDR system",
        objectives: [
      {
        id: "1.01",
        text: "Explain FortiEDR architecture and technical positioning",
        relatedArticles: ["fortiedr-architecture-and-deployment"],
        relatedTools: [],
        manualLinks: [{ label: "FortiEDR—Installation and Administration Guide 7.0", url: "https://docs.fortinet.com/document/fortiedr/7.0.0/administration-guide/354083/introducing-fortiedr", version: null }],
      },
      {
        id: "1.02",
        text: "Perform installation process",
        relatedArticles: ["fortiedr-architecture-and-deployment"],
        relatedTools: [],
        manualLinks: [{ label: "FortiEDR—Installation and Administration Guide 7.0", url: "https://docs.fortinet.com/document/fortiedr/7.0.0/administration-guide/354083/introducing-fortiedr", version: null }],
      },
      {
        id: "1.03",
        text: "Perform FortiEDR inventory and use system tools",
        relatedArticles: ["fortiedr-architecture-and-deployment"],
        relatedTools: [],
        manualLinks: [{ label: "FortiEDR—Installation and Administration Guide 7.0", url: "https://docs.fortinet.com/document/fortiedr/7.0.0/administration-guide/354083/introducing-fortiedr", version: null }],
      },
      {
        id: "1.04",
        text: "Deploy FortiEDR multi-tenancy",
        relatedArticles: ["fortiedr-architecture-and-deployment"],
        relatedTools: [],
        manualLinks: [{ label: "FortiEDR—Installation and Administration Guide 7.0", url: "https://docs.fortinet.com/document/fortiedr/7.0.0/administration-guide/354083/introducing-fortiedr", version: null }],
      },
      {
        id: "1.05",
        text: "Use API to carry out FortiEDR management functions",
        relatedArticles: ["fortiedr-architecture-and-deployment"],
        relatedTools: [],
        manualLinks: [{ label: "FortiEDR—Installation and Administration Guide 7.0", url: "https://docs.fortinet.com/document/fortiedr/7.0.0/administration-guide/354083/introducing-fortiedr", version: null }],
      },
      ...
      {
        id: "section-2",
        title: "FortiEDR security settings and policies",
        objectives: [
      {
        id: "2.01",
        text: "Configure communication control policy",
        relatedArticles: ["fortiedr-policies-playbooks-and-communication-control"],
        relatedTools: [],
        manualLinks: [{ label: "FortiEDR—Installation and Administration Guide 7.0", url: "https://docs.fortinet.com/document/fortiedr/7.0.0/administration-guide/354083/introducing-fortiedr", version: null }],
      },
      {
      ...
      {
        id: "2.04",
        text: "Explain Fortinet Cloud Service (FCS)",
        relatedArticles: ["fortiedr-architecture-and-deployment"],
        relatedTools: [],
        manualLinks: [{ label: "FortiEDR—Installation and Administration Guide 7.0", url: "https://docs.fortinet.com/document/fortiedr/7.0.0/administration-guide/354083/introducing-fortiedr", version: null }],
      },
      ...
      {
        id: "section-3",
        title: "Events, forensics, and threat hunting",
        objectives: [
      {
        id: "3.01",
        text: "Analyze security events and alerts",
        relatedArticles: ["fortiedr-threat-hunting-forensics-and-investigation"],
        relatedTools: [],
        manualLinks: [{ label: "FortiEDR—Installation and Administration Guide 7.0", url: "https://docs.fortinet.com/document/fortiedr/7.0.0/administration-guide/354083/introducing-fortiedr", version: null }],
      },
      {
        id: "3.02",
        text: "Configure threat hunting profiles and scheduled queries",
        relatedArticles: ["fortiedr-threat-hunting-forensics-and-investigation"],
        relatedTools: [],
        manualLinks: [{ label: "FortiEDR—Installation and Administration Guide 7.0", url: "https://docs.fortinet.com/document/fortiedr/7.0.0/administration-guide/354083/introducing-fortiedr", version: null }],
      },
      {
        id: "3.03",
        text: "Analyze threat hunting data",
        relatedArticles: ["fortiedr-threat-hunting-forensics-and-investigation"],
        relatedTools: [],
        manualLinks: [{ label: "FortiEDR—Installation and Administration Guide 7.0", url: "https://docs.fortinet.com/document/fortiedr/7.0.0/administration-guide/354083/introducing-fortiedr", version: null }],
      },
      {
        id: "3.04",
        text: "Investigate security events using forensics analysis",
        relatedArticles: ["fortiedr-threat-hunting-forensics-and-investigation"],
        relatedTools: [],
        manualLinks: [{ label: "FortiEDR—Installation and Administration Guide 7.0", url: "https://docs.fortinet.com/document/fortiedr/7.0.0/administration-guide/354083/introducing-fortiedr", version: null }],
      },
      ...
      {
        id: "section-4",
        title: "FortiEDR integration",
        objectives: [
      {
        id: "4.01",
        text: "Deploy FortiXDR",
        relatedArticles: ["fortiedr-threat-hunting-forensics-and-investigation"],
        relatedTools: [],
        manualLinks: [{ label: "FortiEDR—Installation and Administration Guide 7.0", url: "https://docs.fortinet.com/document/fortiedr/7.0.0/administration-guide/354083/introducing-fortiedr", version: null }],
      },
      {
        id: "4.02",
        text: "Configure security fabric using FortiEDR",
        relatedArticles: ["fortigate-firewall-policy-and-nat"],
        relatedTools: [],
        manualLinks: [{ label: "FortiEDR—Installation and Administration Guide 7.0", url: "https://docs.fortinet.com/document/fortiedr/7.0.0/administration-guide/354083/introducing-fortiedr", version: null }],
      },
      ...
      {
        id: "section-5",
        title: "FortiEDR troubleshooting",
        objectives: [
      {
        id: "5.01",
        text: "Perform FortiEDR troubleshooting",
        relatedArticles: ["fortiedr-threat-hunting-forensics-and-investigation"],
        relatedTools: [],
        manualLinks: [{ label: "FortiEDR—Installation and Administration Guide 7.0", url: "https://docs.fortinet.com/document/fortiedr/7.0.0/administration-guide/354083/introducing-fortiedr", version: null }],
      },
      {
        id: "5.02",
        text: "Perform alert analysis on FortiEDR security events and logs",
        relatedArticles: ["fortiedr-threat-hunting-forensics-and-investigation"],
        relatedTools: [],
        manualLinks: [{ label: "FortiEDR—Installation and Administration Guide 7.0", url: "https://docs.fortinet.com/document/fortiedr/7.0.0/administration-guide/354083/introducing-fortiedr", version: null }],
      },
  ...
  {
    slug: "fortinet-nse-6-forticnapp-analyst",
    examCode: "NSE 6",
    examName: "FortiCNAPP Analyst",
    vendor: "fortinet",
    certification: "fortinet-nse-6-cloud-security",
    targetVersion: "FortiCNAPP 26",
    blueprintSourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=forticnapp_analyst_exam",
    blueprintSourceLabel: "Fortinet NSE Certification Program, effective 15 July 2026",
    status: "published",
    examFacts: {
      questions: "30–40 questions",
      ...
      passMark: "Pass or fail. A score report is available from your Pearson VUE account.",
      cost: "See Pearson VUE for current pricing",
      note: "Time allowed: 65–75 minutes. Language: English. Product version: FortiCNAPP 26.",
    },
    sections: [
      {
        id: "section-1",
        title: "FortiCNAPP fundamentals (25–35% of the exam)",
        objectives: [
      {
        id: "1.01",
        text: "FortiCNAPP Fundamentals",
        relatedArticles: ["forticnapp-fundamentals-and-cloud-posture"],
        relatedTools: [],
        manualLinks: [{ label: "FortiCNAPP 26—Administration Guide", url: "https://docs.fortinet.com/document/forticnapp/latest/alerts-reference/265681/introduction", version: null }, { label: "Lacework FortiCNAPP 26—API Reference", url: "https://docs.fortinet.com/document/forticnapp/latest/api-reference/863111/about-the-lacework-forticnapp-api", version: null }, { label: "FortiCNAPP 26—Policies", url: "https://docs.fortinet.com/document/forticnapp/latest/lacework-forticnapp-policies/254325/forticnapp-policies", version: null }, { label: "LQL Reference Guide", url: "https://docs.fortinet.com/document/forticnapp/latest/lql-reference/598361/lql-overview", version: null }],
      },
      {
        id: "1.02",
        text: "Configure FortiCNAPP integration with cloud accounts",
        relatedArticles: ["forticnapp-fundamentals-and-cloud-posture"],
        relatedTools: [],
        manualLinks: [{ label: "FortiCNAPP 26—Administration Guide", url: "https://docs.fortinet.com/document/forticnapp/latest/alerts-reference/265681/introduction", version: null }, { label: "Lacework FortiCNAPP 26—API Reference", url: "https://docs.fortinet.com/document/forticnapp/latest/api-reference/863111/about-the-lacework-forticnapp-api", version: null }, { label: "FortiCNAPP 26—Policies", url: "https://docs.fortinet.com/document/forticnapp/latest/lacework-forticnapp-policies/254325/forticnapp-policies", version: null }, { label: "LQL Reference Guide", url: "https://docs.fortinet.com/document/forticnapp/latest/lql-reference/598361/lql-overview", version: null }],
      },
      {
        id: "1.03",
        text: "Explain the different deployment models",
        relatedArticles: ["forticnapp-fundamentals-and-cloud-posture"],
        relatedTools: [],
        manualLinks: [{ label: "FortiCNAPP 26—Administration Guide", url: "https://docs.fortinet.com/document/forticnapp/latest/alerts-reference/265681/introduction", version: null }, { label: "Lacework FortiCNAPP 26—API Reference", url: "https://docs.fortinet.com/document/forticnapp/latest/api-reference/863111/about-the-lacework-forticnapp-api", version: null }, { label: "FortiCNAPP 26—Policies", url: "https://docs.fortinet.com/document/forticnapp/latest/lacework-forticnapp-policies/254325/forticnapp-policies", version: null }, { label: "LQL Reference Guide", url: "https://docs.fortinet.com/document/forticnapp/latest/lql-reference/598361/lql-overview", version: null }],
      },
      ...
      {
        id: "section-2",
        title: "End-to-end risk management (35–45% of the exam)",
        objectives: [
      {
        id: "2.01",
        text: "Detect risks with FortiCNAPP",
        relatedArticles: ["forticnapp-fundamentals-and-cloud-posture"],
        relatedTools: [],
        manualLinks: [{ label: "FortiCNAPP 26—Administration Guide", url: "https://docs.fortinet.com/document/forticnapp/latest/alerts-reference/265681/introduction", version: null }, { label: "Lacework FortiCNAPP 26—API Reference", url: "https://docs.fortinet.com/document/forticnapp/latest/api-reference/863111/about-the-lacework-forticnapp-api", version: null }, { label: "FortiCNAPP 26—Policies", url: "https://docs.fortinet.com/document/forticnapp/latest/lacework-forticnapp-policies/254325/forticnapp-policies", version: null }, { label: "LQL Reference Guide", url: "https://docs.fortinet.com/document/forticnapp/latest/lql-reference/598361/lql-overview", version: null }],
      },
      {
        id: "2.02",
        text: "Identify non-compliant assets",
        relatedArticles: ["forticnapp-fundamentals-and-cloud-posture"],
        relatedTools: [],
        manualLinks: [{ label: "FortiCNAPP 26—Administration Guide", url: "https://docs.fortinet.com/document/forticnapp/latest/alerts-reference/265681/introduction", version: null }, { label: "Lacework FortiCNAPP 26—API Reference", url: "https://docs.fortinet.com/document/forticnapp/latest/api-reference/863111/about-the-lacework-forticnapp-api", version: null }, { label: "FortiCNAPP 26—Policies", url: "https://docs.fortinet.com/document/forticnapp/latest/lacework-forticnapp-policies/254325/forticnapp-policies", version: null }, { label: "LQL Reference Guide", url: "https://docs.fortinet.com/document/forticnapp/latest/lql-reference/598361/lql-overview", version: null }],
      },
      {
        id: "2.03",
        text: "Explain shift-left security",
        relatedArticles: ["forticnapp-shift-left-threat-detection-and-remediation"],
        relatedTools: [],
        manualLinks: [{ label: "FortiCNAPP 26—Administration Guide", url: "https://docs.fortinet.com/document/forticnapp/latest/alerts-reference/265681/introduction", version: null }, { label: "Lacework FortiCNAPP 26—API Reference", url: "https://docs.fortinet.com/document/forticnapp/latest/api-reference/863111/about-the-lacework-forticnapp-api", version: null }, { label: "FortiCNAPP 26—Policies", url: "https://docs.fortinet.com/document/forticnapp/latest/lacework-forticnapp-policies/254325/forticnapp-policies", version: null }, { label: "LQL Reference Guide", url: "https://docs.fortinet.com/document/forticnapp/latest/lql-reference/598361/lql-overview", version: null }],
      },
      {
        id: "2.04",
        text: "Remediate risks with FortiCNAPP",
        relatedArticles: ["forticnapp-shift-left-threat-detection-and-remediation"],
        relatedTools: [],
        manualLinks: [{ label: "FortiCNAPP 26—Administration Guide", url: "https://docs.fortinet.com/document/forticnapp/latest/alerts-reference/265681/introduction", version: null }, { label: "Lacework FortiCNAPP 26—API Reference", url: "https://docs.fortinet.com/document/forticnapp/latest/api-reference/863111/about-the-lacework-forticnapp-api", version: null }, { label: "FortiCNAPP 26—Policies", url: "https://docs.fortinet.com/document/forticnapp/latest/lacework-forticnapp-policies/254325/forticnapp-policies", version: null }, { label: "LQL Reference Guide", url: "https://docs.fortinet.com/document/forticnapp/latest/lql-reference/598361/lql-overview", version: null }],
      },
      ...
      {
        id: "section-3",
        title: "Threat detection and response (25–35%of exam)",
        objectives: [
      {
        id: "3.01",
        text: "Investigate threats with FortiCNAPP",
        relatedArticles: ["forticnapp-shift-left-threat-detection-and-remediation"],
        relatedTools: [],
        manualLinks: [{ label: "FortiCNAPP 26—Administration Guide", url: "https://docs.fortinet.com/document/forticnapp/latest/alerts-reference/265681/introduction", version: null }, { label: "Lacework FortiCNAPP 26—API Reference", url: "https://docs.fortinet.com/document/forticnapp/latest/api-reference/863111/about-the-lacework-forticnapp-api", version: null }, { label: "FortiCNAPP 26—Policies", url: "https://docs.fortinet.com/document/forticnapp/latest/lacework-forticnapp-policies/254325/forticnapp-policies", version: null }, { label: "LQL Reference Guide", url: "https://docs.fortinet.com/document/forticnapp/latest/lql-reference/598361/lql-overview", version: null }],
      },
      {
        id: "3.02",
        text: "Respond to and remediate threats",
        relatedArticles: ["forticnapp-shift-left-threat-detection-and-remediation"],
        relatedTools: [],
        manualLinks: [{ label: "FortiCNAPP 26—Administration Guide", url: "https://docs.fortinet.com/document/forticnapp/latest/alerts-reference/265681/introduction", version: null }, { label: "Lacework FortiCNAPP 26—API Reference", url: "https://docs.fortinet.com/document/forticnapp/latest/api-reference/863111/about-the-lacework-forticnapp-api", version: null }, { label: "FortiCNAPP 26—Policies", url: "https://docs.fortinet.com/document/forticnapp/latest/lacework-forticnapp-policies/254325/forticnapp-policies", version: null }, { label: "LQL Reference Guide", url: "https://docs.fortinet.com/document/forticnapp/latest/lql-reference/598361/lql-overview", version: null }],
      },
      {
        id: "3.03",
        text: "Fine-tune threat detection",
        relatedArticles: ["forticnapp-shift-left-threat-detection-and-remediation"],
        relatedTools: [],
        manualLinks: [{ label: "FortiCNAPP 26—Administration Guide", url: "https://docs.fortinet.com/document/forticnapp/latest/alerts-reference/265681/introduction", version: null }, { label: "Lacework FortiCNAPP 26—API Reference", url: "https://docs.fortinet.com/document/forticnapp/latest/api-reference/863111/about-the-lacework-forticnapp-api", version: null }, { label: "FortiCNAPP 26—Policies", url: "https://docs.fortinet.com/document/forticnapp/latest/lacework-forticnapp-policies/254325/forticnapp-policies", version: null }, { label: "LQL Reference Guide", url: "https://docs.fortinet.com/document/forticnapp/latest/lql-reference/598361/lql-overview", version: null }],
      },
  ...
  {
    slug: "fortinet-nse-6-fortiddos-administrator",
    examCode: "NSE 6",
    examName: "FortiDDoS Administrator",
    vendor: "fortinet",
    certification: "fortinet-nse-6-cloud-security",
    targetVersion: null,
    blueprintSourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=library_fortiddos-administrator",
    blueprintSourceLabel: "Fortinet Training Institute course page (course objectives)",
    status: "published",
    sourceCaveat: "course-objectives",
    examFacts: null,
    sections: [
      ...
      {
        id: "1.02",
        text: "Choose the correct FortiDDoS model",
        relatedArticles: ["fortiddos-detection-modes-and-mitigation"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.03",
        text: "Defend against both volumetric and mechanistic DDoS attacks",
        relatedArticles: ["fortiweb-deployment-policies-and-delivery", "fortiweb-application-security-bots-api-and-dos"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.04",
        text: "Deploy FortiDDoS to protect both network appliances and servers",
        relatedArticles: ["fortiweb-deployment-policies-and-delivery", "fortiweb-application-security-bots-api-and-dos"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.05",
        text: "Identify when to use detection and prevention modes",
        relatedArticles: ["fortiddos-detection-modes-and-mitigation"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.06",
        text: "Implement bypass or a high availability FortiDDoS cluster for maximum service uptime",
        relatedArticles: ["fortigate-fgcp-ha-clustering"],
        relatedTools: ["fortigate-ha-failover-simulator"],
        manualLinks: [],
      },
      {
        id: "1.07",
        text: "Detect connections from proxies",
        relatedArticles: ["fortiddos-policies-proxies-and-operations"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.08",
        text: "Describe how the blocking periods and penalty factors intelligently determine which packets are dropped after an attack is detected",
        relatedArticles: ["fortiddos-detection-modes-and-mitigation"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.09",
        text: "Configure access control lists and blocklists",
        relatedArticles: ["fortiddos-detection-modes-and-mitigation"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.10",
        text: "Mitigate anomalies and SYN floods",
        relatedArticles: ["fortiddos-detection-modes-and-mitigation"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.11",
        text: "Describe the main characteristics of protection policies",
        relatedArticles: ["fortiddos-policies-proxies-and-operations"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.12",
        text: "Characterize different types of attacks by using logs and statistics graphs",
        relatedArticles: ["fortiddos-detection-modes-and-mitigation", "fortiddos-policies-proxies-and-operations"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.13",
        text: "Troubleshoot incorrect threshold levels",
        relatedArticles: ["fortigate-logging-and-diagnostics"],
        relatedTools: ["fortios-sniffer-builder", "fortigate-session-table-explainer"],
        manualLinks: [],
      },
  ...
  {
    slug: "fortinet-nse-6-fortimail-administrator",
    examCode: "NSE 6",
    examName: "FortiMail Administrator",
    vendor: "fortinet",
    certification: "fortinet-nse-6-cloud-security",
    targetVersion: "FortiMail 7.4",
    blueprintSourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=fortimail_administrator_exam",
    blueprintSourceLabel: "Fortinet NSE Certification Program, effective 15 July 2026",
    status: "published",
    examFacts: {
      questions: "30–40 questions",
      ...
      passMark: "Pass or fail. A score report is available from your Pearson VUE account.",
      cost: "See Pearson VUE for current pricing",
      note: "Time allowed: 65 minutes. Language: English, Japanese. Product version: FortiMail 7.4.",
    },
    sections: [
      {
        id: "section-1",
        title: "Initial deployment and basic configuration",
        objectives: [
      {
        id: "1.01",
        text: "Describe the fundamentals of SMTP and email flow",
        relatedArticles: ["fortimail-smtp-fundamentals-and-deployment"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.02",
        text: "Complete the basic setup of FortiMail operation mode, system settings, and protected domains",
        relatedArticles: ["fortimail-smtp-fundamentals-and-deployment"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.03",
        text: "Deploy FortiMail high-availability clusters",
        relatedArticles: ["fortigate-fgcp-ha-clustering"],
        relatedTools: ["fortigate-ha-failover-simulator"],
        manualLinks: [],
      },
      ...
      {
        id: "section-2",
        title: "Email flow and authentication",
        objectives: [
      {
        id: "2.01",
        text: "Enable and match authentication on FortiMail",
        relatedArticles: ["fortigate-authentication-and-fsso"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "2.02",
        text: "Configure secure MTA features",
        relatedArticles: ["fortimail-smtp-fundamentals-and-deployment"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "2.03",
        text: "Configure and track access control rules, IP policies, and recipient policies",
        relatedArticles: ["fortimail-policies-session-filtering-and-antispam"],
        relatedTools: [],
        manualLinks: [],
      },
        ],
      ...
      {
        id: "3.01",
        text: "Configure session-based email filtering",
        relatedArticles: ["fortimail-policies-session-filtering-and-antispam"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "3.02",
        text: "Configure and manage spam filtering techniques",
        relatedArticles: ["fortimail-policies-session-filtering-and-antispam"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "3.03",
        text: "Configure malware detection and advanced persistent threat mitigation",
      ...
      {
        id: "3.04",
        text: "Configure content-based email filtering and archiving",
        relatedArticles: ["fortimail-content-security-encryption-and-ibe"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "4.01",
        text: "Configure traditional SMTP encryption methods",
        relatedArticles: ["fortimail-content-security-encryption-and-ibe"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "4.02",
        text: "Configure identity-based encryption (IBE)",
        relatedArticles: ["fortimail-content-security-encryption-and-ibe"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "section-5",
        title: "Server mode and transparent mode",
        objectives: [
      {
        id: "5.01",
        text: "Configure and manage server mode features",
        relatedArticles: ["fortimail-smtp-fundamentals-and-deployment"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "5.02",
        text: "Deploy FortiMail in transparent mode",
        relatedArticles: ["fortigate-initial-configuration-and-operation-modes"],
        relatedTools: [],
        manualLinks: [],
      },
  ...
  {
    slug: "fortinet-nse-6-fortimail-workspace-administrator",
    examCode: "NSE 6",
    examName: "FortiMail Workspace Administrator",
    vendor: "fortinet",
    certification: "fortinet-nse-6-cloud-security",
    targetVersion: null,
    blueprintSourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=library_fortimail-workspace-security-administrator",
    blueprintSourceLabel: "Fortinet Training Institute course page (course objectives)",
    status: "published",
    sourceCaveat: "course-objectives",
    examFacts: null,
    sections: [
      ...
      {
        id: "1.01",
        text: "Explain FortiMail Workspace Security",
        relatedArticles: ["fortimail-smtp-fundamentals-and-deployment", "fortimail-policies-session-filtering-and-antispam"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.02",
        text: "Describe FortiMail Workspace licenses",
        relatedArticles: ["fortimail-smtp-fundamentals-and-deployment", "fortimail-policies-session-filtering-and-antispam"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.03",
        text: "Configure Google Workspace",
        relatedArticles: ["fortimail-workspace-security-and-policies"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.04",
        text: "Configure Microsoft 365",
        relatedArticles: ["fortimail-workspace-security-and-policies"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.05",
        text: "Configure additional email services",
        relatedArticles: ["fortimail-smtp-fundamentals-and-deployment", "fortimail-policies-session-filtering-and-antispam"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.06",
        text: "Configure administrator users and profiles",
        relatedArticles: ["fortimail-workspace-security-and-policies"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "1.09",
        text: "Describe organizational hierarchy",
        relatedArticles: ["fortimail-workspace-security-and-policies"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.10",
        text: "Configure an organization",
        relatedArticles: ["fortimail-workspace-security-and-policies"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.11",
        text: "Describe organization types",
        relatedArticles: ["fortimail-workspace-security-and-policies"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "1.13",
        text: "Describe the precedence of allowlists and blocklists",
        relatedArticles: ["fortimail-workspace-security-and-policies", "fortimail-policies-session-filtering-and-antispam"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.14",
        text: "Configure allowlists and blocklists",
        relatedArticles: ["fortimail-workspace-security-and-policies", "fortimail-policies-session-filtering-and-antispam"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "1.17",
        text: "Monitor service status and feature updates",
        relatedArticles: ["fortimail-workspace-security-and-policies"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "1.19",
        text: "Configure and generate periodic reports",
        relatedArticles: ["fortianalyzer-log-ingestion-and-storage", "fortianalyzer-soc-events-incidents-playbooks"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "1.21",
        text: "Manage FortiMail Workspace Security events",
        relatedArticles: ["fortimail-smtp-fundamentals-and-deployment", "fortimail-policies-session-filtering-and-antispam"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "1.23",
        text: "Manage FortiMail Browser Security",
        relatedArticles: ["fortimail-smtp-fundamentals-and-deployment", "fortimail-policies-session-filtering-and-antispam"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.24",
        text: "Deploy and manage extensions",
        relatedArticles: ["fortimail-workspace-security-and-policies"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.25",
        text: "Configure and manage policies",
        relatedArticles: ["fortimail-workspace-security-and-policies", "fortimail-policies-session-filtering-and-antispam"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.26",
        text: "Configure advanced features",
        relatedArticles: ["fortimail-workspace-security-and-policies", "fortimail-content-security-encryption-and-ibe"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.27",
        text: "Integrate channels",
        relatedArticles: ["fortimail-workspace-security-and-policies"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.28",
        text: "Integrate EDR tools",
        relatedArticles: ["fortiedr-architecture-and-deployment", "fortiedr-threat-hunting-forensics-and-investigation"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.29",
        text: "Troubleshoot scans",
        relatedArticles: ["fortigate-logging-and-diagnostics"],
        relatedTools: ["fortios-sniffer-builder", "fortigate-session-table-explainer"],
        manualLinks: [],
      },
      ...
      {
        id: "1.31",
        text: "Troubleshoot the browser extension",
        relatedArticles: ["fortigate-logging-and-diagnostics"],
        relatedTools: ["fortios-sniffer-builder", "fortigate-session-table-explainer"],
        manualLinks: [],
      },
  ...
  {
    slug: "fortinet-nse-6-fortideceptor-administrator",
    examCode: "NSE 6",
    examName: "FortiDeceptor Administrator",
    vendor: "fortinet",
    certification: "fortinet-nse-6-security-operations",
    targetVersion: null,
    blueprintSourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=library_fortideceptor-administrator",
    blueprintSourceLabel: "Fortinet Training Institute course page (course objectives)",
    status: "published",
    sourceCaveat: "course-objectives",
    examFacts: null,
    sections: [
      ...
      {
        id: "1.01",
        text: "Describe how FortiDeceptor integrates into Enterprise networks",
        relatedArticles: ["fortideceptor-deployment-and-incident-analysis", "fortideceptor-decoys-lures-and-deception-strategy"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.02",
        text: "Describe FortiDeceptor modules and key features",
        relatedArticles: ["fortideceptor-decoys-lures-and-deception-strategy", "fortideceptor-deployment-and-incident-analysis"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.03",
        text: "Access FortiDeceptor and view the dashboard",
        relatedArticles: ["fortideceptor-deployment-and-incident-analysis", "fortideceptor-decoys-lures-and-deception-strategy"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.04",
        text: "Configure network and system settings",
        relatedArticles: ["fortideceptor-deployment-and-incident-analysis"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.05",
        text: "Configure FortiDeceptor central management",
        relatedArticles: ["fortideceptor-deployment-and-incident-analysis", "fortideceptor-decoys-lures-and-deception-strategy"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.06",
        text: "Configure FortiDeceptor top-management",
        relatedArticles: ["fortideceptor-deployment-and-incident-analysis", "fortideceptor-decoys-lures-and-deception-strategy"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.07",
        text: "Configure FortiDeceptor for air-gapped deployments",
        relatedArticles: ["fortideceptor-deployment-and-incident-analysis", "fortideceptor-decoys-lures-and-deception-strategy"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.08",
        text: "Configure deployment networks",
        relatedArticles: ["fortideceptor-deployment-and-incident-analysis"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.09",
        text: "Deploy decoy VMs and configure lure resources",
        relatedArticles: ["fortigate-logging-and-diagnostics"],
        relatedTools: ["fortios-sniffer-builder", "fortigate-session-table-explainer"],
        manualLinks: [],
      },
      {
        id: "1.10",
        text: "Use the deployment wizard to create and deploy decoys",
        relatedArticles: ["fortideceptor-decoys-lures-and-deception-strategy", "fortideceptor-deployment-and-incident-analysis"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.11",
        text: "Select the appropriate decoys, services, and lures",
        relatedArticles: ["fortideceptor-decoys-lures-and-deception-strategy"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.12",
        text: "Create and deploy FortiDeceptor token packages",
        relatedArticles: ["fortideceptor-decoys-lures-and-deception-strategy", "fortideceptor-deployment-and-incident-analysis"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.13",
        text: "Analyze the FortiDeceptor deployment map",
        relatedArticles: ["fortideceptor-deployment-and-incident-analysis", "fortideceptor-decoys-lures-and-deception-strategy"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.14",
        text: "Analyze incidents, attacks, and the attack map",
        relatedArticles: ["fortianalyzer-log-ingestion-and-storage", "fortianalyzer-soc-events-incidents-playbooks"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.15",
        text: "Navigate the MITRE ICS matrix",
        relatedArticles: ["fortideceptor-decoys-lures-and-deception-strategy"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.16",
        text: "Design deception strategies based on network requirements",
        relatedArticles: ["fortideceptor-decoys-lures-and-deception-strategy", "fortideceptor-deployment-and-incident-analysis"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.17",
        text: "Differentiate light-stack and full-stack deception",
        relatedArticles: ["fortideceptor-decoys-lures-and-deception-strategy"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.18",
        text: "Detect and mitigate new outbreaks",
        relatedArticles: ["fortideceptor-deployment-and-incident-analysis"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.19",
        text: "Follow best practices for decoy and token deployment",
        relatedArticles: ["fortideceptor-decoys-lures-and-deception-strategy", "fortideceptor-deployment-and-incident-analysis"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.20",
        text: "Follow best practices for AD integration",
        relatedArticles: ["fortideceptor-deployment-and-incident-analysis"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.21",
        text: "Design deception based on network topology requirements",
        relatedArticles: ["fortideceptor-decoys-lures-and-deception-strategy", "fortideceptor-deployment-and-incident-analysis"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.22",
        text: "Formulate deception strategies against specific attack vectors",
        relatedArticles: ["fortideceptor-decoys-lures-and-deception-strategy"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.23",
        text: "Integrate FortiDeceptor with the Fortinet Security Fabric and other Fortinet products",
        relatedArticles: ["fortigate-firewall-policy-and-nat"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.24",
        text: "Integrate FortiDeceptor with third-party products",
        relatedArticles: ["fortideceptor-deployment-and-incident-analysis", "fortideceptor-decoys-lures-and-deception-strategy"],
        relatedTools: [],
        manualLinks: [],
      },
  ...
  {
    slug: "fortinet-nse-6-fortindr-cloud-analyst",
    examCode: "NSE 6",
    examName: "FortiNDR Cloud Analyst",
    vendor: "fortinet",
    certification: "fortinet-nse-6-security-operations",
    targetVersion: "FortiNDR Cloud 26",
    blueprintSourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=fortindr_cloud_analyst_exam",
    blueprintSourceLabel: "Fortinet NSE Certification Program, effective 15 July 2026",
    status: "published",
    examFacts: {
      questions: "30–40 questions",
      ...
      passMark: "Pass or fail. A score report is available from your Pearson VUE account.",
      cost: "See Pearson VUE for current pricing",
      note: "Time allowed: 65–75 minutes. Language: English. Product version: FortiNDR Cloud 26.",
    },
    sections: [
      {
        id: "section-1",
        title: "Architecture and system settings (15–25% of the exam)",
        objectives: [
      {
        id: "1.01",
        text: "Explain the FortiNDR Cloud architecture",
        relatedArticles: ["fortindr-cloud-architecture-detections-and-events"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.02",
        text: "Identify the FortiNDR Cloud sensors",
        relatedArticles: ["fortindr-cloud-architecture-detections-and-events"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "section-2",
        title: "Events and queries (25–35% of the exam)",
        objectives: [
      {
        id: "2.01",
        text: "Explain event types and fields",
        relatedArticles: ["fortindr-cloud-architecture-detections-and-events"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "2.02",
        text: "Configure IQL query to match security events",
        relatedArticles: ["fortindr-cloud-iql-hunting-and-integration"],
        relatedTools: [],
        manualLinks: [],
      },
        ],
      ...
      {
        id: "section-3",
        title: "Detection (15–25% of the exam)",
        objectives: [
      {
        id: "3.01",
        text: "Analyze detections and behavioral observations",
        relatedArticles: ["fortindr-cloud-architecture-detections-and-events"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "section-4",
        title: "Investigations and integrations (20–30% of the exam)",
        objectives: [
      {
        id: "4.01",
        text: "Perform investigations to detect threats",
        relatedArticles: ["fortindr-cloud-iql-hunting-and-integration"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "4.02",
        text: "Explain how to integrate FortiNDR Cloud (API/connectors)",
        relatedArticles: ["fortindr-cloud-iql-hunting-and-integration"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "4.03",
        text: "Perform threat hunting activities",
        relatedArticles: ["fortindr-cloud-iql-hunting-and-integration"],
        relatedTools: [],
        manualLinks: [],
      },
  ...
  {
    slug: "fortinet-nse-6-fortirecon-analyst",
    examCode: "NSE 6",
    examName: "FortiRecon Analyst",
    vendor: "fortinet",
    certification: "fortinet-nse-6-security-operations",
    targetVersion: null,
    blueprintSourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=library_fortirecon-analyst",
    blueprintSourceLabel: "Fortinet Training Institute course page (course objectives)",
    status: "published",
    sourceCaveat: "course-objectives",
    examFacts: null,
    sections: [
      ...
      {
        id: "1.02",
        text: "Differentiate between the surface web, deep web, and dark web",
        relatedArticles: ["fortirecon-attack-surface-and-digital-risk"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.03",
        text: "Describe the MITRE ATT&CK Matrix and Cyber Kill Chain for Enterprise",
        relatedArticles: ["fortirecon-attack-surface-and-digital-risk", "fortinet-soc-architecture-and-adversary-behaviour"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.04",
        text: "Describe FortiRecon use cases",
        relatedArticles: ["fortirecon-attack-surface-and-digital-risk"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.05",
        text: "Describe the FortiRecon license and initial access",
        relatedArticles: ["fortirecon-attack-surface-and-digital-risk"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.06",
        text: "Describe the FortiRecon provisioning form and seed data",
        relatedArticles: ["fortirecon-attack-surface-and-digital-risk"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.07",
        text: "Identify FortiRecon managed security service provider (MSSP) onboarding and prerequisites",
        relatedArticles: ["fortirecon-attack-surface-and-digital-risk"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.08",
        text: "Describe the FortiRecon overview page, digital risk posture, and ASM",
        relatedArticles: ["fortirecon-attack-surface-and-digital-risk"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.09",
        text: "Identify FortiRecon exposed services and technologies",
        relatedArticles: ["fortirecon-attack-surface-and-digital-risk"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.10",
        text: "Describe FortiRecon BP and ACI components",
        relatedArticles: ["fortirecon-attack-surface-and-digital-risk"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.11",
        text: "Describe FortiRecon reports, objectives, and data",
        relatedArticles: ["fortianalyzer-log-ingestion-and-storage", "fortianalyzer-soc-events-incidents-playbooks"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.12",
        text: "Describe automation and FortiRecon Security Orchestration",
        relatedArticles: ["fortisoar-playbooks-jinja-and-connectors", "fortisoar-incident-workflow-and-troubleshooting"],
        relatedTools: [],
        manualLinks: [],
      },
      {
      ...
      {
        id: "1.14",
        text: "Explore APIs and examples",
        relatedArticles: ["fortirecon-attack-surface-and-digital-risk"],
        relatedTools: [],
        manualLinks: [],
      },
  ...
  {
    slug: "fortinet-nse-6-fortisiem-analyst",
    examCode: "NSE 6",
    examName: "FortiSIEM Analyst",
    vendor: "fortinet",
    certification: "fortinet-nse-6-security-operations",
    targetVersion: "FortiSIEM 7.4",
    blueprintSourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=fortisiem_analyst_exam",
    blueprintSourceLabel: "Fortinet NSE Certification Program, effective 15 July 2026",
    status: "published",
    examFacts: {
      questions: "35-40 questions",
      ...
      passMark: "Pass or fail. A score report is available from your Pearson VUE account.",
      cost: "See Pearson VUE for current pricing",
      note: "Time allowed: 70 minutes. Language: English. Product version: FortiSIEM 7.4.",
    },
    sections: [
      {
        id: "section-1",
      ...
      {
        id: "1.01",
        text: "Build queries from search results and events",
        relatedArticles: ["fortisiem-analytics-queries-and-cmdb"],
        relatedTools: [],
        manualLinks: [{ label: "FortiSIEM 7.4—User Guide", url: "https://docs.fortinet.com/document/fortisiem/7.4.2/user-guide/780675/fortisiem-user-guide", version: null }, { label: "Agentless ZTNA with FortiSIEM UEBA and FortiGate", url: "https://docs.fortinet.com/document/fortisiem/7.4.2/agentless-ztna-with-fortisiem-ueba-and-fortigate/91627/deployment-overview", version: null }],
      },
      {
        id: "1.02",
        text: "Apply group by and data aggregation on search results",
        relatedArticles: ["fortisiem-analytics-queries-and-cmdb"],
        relatedTools: [],
        manualLinks: [{ label: "FortiSIEM 7.4—User Guide", url: "https://docs.fortinet.com/document/fortisiem/7.4.2/user-guide/780675/fortisiem-user-guide", version: null }, { label: "Agentless ZTNA with FortiSIEM UEBA and FortiGate", url: "https://docs.fortinet.com/document/fortisiem/7.4.2/agentless-ztna-with-fortisiem-ueba-and-fortigate/91627/deployment-overview", version: null }],
      },
      {
        id: "1.03",
        text: "Perform configuration management database (CMDB) and lookup table queries",
        relatedArticles: ["fortisiem-analytics-queries-and-cmdb"],
        relatedTools: [],
        manualLinks: [{ label: "FortiSIEM 7.4—User Guide", url: "https://docs.fortinet.com/document/fortisiem/7.4.2/user-guide/780675/fortisiem-user-guide", version: null }, { label: "Agentless ZTNA with FortiSIEM UEBA and FortiGate", url: "https://docs.fortinet.com/document/fortisiem/7.4.2/agentless-ztna-with-fortisiem-ueba-and-fortigate/91627/deployment-overview", version: null }],
      },
      {
        id: "1.04",
        text: "Perform nested query lookups",
        relatedArticles: ["fortisiem-analytics-queries-and-cmdb"],
        relatedTools: [],
        manualLinks: [{ label: "FortiSIEM 7.4—User Guide", url: "https://docs.fortinet.com/document/fortisiem/7.4.2/user-guide/780675/fortisiem-user-guide", version: null }, { label: "Agentless ZTNA with FortiSIEM UEBA and FortiGate", url: "https://docs.fortinet.com/document/fortisiem/7.4.2/agentless-ztna-with-fortisiem-ueba-and-fortigate/91627/deployment-overview", version: null }],
      },
      ...
      {
        id: "section-3",
        title: "Rules and subpatterns",
        objectives: [
      {
        id: "3.01",
        text: "Identify various rule components",
        relatedArticles: ["fortisiem-rules-incidents-and-remediation"],
        relatedTools: [],
        manualLinks: [{ label: "FortiSIEM 7.4—User Guide", url: "https://docs.fortinet.com/document/fortisiem/7.4.2/user-guide/780675/fortisiem-user-guide", version: null }, { label: "Agentless ZTNA with FortiSIEM UEBA and FortiGate", url: "https://docs.fortinet.com/document/fortisiem/7.4.2/agentless-ztna-with-fortisiem-ueba-and-fortigate/91627/deployment-overview", version: null }],
      },
      {
        id: "3.02",
        text: "Utilize rule subpatterns, aggregation, and group by",
        relatedArticles: ["fortisiem-rules-incidents-and-remediation"],
        relatedTools: [],
        manualLinks: [{ label: "FortiSIEM 7.4—User Guide", url: "https://docs.fortinet.com/document/fortisiem/7.4.2/user-guide/780675/fortisiem-user-guide", version: null }, { label: "Agentless ZTNA with FortiSIEM UEBA and FortiGate", url: "https://docs.fortinet.com/document/fortisiem/7.4.2/agentless-ztna-with-fortisiem-ueba-and-fortigate/91627/deployment-overview", version: null }],
      },
      {
        id: "3.03",
        text: "Configure FortiSIEM analytics rules",
        relatedArticles: ["fortisiem-rules-incidents-and-remediation"],
        relatedTools: [],
        manualLinks: [{ label: "FortiSIEM 7.4—User Guide", url: "https://docs.fortinet.com/document/fortisiem/7.4.2/user-guide/780675/fortisiem-user-guide", version: null }, { label: "Agentless ZTNA with FortiSIEM UEBA and FortiGate", url: "https://docs.fortinet.com/document/fortisiem/7.4.2/agentless-ztna-with-fortisiem-ueba-and-fortigate/91627/deployment-overview", version: null }],
      },
      ...
      {
        id: "section-4",
        title: "Incidents, notifications, and remediation",
        objectives: [
      {
        id: "4.01",
        text: "Manage and tune incidents",
        relatedArticles: ["fortisiem-rules-incidents-and-remediation"],
        relatedTools: [],
        manualLinks: [{ label: "FortiSIEM 7.4—User Guide", url: "https://docs.fortinet.com/document/fortisiem/7.4.2/user-guide/780675/fortisiem-user-guide", version: null }, { label: "Agentless ZTNA with FortiSIEM UEBA and FortiGate", url: "https://docs.fortinet.com/document/fortisiem/7.4.2/agentless-ztna-with-fortisiem-ueba-and-fortigate/91627/deployment-overview", version: null }],
      },
      {
        id: "4.02",
        text: "Configure notification policies",
        relatedArticles: ["fortisiem-rules-incidents-and-remediation"],
        relatedTools: [],
        manualLinks: [{ label: "FortiSIEM 7.4—User Guide", url: "https://docs.fortinet.com/document/fortisiem/7.4.2/user-guide/780675/fortisiem-user-guide", version: null }, { label: "Agentless ZTNA with FortiSIEM UEBA and FortiGate", url: "https://docs.fortinet.com/document/fortisiem/7.4.2/agentless-ztna-with-fortisiem-ueba-and-fortigate/91627/deployment-overview", version: null }],
      },
      {
        id: "4.03",
        text: "Configure remediation options",
        relatedArticles: ["fortisiem-rules-incidents-and-remediation"],
        relatedTools: [],
        manualLinks: [{ label: "FortiSIEM 7.4—User Guide", url: "https://docs.fortinet.com/document/fortisiem/7.4.2/user-guide/780675/fortisiem-user-guide", version: null }, { label: "Agentless ZTNA with FortiSIEM UEBA and FortiGate", url: "https://docs.fortinet.com/document/fortisiem/7.4.2/agentless-ztna-with-fortisiem-ueba-and-fortigate/91627/deployment-overview", version: null }],
      },
      ...
      {
        id: "section-5",
        title: "ML, UEBA, and ZTNA",
        objectives: [
      {
        id: "5.01",
        text: "Configure machine learning (ML) configuration tasks",
        relatedArticles: ["fortisiem-ml-ueba-and-platform-integration"],
        relatedTools: [],
        manualLinks: [{ label: "FortiSIEM 7.4—User Guide", url: "https://docs.fortinet.com/document/fortisiem/7.4.2/user-guide/780675/fortisiem-user-guide", version: null }, { label: "Agentless ZTNA with FortiSIEM UEBA and FortiGate", url: "https://docs.fortinet.com/document/fortisiem/7.4.2/agentless-ztna-with-fortisiem-ueba-and-fortigate/91627/deployment-overview", version: null }],
      },
      {
        id: "5.02",
        text: "Integrate user and entity behavior analytics (UEBA) data into rules and dashboards",
        relatedArticles: ["fortisiem-ml-ueba-and-platform-integration"],
        relatedTools: [],
        manualLinks: [{ label: "FortiSIEM 7.4—User Guide", url: "https://docs.fortinet.com/document/fortisiem/7.4.2/user-guide/780675/fortisiem-user-guide", version: null }, { label: "Agentless ZTNA with FortiSIEM UEBA and FortiGate", url: "https://docs.fortinet.com/document/fortisiem/7.4.2/agentless-ztna-with-fortisiem-ueba-and-fortigate/91627/deployment-overview", version: null }],
      },
      {
        id: "5.03",
        text: "Describe how to integrate zero trust network access (ZTNA) into FortiSIEM operations",
        relatedArticles: ["fortisiem-ml-ueba-and-platform-integration"],
        relatedTools: [],
        manualLinks: [{ label: "FortiSIEM 7.4—User Guide", url: "https://docs.fortinet.com/document/fortisiem/7.4.2/user-guide/780675/fortisiem-user-guide", version: null }, { label: "Agentless ZTNA with FortiSIEM UEBA and FortiGate", url: "https://docs.fortinet.com/document/fortisiem/7.4.2/agentless-ztna-with-fortisiem-ueba-and-fortigate/91627/deployment-overview", version: null }],
      },
  ...
  {
    slug: "fortinet-nse-6-fortisoar-analyst",
    examCode: "NSE 6",
    examName: "FortiSOAR Analyst",
    vendor: "fortinet",
    certification: "fortinet-nse-6-security-operations",
    targetVersion: "FortiSOAR 7.6",
    blueprintSourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=fortisoar_analyst_exam",
    blueprintSourceLabel: "Fortinet NSE Certification Program, effective 15 July 2026",
    status: "published",
    examFacts: {
      ...
      passMark: "Pass or fail. A score report is available from your Pearson VUE account.",
      cost: "See Pearson VUE for current pricing",
      note: "Time allowed: 60–70 minutes. Language: English. Product version: FortiSOAR 7.6.",
    },
    sections: [
      {
        id: "section-1",
        title: "FortiSOAR architecture and data models (20–30% of the exam)",
        objectives: [
      {
        id: "1.01",
        text: "Identify FortiSOAR deployment models",
        relatedArticles: ["fortisoar-architecture-and-data-model"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.02",
        text: "Analyze how modules, records, fields, and relationships define the FortiSOAR data model",
        relatedArticles: ["fortisoar-architecture-and-data-model"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "1.04",
        text: "Configure templates, dashboards, and widgets",
        relatedArticles: ["fortisoar-architecture-and-data-model"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "section-2",
        title: "Playbook Development (25–35% of the exam)",
        objectives: [
      {
        id: "2.01",
        text: "Implement playbook logic",
        relatedArticles: ["fortisoar-playbooks-jinja-and-connectors"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "2.02",
        text: "Manipulate data using Jinja filters",
        relatedArticles: ["fortisoar-playbooks-jinja-and-connectors"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "2.03",
        text: "Analyze basic JSON Query and YAQL statements",
        relatedArticles: ["fortisoar-playbooks-jinja-and-connectors"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "section-3",
        title: "Incident Handling (5–15 of the exam)",
        objectives: [
      {
        id: "3.01",
        text: "Manage FortiSOAR incident phases",
        relatedArticles: ["fortisoar-incident-workflow-and-troubleshooting"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "3.02",
        text: "Create queues and shifts for workload management",
        relatedArticles: ["fortisoar-incident-workflow-and-troubleshooting"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "3.03",
        text: "Use war rooms for incident handling",
        relatedArticles: ["fortisoar-incident-workflow-and-troubleshooting"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "3.04",
        text: "Correlate records across modules",
        relatedArticles: ["fortisoar-architecture-and-data-model"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "section-4",
        title: "APIs and Connectors (15–25% of the exam)",
        objectives: [
      {
        id: "4.01",
        text: "Configure FortiSOAR connectors",
        relatedArticles: ["fortisoar-playbooks-jinja-and-connectors"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "4.02",
        text: "Interact with FortiSOAR using the API or custom triggers",
        relatedArticles: ["fortisoar-playbooks-jinja-and-connectors"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "4.03",
        text: "Compare REST API and JSON-RPC API",
        relatedArticles: ["fortisoar-playbooks-jinja-and-connectors"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "section-5",
        title: "Troubleshooting (15–25% of the exam)",
        objectives: [
      {
        id: "5.01",
        text: "Identify common playbook and connector issues",
        relatedArticles: ["fortisoar-incident-workflow-and-troubleshooting", "fortisoar-playbooks-jinja-and-connectors"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "5.02",
        text: "Use the Jinja editor to troubleshoot Jinja expressions",
        relatedArticles: ["fortisoar-incident-workflow-and-troubleshooting", "fortisoar-playbooks-jinja-and-connectors"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "5.03",
        text: "Debug and troubleshoot playbooks using executed playbook logs",
        relatedArticles: ["fortisoar-incident-workflow-and-troubleshooting"],
        relatedTools: [],
        manualLinks: [],
      },
  ...
  {
    slug: "fortinet-nse-7-secure-networking-architect",
    examCode: "NSE 7",
    examName: "Secure Networking Architect",
    vendor: "fortinet",
    certification: "fortinet-nse-7-secure-networking",
    targetVersion: "FortiGate 7.6, FortiManager 7.6, FortiAnalyzer 7.6",
    blueprintSourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=secure_networking_architect_exam",
    blueprintSourceLabel: "Fortinet NSE Certification Program, effective 15 July 2026",
    status: "published",
    examFacts: {
      ...
      passMark: "Pass or fail. A score report is available from your Pearson VUE account.",
      cost: "See Pearson VUE for current pricing",
      note: "Time allowed: 60–70 minutes. Language: English. Product version: FortiGate 7.6, FortiManager 7.6, FortiAnalyzer 7.6.",
    },
    sections: [
      {
        id: "section-1",
        title: "System configuration and SD-WAN setup (20–30% of the exam)",
        objectives: [
      {
        id: "1.01",
        text: "Implement the Fortinet Security Fabric",
        relatedArticles: ["fortigate-firewall-policy-and-nat"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.02",
        text: "Configure different operation modes for a high availability (HA) cluster",
        relatedArticles: ["fortigate-fgcp-ha-clustering"],
        relatedTools: ["fortigate-ha-failover-simulator"],
        manualLinks: [],
      },
      {
        id: "1.03",
        text: "Implement enterprise networks using VLANs and VDOMs",
      ...
      {
        id: "1.04",
        text: "Deploy an enterprise SD-WAN setup",
        relatedArticles: ["fortigate-routing-and-sdwan-selection"],
        relatedTools: ["fortigate-route-selection-explainer"],
        manualLinks: [],
      },
      ...
      {
        id: "section-2",
        title: "Central management (15–25% of the exam)",
        objectives: [
      {
        id: "2.01",
        text: "Implement branch configuration deployments",
        relatedArticles: ["fortimanager-policy-packages-and-installs"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "2.02",
        text: "Use SD-WAN Manager and overlay orchestration",
        relatedArticles: ["fortigate-routing-and-sdwan-selection"],
        relatedTools: ["fortigate-route-selection-explainer"],
        manualLinks: [],
      },
      ...
      {
        id: "section-3",
        title: "Security profiles (5–15% of the exam)",
        objectives: [
      {
        id: "3.01",
        text: "Manage SSL/SSH inspection profiles",
        relatedArticles: ["fortinet-ssl-inspection-modes", "fortigate-security-profiles-flow-vs-proxy"],
        relatedTools: ["fortigate-security-profile-coverage-checker"],
        manualLinks: [],
      },
      {
        id: "3.02",
        text: "Use a combination of web filtering, application control, intrusion prevention system (IPS), and Internet Service Database (ISDB) to secure the network",
        relatedArticles: ["fortigate-security-profiles-flow-vs-proxy"],
        relatedTools: ["fortigate-security-profile-coverage-checker"],
        manualLinks: [],
      },
      ...
      {
        id: "section-4",
        title: "Rules and routing (25–35% of the exam)",
        objectives: [
      {
        id: "4.01",
        text: "Implement OSPF to route enterprise traffic",
        relatedArticles: ["fortigate-routing-and-sdwan-selection"],
        relatedTools: ["fortigate-route-selection-explainer"],
        manualLinks: [],
      },
      {
        id: "4.02",
        text: "Implement BGP to route enterprise traffic",
        relatedArticles: ["fortigate-routing-and-sdwan-selection"],
        relatedTools: ["fortigate-route-selection-explainer"],
        manualLinks: [],
      },
      ...
      {
        id: "section-5",
        title: "Advanced IPsec (25–35% of the exam)",
        objectives: [
      {
        id: "5.01",
        text: "Implement IPsec VPN IKE version 2",
        relatedArticles: ["fortigate-ipsec-vpn-topologies"],
        relatedTools: ["fortigate-ipsec-phase-mismatch-analyzer"],
        manualLinks: [],
      },
      {
        id: "5.02",
        text: "Configure IPsec multihub, multiregion, and large deployments",
        relatedArticles: ["fortigate-ipsec-vpn-topologies"],
        relatedTools: ["fortigate-ipsec-phase-mismatch-analyzer"],
        manualLinks: [],
      },
      {
        id: "5.03",
        text: "Implement ADVPN to enable on-demand VPN tunnels between sites",
        relatedArticles: ["fortigate-ipsec-vpn-topologies"],
        relatedTools: ["fortigate-ipsec-phase-mismatch-analyzer"],
        manualLinks: [],
      },
  ...
  {
    slug: "fortinet-nse-7-sase-architect",
    examCode: "NSE 7",
    examName: "SASE Architect",
    vendor: "fortinet",
    certification: "fortinet-nse-7-sase",
    targetVersion: "FortiSASE 26, FortiOS 7.4 and 7.6",
    blueprintSourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=fortisase_architect_exam",
    blueprintSourceLabel: "Fortinet NSE Certification Program, effective 15 July 2026",
    status: "published",
    examFacts: {
      questions: "40–50 questions",
      ...
      passMark: "Pass or fail. A score report is available from your Pearson VUE account.",
      cost: "See Pearson VUE for current pricing",
      note: "Time allowed: 70–80 minutes. Language: English. Product version: FortiSASE 26, FortiOS 7.4 and 7.6.",
    },
    sections: [
      {
        id: "section-1",
        title: "SD-WAN architecture and deployment (10–20% of the exam)",
        objectives: [
      {
        id: "1.01",
        text: "Design enterprise SD-WAN architectures",
        relatedArticles: ["fortigate-routing-and-sdwan-selection"],
        relatedTools: ["fortigate-route-selection-explainer"],
        manualLinks: [],
      },
      {
        id: "1.02",
        text: "Deploy SD-WAN infrastructure",
        relatedArticles: ["fortigate-routing-and-sdwan-selection"],
        relatedTools: ["fortigate-route-selection-explainer"],
        manualLinks: [],
      },
      {
        id: "1.03",
        text: "Implement SD-WAN performance controls",
        relatedArticles: ["fortigate-routing-and-sdwan-selection"],
        relatedTools: ["fortigate-route-selection-explainer"],
        manualLinks: [],
      },
      ...
      {
        id: "section-2",
        title: "SD-WAN traffic control and IPsec (20–30% of the exam)",
        objectives: [
      {
        id: "2.01",
        text: "Design SD-WAN rules",
      ...
      {
        id: "2.03",
        text: "Deploy advanced IPsec for SD-WAN",
        relatedArticles: ["fortigate-routing-and-sdwan-selection", "fortigate-ipsec-vpn-topologies"],
        relatedTools: ["fortigate-route-selection-explainer", "fortigate-ipsec-phase-mismatch-analyzer"],
        manualLinks: [],
      },
        ],
      },
      {
        id: "section-3",
        title: "FortiSASE architecture and integration (15–25% of the exam)",
        objectives: [
      {
        id: "3.01",
        text: "Evaluate FortiSASE components in advanced deployment scenarios",
        relatedArticles: ["fortigate-cloud-deployments-and-fortisase"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "3.02",
        text: "Integrate FortiSASE into hybrid networks",
        relatedArticles: ["fortigate-cloud-deployments-and-fortisase"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "3.03",
        text: "Integrate SD-WAN and FortiSASE workflows",
        relatedArticles: ["fortigate-routing-and-sdwan-selection", "fortigate-cloud-deployments-and-fortisase"],
        relatedTools: ["fortigate-route-selection-explainer"],
        manualLinks: [],
      },
      ...
      {
        id: "section-4",
        title: "FortiSASE deployment and secure access (20–30% of the exam)",
        objectives: [
      {
        id: "4.01",
        text: "Deploy FortiSASE access and onboarding",
        relatedArticles: ["fortigate-cloud-deployments-and-fortisase"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "4.02",
        text: "Configure endpoint posture and access control",
        relatedArticles: ["forticlient-ems-endpoint-security-ztna-and-troubleshooting", "fortisase-operations-onboarding-and-reporting"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "4.03",
        text: "Deploy cloud-delivered secure services",
        relatedArticles: ["fortigate-cloud-deployments-and-fortisase", "fortisase-operations-onboarding-and-reporting"],
        relatedTools: [],
        manualLinks: [],
      },
        ],
      ...
      {
        id: "section-5",
        title: "Centralized management, visibility and troubleshooting (10–20% of the exam)",
        objectives: [
      {
        id: "5.01",
        text: "Centrally manage FortiSASE and SD-WAN deployments",
        relatedArticles: ["fortigate-routing-and-sdwan-selection", "fortigate-cloud-deployments-and-fortisase"],
        relatedTools: ["fortigate-route-selection-explainer"],
        manualLinks: [],
      },
      {
        id: "5.02",
        text: "Analyze traffic and security logs",
        relatedArticles: ["fortisase-operations-onboarding-and-reporting", "fortianalyzer-reports-datasets-and-charts"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "5.03",
        text: "Troubleshoot connectivity and policy behavior",
        relatedArticles: ["reading-a-fortigate-sniffer-trace"],
        relatedTools: ["fortios-sniffer-builder"],
        manualLinks: [],
      },
  ...
  {
    slug: "fortinet-nse-7-public-cloud-security-architect",
    examCode: "NSE 7",
    examName: "Public Cloud Security Architect",
    vendor: "fortinet",
    certification: "fortinet-nse-7-cloud-security",
    targetVersion: "FortiOS 7.6, FortiWeb 7.4",
    blueprintSourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=public_cloud_security_architect_exam",
    blueprintSourceLabel: "Fortinet NSE Certification Program, effective 15 July 2026",
    status: "published",
    retirement: {
    ...
    examFacts: {
      ...
      passMark: "Pass or fail. A score report is available from your Pearson VUE account.",
      cost: "See Pearson VUE for current pricing",
      note: "Time allowed: 75 minutes. Language: English. Product version: FortiOS 7.6, FortiWeb 7.4.",
    },
    sections: [
      {
        id: "section-1",
      ...
      {
        id: "1.01",
        text: "Deploy Fortinet solutions to protect IaaS",
        relatedArticles: ["fortigate-cloud-deployments-and-fortisase", "fortinet-cloud-automation-caas-and-native-integration"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.02",
        text: "Deploy Fortinet solutions to protect CaaS",
        relatedArticles: ["fortinet-cloud-automation-caas-and-native-integration"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.03",
        text: "Integrate Fortinet solutions with cloud native tools",
        relatedArticles: ["fortinet-cloud-automation-caas-and-native-integration"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "2.01",
        text: "Deploy cloud infrastructure using Terraform and Ansible",
        relatedArticles: ["fortinet-cloud-automation-caas-and-native-integration"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "2.02",
        text: "Deploy Fortinet solutions using Azure Bicep",
        relatedArticles: ["fortigate-cloud-deployments-and-fortisase"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "2.03",
        text: "Deploy Fortinet solutions using AWS CloudFormation",
        relatedArticles: ["fortigate-cloud-deployments-and-fortisase"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "3.03",
        text: "Use Fortinet monitoring tools for cloud workloads",
        relatedArticles: ["fortinet-cloud-automation-caas-and-native-integration", "forticnapp-fundamentals-and-cloud-posture"],
        relatedTools: [],
        manualLinks: [],
      },
        ],
      ...
      {
        id: "4.01",
        text: "Troubleshoot AWS connectivity issues",
        relatedArticles: ["fortigate-cloud-deployments-and-fortisase"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "4.02",
        text: "Troubleshoot Azure connectivity issues",
        relatedArticles: ["fortigate-cloud-deployments-and-fortisase"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "4.03",
        text: "Troubleshoot AWS and Azure SDN connectors",
        relatedArticles: ["fortigate-cloud-deployments-and-fortisase"],
        relatedTools: [],
        manualLinks: [],
      },
  ...
  {
    slug: "fortinet-nse-7-security-operations-architect",
    examCode: "NSE 7",
    examName: "Security Operations Architect",
    vendor: "fortinet",
    certification: "fortinet-nse-7-security-operations",
    targetVersion: "FortiSOAR 7.6., FortiSIEM 7.3",
    blueprintSourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=security_operations_architect_exam",
    blueprintSourceLabel: "Fortinet NSE Certification Program, effective 15 July 2026",
    status: "published",
    examFacts: {
      questions: "35-40 questions",
      ...
      passMark: "Pass or fail. A score report is available from your Pearson VUE account.",
      cost: "See Pearson VUE for current pricing",
      note: "Time allowed: 75 minutes. Language: English. Product version: FortiSOAR 7.6., FortiSIEM 7.3.",
    },
    sections: [
      {
        id: "section-1",
        title: "SOC Concepts and Frameworks",
        objectives: [
      {
        id: "1.01",
        text: "Analyze security incidents and identify adversary behaviors",
        relatedArticles: ["fortinet-soc-architecture-and-adversary-behaviour"],
        relatedTools: [],
        manualLinks: [{ label: "FortiSOAR 7.6—User Guide", url: "https://docs.fortinet.com/document/fortisoar/7.6.3/user-guide/103864/overview", version: null }, { label: "FortiSOAR 7.6—Connector Guide", url: "https://docs.fortinet.com/document/fortisoar/7.6.2/connectors-guide/929681/introduction-to-connectors", version: null }, { label: "FortiSOAR 7.6—Playbook Guide", url: "https://docs.fortinet.com/document/fortisoar/7.6.2/playbooks-guide/331279/introduction-to-playbooks", version: null }, { label: "FortiSIEM 7.3—User Guide", url: "https://docs.fortinet.com/document/fortisiem/7.4.2/user-guide/780675/fortisiem-user-guide", version: null }],
      },
      {
        id: "1.02",
        text: "Explain Fortinet SOC enterprise architecture",
        relatedArticles: ["fortinet-soc-architecture-and-adversary-behaviour"],
        relatedTools: [],
        manualLinks: [{ label: "FortiSOAR 7.6—User Guide", url: "https://docs.fortinet.com/document/fortisoar/7.6.3/user-guide/103864/overview", version: null }, { label: "FortiSOAR 7.6—Connector Guide", url: "https://docs.fortinet.com/document/fortisoar/7.6.2/connectors-guide/929681/introduction-to-connectors", version: null }, { label: "FortiSOAR 7.6—Playbook Guide", url: "https://docs.fortinet.com/document/fortisoar/7.6.2/playbooks-guide/331279/introduction-to-playbooks", version: null }, { label: "FortiSIEM 7.3—User Guide", url: "https://docs.fortinet.com/document/fortisiem/7.4.2/user-guide/780675/fortisiem-user-guide", version: null }],
      },
      ...
      {
        id: "2.01",
        text: "Configure FortiSIEM incident rules",
        relatedArticles: ["fortisiem-rules-incidents-and-remediation"],
        relatedTools: [],
        manualLinks: [{ label: "FortiSOAR 7.6—User Guide", url: "https://docs.fortinet.com/document/fortisoar/7.6.3/user-guide/103864/overview", version: null }, { label: "FortiSOAR 7.6—Connector Guide", url: "https://docs.fortinet.com/document/fortisoar/7.6.2/connectors-guide/929681/introduction-to-connectors", version: null }, { label: "FortiSOAR 7.6—Playbook Guide", url: "https://docs.fortinet.com/document/fortisoar/7.6.2/playbooks-guide/331279/introduction-to-playbooks", version: null }, { label: "FortiSIEM 7.3—User Guide", url: "https://docs.fortinet.com/document/fortisiem/7.4.2/user-guide/780675/fortisiem-user-guide", version: null }],
      },
      {
        id: "2.02",
        text: "Build queries to search event logs on FortiSIEM",
        relatedArticles: ["fortisiem-analytics-queries-and-cmdb"],
        relatedTools: [],
        manualLinks: [{ label: "FortiSOAR 7.6—User Guide", url: "https://docs.fortinet.com/document/fortisoar/7.6.3/user-guide/103864/overview", version: null }, { label: "FortiSOAR 7.6—Connector Guide", url: "https://docs.fortinet.com/document/fortisoar/7.6.2/connectors-guide/929681/introduction-to-connectors", version: null }, { label: "FortiSOAR 7.6—Playbook Guide", url: "https://docs.fortinet.com/document/fortisoar/7.6.2/playbooks-guide/331279/introduction-to-playbooks", version: null }, { label: "FortiSIEM 7.3—User Guide", url: "https://docs.fortinet.com/document/fortisiem/7.4.2/user-guide/780675/fortisiem-user-guide", version: null }],
      },
      {
        id: "2.03",
        text: "Analyze FortiSIEM incidents",
        relatedArticles: ["fortisiem-rules-incidents-and-remediation"],
        relatedTools: [],
        manualLinks: [{ label: "FortiSOAR 7.6—User Guide", url: "https://docs.fortinet.com/document/fortisoar/7.6.3/user-guide/103864/overview", version: null }, { label: "FortiSOAR 7.6—Connector Guide", url: "https://docs.fortinet.com/document/fortisoar/7.6.2/connectors-guide/929681/introduction-to-connectors", version: null }, { label: "FortiSOAR 7.6—Playbook Guide", url: "https://docs.fortinet.com/document/fortisoar/7.6.2/playbooks-guide/331279/introduction-to-playbooks", version: null }, { label: "FortiSIEM 7.3—User Guide", url: "https://docs.fortinet.com/document/fortisiem/7.4.2/user-guide/780675/fortisiem-user-guide", version: null }],
      },
      ...
      {
        id: "section-3",
        title: "SOAR Incident Handling and Threat Hunting",
        objectives: [
      {
        id: "3.01",
        text: "Analyze threat hunting processes and data",
        relatedArticles: ["fortiedr-threat-hunting-forensics-and-investigation", "fortinet-soc-architecture-and-adversary-behaviour"],
        relatedTools: [],
        manualLinks: [{ label: "FortiSOAR 7.6—User Guide", url: "https://docs.fortinet.com/document/fortisoar/7.6.3/user-guide/103864/overview", version: null }, { label: "FortiSOAR 7.6—Connector Guide", url: "https://docs.fortinet.com/document/fortisoar/7.6.2/connectors-guide/929681/introduction-to-connectors", version: null }, { label: "FortiSOAR 7.6—Playbook Guide", url: "https://docs.fortinet.com/document/fortisoar/7.6.2/playbooks-guide/331279/introduction-to-playbooks", version: null }, { label: "FortiSIEM 7.3—User Guide", url: "https://docs.fortinet.com/document/fortisiem/7.4.2/user-guide/780675/fortisiem-user-guide", version: null }],
      },
      {
        id: "3.02",
        text: "Manage FortiSOAR incidents",
        relatedArticles: ["fortisoar-incident-workflow-and-troubleshooting"],
        relatedTools: [],
        manualLinks: [{ label: "FortiSOAR 7.6—User Guide", url: "https://docs.fortinet.com/document/fortisoar/7.6.3/user-guide/103864/overview", version: null }, { label: "FortiSOAR 7.6—Connector Guide", url: "https://docs.fortinet.com/document/fortisoar/7.6.2/connectors-guide/929681/introduction-to-connectors", version: null }, { label: "FortiSOAR 7.6—Playbook Guide", url: "https://docs.fortinet.com/document/fortisoar/7.6.2/playbooks-guide/331279/introduction-to-playbooks", version: null }, { label: "FortiSIEM 7.3—User Guide", url: "https://docs.fortinet.com/document/fortisiem/7.4.2/user-guide/780675/fortisiem-user-guide", version: null }],
      },
      ...
      {
        id: "4.01",
        text: "Configure FortiSOAR playbooks",
        relatedArticles: ["fortisoar-playbooks-jinja-and-connectors"],
        relatedTools: [],
        manualLinks: [{ label: "FortiSOAR 7.6—User Guide", url: "https://docs.fortinet.com/document/fortisoar/7.6.3/user-guide/103864/overview", version: null }, { label: "FortiSOAR 7.6—Connector Guide", url: "https://docs.fortinet.com/document/fortisoar/7.6.2/connectors-guide/929681/introduction-to-connectors", version: null }, { label: "FortiSOAR 7.6—Playbook Guide", url: "https://docs.fortinet.com/document/fortisoar/7.6.2/playbooks-guide/331279/introduction-to-playbooks", version: null }, { label: "FortiSIEM 7.3—User Guide", url: "https://docs.fortinet.com/document/fortisiem/7.4.2/user-guide/780675/fortisiem-user-guide", version: null }],
      },
      ...
      {
        id: "4.04",
        text: "Debug and troubleshoot FortiSOAR playbooks",
        relatedArticles: ["fortisoar-incident-workflow-and-troubleshooting", "fortisoar-playbooks-jinja-and-connectors"],
        relatedTools: [],
        manualLinks: [{ label: "FortiSOAR 7.6—User Guide", url: "https://docs.fortinet.com/document/fortisoar/7.6.3/user-guide/103864/overview", version: null }, { label: "FortiSOAR 7.6—Connector Guide", url: "https://docs.fortinet.com/document/fortisoar/7.6.2/connectors-guide/929681/introduction-to-connectors", version: null }, { label: "FortiSOAR 7.6—Playbook Guide", url: "https://docs.fortinet.com/document/fortisoar/7.6.2/playbooks-guide/331279/introduction-to-playbooks", version: null }, { label: "FortiSIEM 7.3—User Guide", url: "https://docs.fortinet.com/document/fortisiem/7.4.2/user-guide/780675/fortisiem-user-guide", version: null }],
      },
  ...
  {
    slug: "fortinet-nse-8-core",
    examCode: "NSE 8",
    examName: "NSE 8 Core Practical Exam",
    vendor: "fortinet",
    certification: "fortinet-nse-8",
    targetVersion: null,
    blueprintSourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=880_core_exam",
    blueprintSourceLabel: "Fortinet NSE Certification Program, effective 15 July 2026",
    status: "published",
    sourceCaveat: "truncated-blueprint",
    examFacts: null,
    sections: [
      {
        id: "section-1",
        title: "Infrastructure (27% of the exam)",
        objectives: [
      {
        id: "1.01",
        text: "Aggregation (Link Aggregation Control Protocol (LACP))",
        relatedArticles: ["fortiswitch-vlans-stp-ports-and-qos", "fortiswitch-fortilink-provisioning-and-topologies"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.02",
        text: "FortiGate Clustering Protocol (FGCP)",
        relatedArticles: ["fortigate-fgcp-ha-clustering"],
        relatedTools: ["fortigate-ha-failover-simulator"],
        manualLinks: [],
      },
      {
        id: "1.03",
        text: "FortiGate Session Life Support Protocol (FGSP)",
        relatedArticles: ["fortigate-fgcp-ha-clustering"],
        relatedTools: ["fortigate-ha-failover-simulator"],
        manualLinks: [],
      },
      {
        id: "1.04",
        text: "FortiAnalyzer HA",
        relatedArticles: ["fortigate-fgcp-ha-clustering", "fortianalyzer-log-ingestion-and-storage", "fortianalyzer-soc-events-incidents-playbooks"],
        relatedTools: ["fortigate-ha-failover-simulator"],
        manualLinks: [],
      },
      {
        id: "1.05",
        text: "FortiAuthenticator HA",
        relatedArticles: ["fortigate-fgcp-ha-clustering", "fortigate-authentication-and-fsso"],
        relatedTools: ["fortigate-ha-failover-simulator"],
        manualLinks: [],
      },
      {
        id: "1.06",
        text: "FortiManager HA",
        relatedArticles: ["fortigate-fgcp-ha-clustering", "fortimanager-adoms-and-device-registration", "fortimanager-policy-packages-and-installs"],
        relatedTools: ["fortigate-ha-failover-simulator", "fortios-config-diff-explainer"],
        manualLinks: [],
      },
      {
        id: "1.07",
        text: "Virtual clustering",
        relatedArticles: ["fortigate-fgcp-ha-clustering"],
        relatedTools: ["fortigate-ha-failover-simulator"],
        manualLinks: [],
      },
      {
        ...
        relatedArticles: ["fortigate-fgcp-ha-clustering", "fortigate-routing-and-sdwan-selection"],
        relatedTools: ["fortigate-ha-failover-simulator", "fortigate-route-selection-explainer"],
        manualLinks: [],
      },
      {
        id: "1.09",
        text: "Application performance",
        relatedArticles: ["fortigate-routing-and-sdwan-selection", "fortiweb-deployment-policies-and-delivery"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.10",
        text: "Multi-data-center deployments",
        relatedArticles: ["fortigate-fgcp-ha-clustering", "fortigate-routing-and-sdwan-selection"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "1.15",
        text: "FortiGate-VM bootstrapping",
        relatedArticles: ["fortigate-cloud-deployments-and-fortisase"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "1.17",
        text: "FortiAnalyzer integration",
        relatedArticles: ["fortianalyzer-log-ingestion-and-storage", "fortianalyzer-soc-events-incidents-playbooks"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.18",
        text: "FortiGuard",
        relatedArticles: ["fortimanager-policy-packages-and-installs", "fortigate-security-profiles-flow-vs-proxy"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.19",
        text: "FortiManager policy packages",
        relatedArticles: ["fortimanager-adoms-and-device-registration", "fortimanager-policy-packages-and-installs"],
        relatedTools: ["fortios-config-diff-explainer"],
        manualLinks: [],
      },
      ...
      },
      {
        id: "1.21",
        text: "Multi-tenancy",
        relatedArticles: ["fortimanager-adoms-and-device-registration", "fortiedr-architecture-and-deployment"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.22",
        text: "Virtual domains (VDOM)",
        relatedArticles: ["fortigate-initial-configuration-and-operation-modes"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "section-2",
        title: "Networking (40% of the exam)",
        objectives: [
      {
        id: "2.01",
        text: "Secure Private Access (SPA) preparation",
        relatedArticles: ["forticlient-ems-endpoint-security-ztna-and-troubleshooting", "fortigate-cloud-deployments-and-fortisase"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "2.02",
        text: "SD-WAN on-ramp",
        relatedArticles: ["fortigate-routing-and-sdwan-selection", "fortigate-cloud-deployments-and-fortisase", "fortisase-operations-onboarding-and-reporting"],
        relatedTools: ["fortigate-route-selection-explainer"],
        manualLinks: [],
      },
      {
      ...
      {
        id: "2.07",
        text: "Equal-cost multi-path (ECMP)",
        relatedArticles: ["fortigate-routing-and-sdwan-selection"],
        relatedTools: ["fortigate-route-selection-explainer"],
        manualLinks: [],
      },
      ...
      {
        id: "2.18",
        text: "Post-quantum cryptography (PQC) for IPsec key exchange",
        relatedArticles: ["fortigate-ipsec-vpn-topologies"],
        relatedTools: ["fortigate-ipsec-phase-mismatch-analyzer"],
        manualLinks: [],
      },
      ...
      {
        id: "2.21",
        text: "Virtual eXtensible LAN (VXLAN) over IPsec",
        relatedArticles: ["fortigate-ipsec-vpn-topologies"],
        relatedTools: ["fortigate-ipsec-phase-mismatch-analyzer"],
        manualLinks: [],
      },
      ...
      },
      {
        ...
        text: "Policy modes",
        relatedArticles: ["fortigate-firewall-policy-and-nat"],
        relatedTools: ["fortigate-policy-lookup-explainer", "fortigate-session-table-explainer"],
        manualLinks: [],
      },
      {
        id: "2.27",
        text: "Proxy rules",
        relatedArticles: ["fortigate-firewall-policy-and-nat", "fortigate-security-profiles-flow-vs-proxy"],
        relatedTools: ["fortigate-policy-lookup-explainer", "fortigate-session-table-explainer"],
        manualLinks: [],
      },
      {
      ...
      },
      {
        ...
        relatedArticles: ["fortigate-traffic-shaping-and-qos"],
        relatedTools: [],
        manualLinks: [],
      },
      {
      ...
      {
        id: "section-3",
        title: "Authentication (14% of the exam)",
        objectives: [
      {
        id: "3.01",
        text: "802.1X",
        relatedArticles: ["fortinac-device-modeling-and-profiling", "fortinac-isolation-access-control-and-onboarding"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "3.02",
        text: "ADOM-scoped administrators",
        relatedArticles: ["fortimanager-adoms-and-device-registration", "fortimanager-policy-packages-and-installs"],
        relatedTools: ["fortios-config-diff-explainer"],
        manualLinks: [],
      },
      ...
      {
        id: "3.06",
        text: "Device and user authentication",
        relatedArticles: ["fortigate-authentication-and-fsso"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "3.07",
        text: "Fabric single sign-on (SSO)",
        relatedArticles: ["fortigate-authentication-and-fsso"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "3.08",
        text: "Fortinet Single Sign-On (FSSO)",
        relatedArticles: ["fortigate-authentication-and-fsso"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "3.13",
        text: "RADIUS single sign-on (RSSO)",
        relatedArticles: ["fortigate-authentication-and-fsso"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "3.16",
        text: "Single sign-on mobility agent (SSOMA)",
        relatedArticles: ["fortigate-authentication-and-fsso"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "3.18",
        text: "Terminal Access Controller Access-Control System Plus (TACACs+)",
        relatedArticles: ["fortigate-authentication-and-fsso"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      },
      {
        ...
        relatedArticles: ["fortigate-acme-certificate-automation", "fortinet-ssl-inspection-modes"],
        relatedTools: [],
        manualLinks: [],
      },
      {
      ...
      {
        id: "section-4",
        title: "Fortinet Security Fabric (19% of the exam)",
        objectives: [
      {
        id: "4.01",
      ...
      {
        id: "4.02",
        text: "Automation stitches",
        relatedArticles: ["fortisoar-playbooks-jinja-and-connectors", "fortianalyzer-soc-events-incidents-playbooks"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "4.03",
        text: "Automated scripts",
        relatedArticles: ["fortimanager-adoms-and-device-registration", "fortimanager-policy-packages-and-installs"],
        relatedTools: ["fortios-config-diff-explainer"],
        manualLinks: [],
      },
      {
        id: "4.04",
        text: "Fortinet device APIs",
        relatedArticles: ["fortinet-cloud-automation-caas-and-native-integration", "fortisoar-playbooks-jinja-and-connectors"],
        relatedTools: [],
        manualLinks: [],
      },
      {
      ...
      },
      {
        id: "4.08",
        text: "Threat feeds",
        relatedArticles: ["fortigate-security-profiles-flow-vs-proxy", "fortinet-soc-architecture-and-adversary-behaviour"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "4.09",
        text: "Custom FortiAnalyzer views",
        relatedArticles: ["fortianalyzer-log-ingestion-and-storage", "fortianalyzer-soc-events-incidents-playbooks"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "4.15",
        text: "Network triaging",
        relatedArticles: ["fortigate-logging-and-diagnostics", "fortianalyzer-reports-datasets-and-charts"],
        relatedTools: [],
        manualLinks: [],
      },
      {
  ...
  {
    slug: "fortinet-nse-8-secure-networking",
    examCode: "NSE 8",
    examName: "NSE 8 Secure Networking Practical Exam",
    vendor: "fortinet",
    certification: "fortinet-nse-8",
    targetVersion: null,
    blueprintSourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=881_secure_networking_exam",
    blueprintSourceLabel: "Fortinet NSE Certification Program, effective 15 July 2026",
    status: "published",
    sourceCaveat: "truncated-blueprint",
    examFacts: null,
    sections: [
      {
        id: "section-1",
        title: "Secure SD-WAN (25% of the exam)",
        objectives: [
      {
        id: "1.01",
      ...
      {
        id: "1.02",
        text: "Advanced auto-discovery VPN (ADVPN)",
        relatedArticles: ["fortigate-ipsec-vpn-topologies"],
        relatedTools: ["fortigate-ipsec-phase-mismatch-analyzer"],
        manualLinks: [],
      },
      {
        id: "1.03",
        text: "Advanced IPsec troubleshooting",
        relatedArticles: ["fortigate-ipsec-vpn-topologies", "fortigate-logging-and-diagnostics"],
        relatedTools: ["fortigate-ipsec-phase-mismatch-analyzer", "fortios-sniffer-builder"],
        manualLinks: [],
      },
      {
        id: "1.04",
        text: "ADVPN 2.0 versus legacy",
        relatedArticles: ["fortigate-ipsec-vpn-topologies"],
        relatedTools: ["fortigate-ipsec-phase-mismatch-analyzer"],
        manualLinks: [],
      },
      {
        id: "1.05",
        text: "Application-based routing",
        relatedArticles: ["fortigate-routing-and-sdwan-selection"],
        relatedTools: ["fortigate-route-selection-explainer"],
        manualLinks: [],
      },
      ...
      {
        id: "1.08",
        text: "Software-defined branch (SD-Branch) deployment",
        relatedArticles: ["fortinet-sd-branch-and-overlay-fabric"],
        relatedTools: [],
        manualLinks: [],
      },
      {
      ...
      {
        id: "1.12",
        text: "Full mesh overlay networks",
        relatedArticles: ["fortigate-routing-and-sdwan-selection", "fortigate-ipsec-vpn-topologies"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.13",
        text: "Load balancing and redundancy",
        relatedArticles: ["fortiweb-deployment-policies-and-delivery", "fortiweb-application-security-bots-api-and-dos"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "1.16",
        text: "Performance SLAs and service rules",
        relatedArticles: ["fortigate-routing-and-sdwan-selection"],
        relatedTools: ["fortigate-route-selection-explainer"],
        manualLinks: [],
      },
      ...
      {
        id: "1.18",
        text: "Remote health signaling from spokes to hub",
        relatedArticles: ["fortigate-routing-and-sdwan-selection", "fortigate-ipsec-vpn-topologies"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.19",
        text: "Remote health signaling to third-party devices",
        relatedArticles: ["fortigate-routing-and-sdwan-selection", "fortigate-ipsec-vpn-topologies"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.20",
        text: "Route monitoring and triaging",
        relatedArticles: ["fortigate-routing-and-sdwan-selection"],
        relatedTools: ["fortigate-route-selection-explainer"],
        manualLinks: [],
      },
      ...
      {
        id: "1.24",
        text: "SLA probe Differentiated Services Code Point (DSCP) marking",
        relatedArticles: ["fortigate-routing-and-sdwan-selection"],
        relatedTools: ["fortigate-route-selection-explainer"],
        manualLinks: [],
      },
      ...
      {
        id: "1.30",
        text: "FortiManager zero-touch provisioning (ZTP)",
        relatedArticles: ["fortimanager-adoms-and-device-registration", "fortimanager-policy-packages-and-installs"],
        relatedTools: ["fortios-config-diff-explainer"],
        manualLinks: [],
      },
      {
        id: "1.31",
        text: "Jinja scripting",
        relatedArticles: ["fortimanager-adoms-and-device-registration", "fortimanager-policy-packages-and-installs", "fortisoar-playbooks-jinja-and-connectors"],
        relatedTools: ["fortios-config-diff-explainer"],
        manualLinks: [],
      },
      {
      ...
      {
        id: "section-2",
        title: "Endpoint security (20% of the exam)",
        objectives: [
      {
        id: "2.01",
        text: "ZTNA profiles",
      ...
      {
        id: "2.02",
        text: "Agentless portal on FortiGate",
        relatedArticles: ["forticlient-ems-endpoint-security-ztna-and-troubleshooting", "fortigate-cloud-deployments-and-fortisase"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "2.04",
        text: "ZTNA access proxy—HTTP/HTTPS",
        relatedArticles: ["forticlient-ems-endpoint-security-ztna-and-troubleshooting", "fortigate-cloud-deployments-and-fortisase", "fortigate-security-profiles-flow-vs-proxy"],
        relatedTools: [],
        manualLinks: [],
      },
      {
      ...
      {
        id: "2.06",
        text: "Endpoint malware protection",
        relatedArticles: ["fortiedr-policies-playbooks-and-communication-control", "fortiedr-threat-hunting-forensics-and-investigation"],
        relatedTools: [],
        manualLinks: [],
      },
      {
      ...
      },
      {
        id: "2.09",
        text: "FortiClient",
        relatedArticles: ["forticlient-ems-architecture-and-deployment", "forticlient-ems-endpoint-security-ztna-and-troubleshooting"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "2.10",
        text: "FortiClient EMS high availability (HA)",
        relatedArticles: ["fortigate-fgcp-ha-clustering", "forticlient-ems-architecture-and-deployment", "forticlient-ems-endpoint-security-ztna-and-troubleshooting"],
        relatedTools: ["fortigate-ha-failover-simulator"],
        manualLinks: [],
      },
      {
        id: "2.11",
        text: "FortiClient EMS integration",
        relatedArticles: ["forticlient-ems-architecture-and-deployment", "forticlient-ems-endpoint-security-ztna-and-troubleshooting"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      },
      {
        ...
        relatedArticles: ["fortimail-content-security-encryption-and-ibe", "fortigate-security-profiles-flow-vs-proxy"],
        relatedTools: [],
        manualLinks: [],
      },
        ],
      ...
      {
        id: "section-3",
        title: "Threat mitigation (30% of the exam)",
        objectives: [
      {
        id: "3.01",
        text: "Custom intrusion prevention system (IPS) signatures",
        relatedArticles: ["fortigate-security-profiles-flow-vs-proxy"],
        relatedTools: ["fortigate-security-profile-coverage-checker"],
        manualLinks: [],
      },
      ...
      {
        id: "3.07",
        text: "FortiSandbox HA",
        relatedArticles: ["fortigate-fgcp-ha-clustering", "fortimail-content-security-encryption-and-ibe", "fortigate-security-profiles-flow-vs-proxy"],
        relatedTools: ["fortigate-ha-failover-simulator"],
        manualLinks: [],
      },
      {
        id: "3.08",
        text: "Sniffer integration",
        relatedArticles: ["fortigate-logging-and-diagnostics"],
        relatedTools: ["fortios-sniffer-builder", "fortigate-session-table-explainer"],
        manualLinks: [],
      },
      ...
      {
        id: "3.12",
        text: "Carrier-grade network address translation (CGNAT)",
        relatedArticles: ["fortigate-carrier-nat-and-specialised-traffic"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "3.13",
        text: "Domain fronting protection",
        relatedArticles: ["fortigate-carrier-nat-and-specialised-traffic"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "3.17",
        text: "Operational technology (OT) security",
        relatedArticles: ["fortinet-ot-security"],
        relatedTools: [],
        manualLinks: [],
      },
      {
      ...
      {
        id: "section-4",
        title: "Enterprise networking (25% of the exam)",
        objectives: [
      {
        id: "4.01",
      ...
      {
        id: "4.04",
        text: "FortiNAC fabric integration",
        relatedArticles: ["fortinac-device-modeling-and-profiling", "fortinac-isolation-access-control-and-onboarding", "fortigate-firewall-policy-and-nat"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "4.05",
        text: "FortiNAC HA",
        relatedArticles: ["fortigate-fgcp-ha-clustering", "fortinac-device-modeling-and-profiling", "fortinac-isolation-access-control-and-onboarding"],
        relatedTools: ["fortigate-ha-failover-simulator"],
        manualLinks: [],
      },
      {
      ...
      {
        id: "4.10",
        text: "Enhanced MAC Virtual Local Area Network (EMAC VLAN)",
        relatedArticles: ["fortiswitch-vlans-stp-ports-and-qos", "fortiswitch-fortilink-provisioning-and-topologies"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "4.27",
        text: "Virtual eXtensible LAN (VXLAN)",
        relatedArticles: ["fortinet-sd-branch-and-overlay-fabric"],
        relatedTools: [],
        manualLinks: [],
      },
  ...
  {
    slug: "fortinet-nse-8-application-security",
    examCode: "NSE 8",
    examName: "NSE 8 Application Security Practical Exam",
    vendor: "fortinet",
    certification: "fortinet-nse-8",
    targetVersion: null,
    blueprintSourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=882_application_security_exam",
    blueprintSourceLabel: "Fortinet NSE Certification Program, effective 15 July 2026",
    status: "published",
    sourceCaveat: "truncated-blueprint",
    examFacts: null,
    sections: [
      {
        id: "section-1",
        title: "Email security (27% of the exam)",
        objectives: [
      {
        id: "1.01",
        text: "Archiving",
      ...
      },
      {
        id: "1.02",
        text: "DNS security",
        relatedArticles: ["fortimail-policies-session-filtering-and-antispam", "fortimail-smtp-fundamentals-and-deployment"],
        relatedTools: [],
        manualLinks: [],
      },
      {
      ...
      {
        id: "1.14",
        text: "Content disarm and reconstruction (CDR)",
        relatedArticles: ["fortimail-content-security-encryption-and-ibe"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "section-2",
        title: "Application delivery (44% of the exam)",
        objectives: [
      {
        id: "2.01",
        text: "Application Access Manager",
        relatedArticles: [],
        relatedTools: [],
        manualLinks: [],
        gap: true,
      ...
      {
        id: "2.03",
        text: "Agentless Application Gateway",
        relatedArticles: ["fortiweb-application-security-bots-api-and-dos", "fortiweb-deployment-policies-and-delivery"],
        relatedTools: [],
        manualLinks: [],
      },
      {
      ...
      {
        id: "2.05",
        text: "Global load balancing (GLB)",
        relatedArticles: ["fortiweb-deployment-policies-and-delivery", "fortiweb-application-security-bots-api-and-dos"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "2.09",
        text: "Server load balancing (SLB)",
        relatedArticles: ["fortiweb-deployment-policies-and-delivery", "fortiweb-application-security-bots-api-and-dos"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "2.10",
        text: "Web Cache Communication Protocol (WCCP)",
        relatedArticles: ["fortigate-carrier-nat-and-specialised-traffic"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "2.17",
        text: "Open Web Application Security Project (OWASP) Top 10 list",
        relatedArticles: ["fortiweb-application-security-bots-api-and-dos"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "2.20",
        text: "WAF Adaptive Learning 2.0",
        relatedArticles: ["fortiweb-deployment-policies-and-delivery", "fortiweb-application-security-bots-api-and-dos"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "section-3",
        title: "Threat detection (12% of the exam)",
        objectives: [
      {
        id: "3.01",
        text: "Air-gapped sandboxing",
        relatedArticles: ["fortimail-content-security-encryption-and-ibe", "fortigate-security-profiles-flow-vs-proxy"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "3.02",
        text: "Malware behavior analysis",
        relatedArticles: ["fortimail-content-security-encryption-and-ibe", "fortiedr-threat-hunting-forensics-and-investigation"],
        relatedTools: [],
        manualLinks: [],
      },
      {
      ...
      {
        id: "3.06",
        text: "Scan policies and objects",
        relatedArticles: ["fortimail-content-security-encryption-and-ibe", "fortiedr-threat-hunting-forensics-and-investigation"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "3.09",
        text: "Operational technology (OT) protection",
        relatedArticles: ["fortinet-ot-security"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "section-4",
        title: "Infrastructure (17% of the exam)",
        objectives: [
      {
        id: "4.01",
        text: "FortiADC clustering",
        relatedArticles: ["fortigate-fgcp-ha-clustering"],
        relatedTools: ["fortigate-ha-failover-simulator"],
        manualLinks: [],
      },
      ...
      {
        id: "4.07",
        text: "Mail transfer agent (MTA) and blind carbon copy (BCC) adapter integration",
        relatedArticles: ["fortimail-smtp-fundamentals-and-deployment", "fortimail-policies-session-filtering-and-antispam"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      },
      {
        ...
        relatedArticles: ["forticnapp-fundamentals-and-cloud-posture", "fortinet-cloud-automation-caas-and-native-integration"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "4.10",
        text: "Fortinet Security Fabric integration",
        relatedArticles: ["fortigate-firewall-policy-and-nat", "fortianalyzer-log-ingestion-and-storage"],
        relatedTools: [],
        manualLinks: [],
      },
  ...
  {
    slug: "fortinet-nse-8-security-operations",
    examCode: "NSE 8",
    examName: "NSE 8 Security Operations Practical Exam",
    vendor: "fortinet",
    certification: "fortinet-nse-8",
    targetVersion: null,
    blueprintSourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=883_security_operations_exam",
    blueprintSourceLabel: "Fortinet NSE Certification Program, effective 15 July 2026",
    status: "published",
    sourceCaveat: "truncated-blueprint",
    examFacts: null,
    sections: [
      {
        id: "section-1",
        title: "Automation (23% of the exam)",
        objectives: [
      {
        id: "1.01",
        text: "FortiManager Jinja scripting",
        relatedArticles: ["fortimanager-adoms-and-device-registration", "fortimanager-policy-packages-and-installs", "fortisoar-playbooks-jinja-and-connectors"],
        relatedTools: ["fortios-config-diff-explainer"],
        manualLinks: [],
      },
      {
        id: "1.02",
        text: "FortiManager provisioning templates",
        relatedArticles: ["fortimanager-adoms-and-device-registration", "fortimanager-policy-packages-and-installs"],
        relatedTools: ["fortios-config-diff-explainer"],
        manualLinks: [],
      },
      ...
      {
        id: "1.09",
        text: "Security orchestration, automation, and response (SOAR) playbooks",
        relatedArticles: ["fortianalyzer-log-ingestion-and-storage", "fortianalyzer-soc-events-incidents-playbooks", "fortisoar-playbooks-jinja-and-connectors"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.10",
        text: "Workflows and workspaces",
        relatedArticles: ["fortisoar-playbooks-jinja-and-connectors", "fortianalyzer-soc-events-incidents-playbooks"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "1.11",
        text: "FortiSIEM automation service",
        relatedArticles: ["fortisiem-analytics-queries-and-cmdb", "fortisiem-rules-incidents-and-remediation"],
        relatedTools: [],
        manualLinks: [],
      },
        ],
      ...
      {
        id: "section-2",
        title: "Analytics and reporting (26% of the exam)",
        objectives: [
      {
        id: "2.01",
      ...
      },
      {
        ...
        relatedArticles: ["fortianalyzer-log-ingestion-and-storage", "fortianalyzer-soc-events-incidents-playbooks", "forticnapp-fundamentals-and-cloud-posture"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "2.03",
        text: "Custom log parsers",
        relatedArticles: ["fortianalyzer-log-ingestion-and-storage", "fortianalyzer-soc-events-incidents-playbooks"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "2.05",
        text: "FortiAnalyzer custom reports",
        relatedArticles: ["fortianalyzer-log-ingestion-and-storage", "fortianalyzer-soc-events-incidents-playbooks"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "2.06",
        text: "FortiSIEM analytics",
        relatedArticles: ["fortianalyzer-log-ingestion-and-storage", "fortianalyzer-soc-events-incidents-playbooks", "fortisiem-analytics-queries-and-cmdb"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "2.07",
        text: "FortiSOAR reports",
        relatedArticles: ["fortianalyzer-log-ingestion-and-storage", "fortianalyzer-soc-events-incidents-playbooks", "fortisoar-playbooks-jinja-and-connectors"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "2.10",
        text: "Security information and event management (SIEM) parsers and monitors",
        relatedArticles: ["fortisiem-analytics-queries-and-cmdb", "fortisiem-rules-incidents-and-remediation"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      },
      {
        ...
        relatedArticles: ["fortiedr-threat-hunting-forensics-and-investigation", "fortisoar-incident-workflow-and-troubleshooting"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "2.14",
        text: "Endpoint detection and response (EDR) security incidents",
        relatedArticles: ["fortiedr-architecture-and-deployment", "fortiedr-threat-hunting-forensics-and-investigation", "fortianalyzer-log-ingestion-and-storage"],
        relatedTools: [],
        manualLinks: [],
      },
      {
      ...
      {
        id: "section-3",
        title: "Threat handling (29% of the exam)",
        objectives: [
      {
        id: "3.01",
        text: "EDR threat hunting",
        relatedArticles: ["fortiedr-architecture-and-deployment", "fortiedr-threat-hunting-forensics-and-investigation"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "3.03",
        text: "Device isolation and remediation",
        relatedArticles: ["fortiedr-policies-playbooks-and-communication-control", "fortiedr-threat-hunting-forensics-and-investigation"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "3.08",
        text: "Incident handling and response frameworks",
        relatedArticles: ["fortianalyzer-log-ingestion-and-storage", "fortianalyzer-soc-events-incidents-playbooks"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "3.09",
        text: "Application communication control",
        relatedArticles: ["fortiedr-architecture-and-deployment", "fortiedr-threat-hunting-forensics-and-investigation"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "3.16",
        text: "Suspicious indicator blocking",
        relatedArticles: ["fortiedr-policies-playbooks-and-communication-control", "fortiedr-threat-hunting-forensics-and-investigation"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      {
        id: "section-4",
        title: "Infrastructure (22% of the exam)",
        objectives: [
      {
        id: "4.01",
        text: "Advanced health system",
        relatedArticles: [],
        relatedTools: [],
        manualLinks: [],
        gap: true,
      ...
      {
        id: "4.04",
        text: "Device support advanced operations",
        relatedArticles: ["fortisiem-analytics-queries-and-cmdb", "fortisiem-rules-incidents-and-remediation"],
        relatedTools: [],
        manualLinks: [],
      },
      ...
      },
      {
        ...
        relatedArticles: ["fortisoar-architecture-and-data-model", "fortigate-initial-configuration-and-operation-modes"],
        relatedTools: [],
        manualLinks: [],
      },
      {
      ...
      {
        id: "4.09",
        text: "Segmented network support",
        relatedArticles: ["fortisiem-analytics-queries-and-cmdb", "fortisiem-rules-incidents-and-remediation"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "4.10",
        text: "FortiEDR HA",
        relatedArticles: ["fortigate-fgcp-ha-clustering", "fortiedr-architecture-and-deployment", "fortiedr-threat-hunting-forensics-and-investigation"],
        relatedTools: ["fortigate-ha-failover-simulator"],
        manualLinks: [],
      },
      {
      ...
      },
      {
        id: "4.13",
        text: "FortiSOAR HA",
        relatedArticles: ["fortigate-fgcp-ha-clustering", "fortisoar-playbooks-jinja-and-connectors", "fortisoar-incident-workflow-and-troubleshooting"],
        relatedTools: ["fortigate-ha-failover-simulator"],
        manualLinks: [],
      },
      {
        id: "4.14",
        text: "FortiSIEM HA",
        relatedArticles: ["fortigate-fgcp-ha-clustering", "fortisiem-analytics-queries-and-cmdb", "fortisiem-rules-incidents-and-remediation"],
        relatedTools: ["fortigate-ha-failover-simulator"],
        manualLinks: [],
      },
      {
      ...
      {
        id: "4.18",
        text: "Policy Analyzer management extension application (MEA)",
        relatedArticles: ["fortisiem-analytics-queries-and-cmdb", "fortisiem-rules-incidents-and-remediation"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "4.19",
        text: "Queue, shift, and leave management",
        relatedArticles: ["fortisoar-playbooks-jinja-and-connectors", "fortisoar-incident-workflow-and-troubleshooting"],
        relatedTools: [],
        manualLinks: [],
      },
      {
        id: "4.20",
        text: "Rules, reports, and dashboards",
        relatedArticles: ["fortianalyzer-log-ingestion-and-storage", "fortianalyzer-soc-events-incidents-playbooks"],
        relatedTools: [],
        manualLinks: [],
      },
  ...
  {
    slug: "fortinet-industry-ot-security-administrator",
    examCode: "OT Security",
    examName: "OT Security Architect",
    vendor: "fortinet",
    certification: "fortinet-industry-ot-security",
    targetVersion: null,
    blueprintSourceUrl: "https://training.fortinet.com/local/staticpage/view.php?page=certifications",
    blueprintSourceLabel: "Fortinet NSE Certification Program, effective 15 July 2026",
    status: "preparing",
    examFacts: null,
    sections: [],
  ...
  {
    slug: "fortinet-industry-mssp-security-administrator",
    examCode: "MSSP Security",
    examName: "MSSP Security Administrator",
    vendor: "fortinet",
