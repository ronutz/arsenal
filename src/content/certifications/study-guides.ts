...
export const certifications: Certification[] = [
...

  {
    ...
    vendor: "fortinet",
    examSlugs: ["fortinet-nse-1-cybersecurity-cloud-fundamentals"],
    requirementMode: "all",
    requirementNote: "Complete the online course. There is no exam at this level.",
    renewalNote: "Renewed by completing the course again. Automatically renewed by earning NSE 2 through NSE 8.",
    sourceUrl: "https://www.fortinet.com/nse-training-update",
  },
  {
    key: "fortinet-nse-2",
    code: "NSE 2",
    ...
    vendor: "fortinet",
    examSlugs: ["fortinet-nse-2-intro-ngfw"],
    requirementMode: "all",
    requirementNote: "Complete the online course. There is no exam at this level.",
    renewalNote: "Renewed by completing the course again, or automatically by earning NSE 3 or above.",
    sourceUrl: "https://www.fortinet.com/nse-training-update",
  },
  {
    key: "fortinet-nse-3",
    ...
    vendor: "fortinet",
    examSlugs: ["fortinet-nse-3-fortigate-operator"],
    requirementMode: "all",
    requirementNote: "Complete the online course and pass the online exam.",
    renewalNote: "Renews NSE 1 and NSE 2. Renewed by retaking the course and exam, or automatically by earning NSE 4 or above.",
    sourceUrl: "https://www.fortinet.com/nse-training-update",
  },
  {
    key: "fortinet-nse-4",
    ...
    vendor: "fortinet",
    examSlugs: ["fortinet-nse-4-fortios-administrator"],
    requirementMode: "all",
    requirementNote: "Pass the NSE 4 proctored exam. No prerequisite certifications.",
    renewalNote: "Valid two years. Renews NSE 1, 2 and 3. Renew via the recertification assessment if the proctored exam is under two years old, otherwise by passing the proctored exam.",
    sourceUrl: "https://www.fortinet.com/nse-training-update",
  },
  {
    key: "fortinet-nse-5",
    code: "NSE 5",
    name: "NSE 5 - Product Administrator",
    vendor: "fortinet",
    examSlugs: [
    ...
    requirementNote: "Pass ONE NSE 5 proctored exam. The exams below are grouped by track; any one of them earns the NSE 5 certification.",
    renewalNote: "Valid two years. Renews NSE 1, 2 and 3.",
    sourceUrl: "https://www.fortinet.com/nse-training-update",
  },
  {
    key: "fortinet-nse-6",
    code: "NSE 6",
    name: "NSE 6 - Product Administrator and Analyst",
    vendor: "fortinet",
    examSlugs: [
    ...
    requirementMode: "one",
    prerequisites: ["NSE 4 certification"],
    requirementNote: "Pass ONE NSE 6 proctored exam. The exams below are grouped by track; any one of them earns the NSE 6 certification.",
    renewalNote: "Valid two years. Renews NSE 1, 2 and 3.",
    sourceUrl: "https://www.fortinet.com/nse-training-update",
  },
  {
    ...
    requirementMode: "one",
    prerequisites: ["NSE 4 certification", "NSE 5 or NSE 6 certification (same track)"],
    requirementNote: "Pass ONE NSE 7 proctored exam, in the same track as the NSE 5 or NSE 6 certification held.",
    renewalNote: "Valid two years. Renews NSE 1, 2, 3, 4, and NSE 5 and 6 in the same track.",
    sourceUrl: "https://www.fortinet.com/nse-training-update",
  },
  {
    key: "fortinet-nse-8",
    ...
    requirementNote: "Pass the NSE 8 Core practical exam AND one NSE 8 elective practical exam. The Core exam is delivered on-site only; electives are available on-site or remotely.",
    renewalNote: "Valid two years, renewed by accumulating 200 activity points. Passing any NSE 8 practical exam renews all active NSE 1 to 7 certifications.",
    sourceUrl: "https://www.fortinet.com/nse-training-update",
  },
  {
    ...
    vendor: "fortinet",
    examSlugs: ["fortinet-industry-ot-security-architect"],
    requirementMode: "all",
    prerequisites: ["NSE 4 certification", "NSE 5 or NSE 6 certification", "NSE 7 certification (same track as the NSE 5 or NSE 6)"],
    requirementNote: "Pass the proctored OT Security Architect exam. Sits outside the eight-level structure.",
    renewalNote: "Valid two years. Does not renew other certifications.",
    sourceUrl: "https://www.fortinet.com/nse-training-update",
  },
  {
    ...
    vendor: "fortinet",
    examSlugs: ["fortinet-industry-mssp-security-administrator"],
    requirementMode: "all",
    prerequisites: ["NSE 4 certification", "NSE 5 or NSE 6 certification", "NSE 7 certification (same track as the NSE 5 or NSE 6)"],
    requirementNote: "Pass the proctored MSSP Security Administrator exam. Sits outside the eight-level structure.",
    renewalNote: "Valid two years. Does not renew other certifications.",
    sourceUrl: "https://www.fortinet.com/nse-training-update",
  },
];
...
export const studyGuides: StudyGuide[] = [
  ...
  },
  {
    ...
    examFacts: {
      ...
      note: "Languages: English, Japanese. Product version: FortiOS 7.6.0.",
    },
    sections: [
  {
    id: "section-1",
    title: "Deployment and system configuration",
    objectives: [
      {
        id: "1.01",
        ...
        relatedArticles: [],
        relatedTools: [],
        manualLinks: [{ label: "FortiOS 7.6.0 Administration Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.0/administration-guide", version: "7.6.0" }],
        gap: true,
      },
      {
        id: "1.02",
      ...
      {
        id: "1.03",
        text: "Configure an FGCP HA cluster",
        relatedArticles: [],
        relatedTools: [],
        manualLinks: [{ label: "FortiOS 7.6.0 Administration Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.0/administration-guide", version: "7.6.0" }],
        gap: true,
      ...
      {
        id: "1.05",
        text: "Describe FortiGate CNF and FortiGate VM in public cloud",
        relatedArticles: [],
        relatedTools: [],
        manualLinks: [{ label: "FortiOS 7.6.0 Administration Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.0/administration-guide", version: "7.6.0" }, { label: "FortiGate CNF Administration Guide", url: "https://docs.fortinet.com/document/fortigate-cnf/latest/administration-guide", version: null }],
        gap: true,
      },
      {
        id: "1.06",
        ...
        relatedArticles: [],
        relatedTools: [],
        manualLinks: [{ label: "FortiOS 7.6.0 Administration Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.0/administration-guide", version: "7.6.0" }, { label: "FortiSASE Administration Guide", url: "https://docs.fortinet.com/document/fortisase/latest/mature-administration-guide", version: null }],
        gap: true,
      },
    ],
  },
  {
    id: "section-2",
    title: "Firewall policies and authentication",
    objectives: [
      {
        id: "2.01",
      ...
      {
        id: "2.02",
        text: "Configure SNAT and DNAT options in firewall policies",
        relatedArticles: [],
        relatedTools: [],
        manualLinks: [{ label: "FortiOS 7.6.0 Administration Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.0/administration-guide", version: "7.6.0" }],
        gap: true,
      ...
      {
        id: "2.04",
        text: "Explain how to deploy and configure FSSO",
        relatedArticles: [],
        relatedTools: [],
        manualLinks: [{ label: "FortiOS 7.6.0 Administration Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.0/administration-guide", version: "7.6.0" }],
        gap: true,
    ...
    objectives: [
      {
        ...
        relatedArticles: ["fortinet-ssl-inspection-modes", "fortigate-acme-certificate-automation"],
        relatedTools: [],
        manualLinks: [{ label: "FortiOS 7.6.0 Administration Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.0/administration-guide", version: "7.6.0" }],
      },
      {
      ...
      {
        id: "3.05",
        text: "Configure IPS to protect networks from threats and vulnerabilities",
        relatedArticles: [],
        relatedTools: [],
        manualLinks: [{ label: "FortiOS 7.6.0 Administration Guide", url: "https://docs.fortinet.com/document/fortigate/7.6.0/administration-guide", version: "7.6.0" }],
        gap: true,
  ...
  },
  {
    ...
    status: "preparing",
    availabilityNote:
      "Fortinet lists this exam as to be added in Q3 2026. It appears in the certification structure but cannot be sat yet.",
    examFacts: null,
    sections: [],
  },
  {
  ...
  {
    slug: "fortinet-industry-ot-security-architect",
