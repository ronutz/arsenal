...
export const extremeProfile: VendorProfile = {
  ...
  timeline: [
    ...
    { year: 2013, title: "The consolidator decade opens: Enterasys", detail: "Announced September 12, 2013: Extreme acquires Enterasys for roughly $180 million in cash - the Cabletron lineage, and the network-management DNA that becomes central to Extreme's software story. My own Extreme chapter opens the same season: the 2013-2014 RNP RedeComep metro deployments told above.", sourceNote: "Prior-round canon (Cabletron/Enterasys page)." },
    ...
    { year: 2021, personal: true, title: "SD-WAN, and a teaching chapter begins", detail: "September 15, 2021: Infovista's Ipanema SD-WAN business joins. The same year, I become an Extreme Networks Certified Instructor - the start of the one relationship in this career section that is still active in the classroom today." },
    ...
    { year: 2013, personal: true, title: "My field chapter", detail: "2013 to 2014: field deployment and training delivery on Extreme gear in Brazil - the first Extreme chapter, eight years before the instructor authorization made it the active one." },
  ],
  products: [
    { name: "Summit and BlackDiamond", what: "The founding franchises: wire-speed gigabit fixed switches and the modular chassis that carried campus and metro Ethernet - including the EAPS optical rings of my RNP deployments." },
    { name: "ExtremeXOS", what: "The modular operating system descended from ExtremeWare - the EXOS that I deployed in the field in 2013-2014 and teaches today." },
    ...
    { name: "ExtremeCloud IQ", what: "The Aerohive-built cloud management plane unifying the whole estate - and the platform behind the ExtremeCloud IQ courses I deliver as a certified instructor." },
  ],
  innovations: [
    ...
    { title: "EAPS resilient rings", detail: "The Ethernet Automatic Protection Switching protocol brought sub-second ring failover to metro Ethernet - the mechanism at the heart of the RedeComep optical rings I built on." },
  ...
  markets: [
    ...
    "My relationship is unique in this section: field deployment in 2013-2014 (RNP RedeComep metro rings on EXOS and EAPS), and instruction ever since 2021 - Extreme is the one career-page vendor he still teaches, with nine authorized courses in the portfolio.",
  ],
  analyst: [
  ...
  careerLink: {
    href: "/extreme",
    label: "Extreme is a platform I teach today - the Extreme hub on this site",
  },
};
