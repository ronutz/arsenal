...
export const extremeProfile: VendorProfile = {
  ...
  timeline: [
    ...
    { year: 2021, personal: true, title: "SD-WAN, and a teaching chapter begins", detail: "September 15, 2021: Infovista's Ipanema SD-WAN business joins. The same year, Rodolfo becomes an Extreme Networks Certified Instructor - the start of the one relationship in this career section that is still active in the classroom today." },
    ...
    { year: 2013, personal: true, title: "Rodolfo's field chapter", detail: "2013 to 2014: field deployment and training delivery on Extreme gear in Brazil - the first Extreme chapter, eight years before the instructor authorization made it the active one." },
  ],
  products: [
