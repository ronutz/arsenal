...
export const fireeyeMcafeeIxiaProfile: VendorProfile = {
  ...
  timeline: [
    ...
    { year: 2015, title: "Rodolfo's distribution chapter opens", detail: "The 2015-2018 value-added distribution years: carrying FireEye, McAfee, and Ixia into the Brazilian channel - three vendors at three different inflection points, sold side by side into the same security-conscious accounts." },
