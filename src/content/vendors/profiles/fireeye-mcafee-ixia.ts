...
export const fireeyeMcafeeIxiaProfile: VendorProfile = {
  ...
  timeline: [
    ...
    { year: 2015, personal: true, title: "Rodolfo's distribution chapter opens", detail: "Five years carrying these vendors into the Brazilian channel from the distribution side: FireEye through the Westcon-Comstor years to 2018, then McAfee and Ixia through the ScanSource years to 2019 - three vendors at three different inflection points, sold into the same security-conscious accounts." },
