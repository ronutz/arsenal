...
// ----------------------------------------------------------------------------
// FIREEYE, McAFEE & IXIA - the 2015-2019 value-added distribution years (Westcon-Comstor 2015-2018 + ScanSource 2018-2019; span widened per PRIME ruling 2026-07-16),
...
export const fireeyeMcafeeIxiaProfile: VendorProfile = {
  ...
  timeline: [
    ...
    { year: 2015, personal: true, title: "My distribution chapter opens", detail: "Five years carrying these vendors into the Brazilian channel from the distribution side, across TWO employers rather than one: FireEye at Westcon-Comstor to 2018, then McAfee and Ixia at Network1/ScanSource to 2019, where they sat alongside Pulse Secure in the same portfolio. F5 is the line that runs through both distributors and is the actual continuity here - three vendors at three different inflection points, sold into the same security-conscious accounts." },
  ...
  markets: [
    ...
    "The 2015-2019 chapter put all three side by side in the Brazilian channel: FireEye at the height of its nation-state reputation, McAfee regaining independence from Intel mid-cycle, and Ixia validating and monitoring the very networks the other two defended.",
  ],
  analyst: [
