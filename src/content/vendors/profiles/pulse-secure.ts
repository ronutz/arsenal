...
export const pulseSecureProfile: VendorProfile = {
  ...
  timeline: [
    ...
    { year: 2018, personal: true, title: "My chapter", detail: "2018 to 2019: Pulse Connect Secure ran through Rodolfo's ScanSource portfolio - pre-sales and partner enablement on a product he had first known from inside Juniper." },
  ],
  products: [
