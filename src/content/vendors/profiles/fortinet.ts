...
export const fortinetProfile: VendorProfile = {
  ...
  timeline: [
    ...
    { year: 2024, personal: true, title: "My chapter", detail: "The NSE ladder climbed from 2022, Fortinet Certified Trainer since 2024 - the FCP curriculum delivered as the portfolio's third teaching pillar." },
  ],
  products: [
