...
export const nortelBayProfile: VendorProfile = {
  ...
  careerLink: {
    ...
    label: "I fought the hub-and-switch wars from the other side, at Cabletron (1996-2000) - the Cabletron page",
  },
};
