...
export const f5Profile: VendorProfile = {
  ...
  timeline: [
    ...
    { year: 2020, personal: true, title: "My chapter: the anchor platform", detail: "Certifications from 2015, F5 Authorized Instructor since 2020, DevCentral MVP 2022 through 2024: twelve official BIG-IP and TMOS courses, and the anchor of the teaching practice this site grows from." },
  ],
  products: [
