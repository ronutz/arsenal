...
export const ciscoProfile: VendorProfile = {
  ...
  timeline: [
    ...
    { year: 2003, personal: true, title: "My era opens: Linksys", detail: "March 20, 2003: Cisco announces the ~$500 million acquisition of Linksys, entering home networking as broadband spreads. The same year, I join Cisco in Brasilia - the recovering giant's government-sector front line in Brazil.", sourceNote: "Cisco SEC 8-K, Mar 20, 2003; closed June 2003." },
