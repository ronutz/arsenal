...
export const ciscoProfile: VendorProfile = {
  ...
  timeline: [
    ...
    { year: 2003, title: "Rodolfo's era opens: Linksys", detail: "March 20, 2003: Cisco announces the ~$500 million acquisition of Linksys, entering home networking as broadband spreads. The same year, Rodolfo joins Cisco in Brasilia - the recovering giant's government-sector front line in Brazil.", sourceNote: "Cisco SEC 8-K, Mar 20, 2003; closed June 2003." },
