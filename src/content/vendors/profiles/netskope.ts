...
export const netskopeProfile: VendorProfile = {
  ...
  timeline: [
    ...
    { year: 2025, personal: true, title: "My chapter", detail: "The accreditation sprint: Administrator, Integrator, and Architect earned across 2024 to 2026, and Netskope Certified Cloud Security Instructor in 2025 - SSE taught from inside the category's defining vendor." },
  ],
  products: [
