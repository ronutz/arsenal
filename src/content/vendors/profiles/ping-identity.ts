...
export const pingIdentityProfile: VendorProfile = {
  ...
  timeline: [
    ...
    { year: 2026, personal: true, title: "My chapter", detail: "PingFederate Practitioner in 2025 through Ping Identity Training, and the identity chapter opening in 2026 - the protocols this hub covers are the ones that carry the rest of the portfolio." },
  ],
  products: [
