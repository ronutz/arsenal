...
export const pingIdentityProfile: VendorProfile = {
  ...
  timeline: [
    ...
    { year: 2003, title: "PingFederate", detail: "The flagship federation server, and the product that made the argument concrete: an identity provider on one side, a service provider on the other, and a signed assertion crossing between two organisations that share no directory. It became the enterprise workhorse for connecting workforces and partners to applications, and the reference implementation many integrations were tested against." },
    ...
    { year: 2026, personal: true, title: "Rodolfo's chapter", detail: "PingFederate Practitioner in 2025 through Ping Identity Training, and the identity chapter opening in 2026 - the protocols this hub covers are the ones that carry the rest of the portfolio." },
  ],
  products: [
