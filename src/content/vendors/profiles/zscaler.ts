...
export const zscalerProfile: VendorProfile = {
  ...
  timeline: [
    ...
    { year: 2026, personal: true, title: "My chapter", detail: "The zero-trust chapter opening in 2026 - the segment where the perimeter stops being a place and becomes a decision made per session." },
  ],
  products: [
