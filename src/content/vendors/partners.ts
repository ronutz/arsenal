...
export const partnerVendors: PartnerVendor[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "The vendors say so themselves. Palo Alto Networks has named it its authorised global training partner of the year for the JAPAC region eleven years running. F5 named it best performing authorised training centre for Australia, the Pacific, China and Japan for 2022, having already given it a best-ATC award for 2020/21. Fortinet named it ATC partner of the year for APAC in 2026, a category awarded to whichever training centre has taught the most people. Check Point made it platinum elite partner of the year in 2024; Nutanix gave it a quality award for the same period; AlgoSec made it the sole training provider for the SAARC region.",
      "Read together those are not decorations. They are the same judgement made independently by companies that compete with each other, about a supplier none of them owns, and the criteria differ enough to be informative: Fortinet counted students taught, Nutanix counted quality scores, F5 counted performance across a region. A training company that satisfies all three is being measured on volume, on satisfaction and on coverage at once.",
    ...
    sources: [
      { label: "Red Education - Palo Alto Networks Authorised Global Training Partner of the Year 2024 for JAPAC, the eleventh consecutive year the company has held the title; the 2023 announcement records the tenth", url: "https://www.rededucation.com/awards/palo-alto-networks-training-partner-of-the-year-2024-for-japac/" },
      { label: "Fortinet Training Institute 2026 ATC Awards - Red Education named ATC Partner of the Year for APAC, announced May 2026; the category recognises the authorised training centre that has trained the largest number of individuals on Fortinet technologies", url: "https://www.rededucation.com/red-education-wins-fortinet-atc-partner-of-the-year-apac-award/" },
      { label: "Red Education F5 pages - Best Performing ATC for APCJ, covering Australia, the Pacific, China and Japan, awarded by F5 for 2022; the company also records a best F5 ATC award for 2020/21 and a 98 per cent customer satisfaction rating on its F5 practice", url: "https://www.rededucation.com/f5-networks/" },
      { label: "Red Education announcements - Check Point named the company its Platinum Elite ATC Partner of the Year, announced 2 February 2024; Nutanix awarded Highest Quality APAC Authorized Training Partner of the Year for fiscal 2023 on consistent quality scores; the company was also named sole Authorised Training Provider for AlgoSec across the SAARC region", url: "https://www.rededucation.com/tag/announcement/" },
  ...
  },
  {
    ...
    sources: [
      ...
      { label: "FireMon’s own history page dates FireMon 1.0 to March 2001, released while the product was part of FishNet Security", url: "https://www.firemon.com/company/" },
    ],
    tags: ["vendor"],
    group: "contemporary",
    founded: 2001,
  ...
  },
  {
    ...
    sources: [
      ...
      { label: "Skybox Security was co-founded in 2002 by Eran Reshef and Gidi Cohen; formerly SecLucid; headquartered in San Jose", url: "https://handwiki.org/wiki/Company:Skybox_Security" },
    ],
    tags: ["vendor"],
    group: "contemporary",
    founded: 2002,
  ...
  },
  {
    ...
    sources: [
      ...
      { label: "Conviso’s own history timeline records 2008 as the year the company was founded, with the first version of its platform launched in 2010", url: "https://www.conviso.com.br/about-us" },
    ],
    tags: ["services"],
    group: "contemporary",
    founded: 2008,
    ...
    body: [
      ...
      "Founded in 2008, it released the first version of what became its platform in 2010. The two-year gap is the interesting part: the consultancy came first and the product was built out of what the consultancy kept having to do by hand.",
    ],
  ...
  },
  {
    ...
    sources: [
      ...
      { label: "Flipside privacy policy - the company identifies itself as Flipside Treinamento Editora e Comercio LTDA - ME, CNPJ 09.058.270/0001-28, headquartered on Avenida Paulista in Sao Paulo", url: "https://www.flipside.com.br/poltica-de-privacidade", sourceNote: "First-party confirmation of the legal identity, which is what allows the registry date below to be attached to this company with confidence." },
      { label: "Brazilian federal tax registry - FLIPSIDE, TREINAMENTO, EDITORA E COMERCIO LTDA, CNPJ 09.058.270/0001-28, opened 11 September 2007 in Sao Paulo, principal activity training in professional and managerial development, CNAE 8599-6/04", url: "https://www.descubraonline.com/guia/sp/sao-paulo/flipside-09058270000128/", sourceNote: "The 0001 suffix confirms the head office. Related registrations under the same partner include Waitstate Comercio e Tecnologia da Informatica, opened 2001 and since closed, Flip Brain 2011, and Hackaflag Tecnologia em Informatica, opened 31 October 2018 - the last matching the capture-the-flag platform Flipside runs alongside its events." },
    ],
    tags: ["services", "training"],
    group: "contemporary",
    founded: 2007,
  ...
  },
  {
    ...
    sources: [
      ...
      { label: "CLM’s own institutional page dates its foundation to 1993, created after a split and acquisition involving the French bank Societe Generale in Brazil", url: "https://clm.tech/institucional/" },
    ],
    tags: ["distributor"],
    group: "contemporary",
    founded: 1993,
  ...
  },
  {
    ...
    sources: [
      ...
      { label: "YSSY’s own history section opens with 1996 and the founding of the group. PRIME records Grupo MTel as YSSY’s predecessor, and this date is the group’s rather than a separate founding of the YSSY brand", url: "https://yssy.com.br/quem-somos/" },
    ],
    tags: ["services", "reseller"],
    group: "contemporary",
    founded: 1996,
    ...
    body: [
      ...
      "Its own history begins in 1996 with the founding of the group rather than of the brand. Grupo MTel is the predecessor, and the distinction matters when reading the date: the thirty years on the counter belong to the group, and the name a client sees today is considerably younger than the business behind it.",
    ],
  ...
  },
  {
    ...
    sources: [
      ...
      { label: "BlueCat was launched in 2001 by two brothers, Richard and Michael Hyatt, to provide simple, secure and affordable network appliances", url: "https://www.networkworld.com/article/849880/wireless-four-more-privately-held-network-companies.html" },
    ],
    tags: ["vendor"],
    group: "contemporary",
    founded: 2001,
  ...
  },
  {
    slug: "nic-br",
    sources: [
      { label: "NIC.br - Historia (official): CGI.br created in 1995 by interministerial ordinance; the work began in the network team at Fapesp; NIC.br established as a legal entity in 2003 under Decree 4.829", url: "https://nic.br/historia/" },
      { label: "NIC.br - Sobre (official): a non-profit civil entity implementing the decisions and projects of CGI.br since December 2005", url: "https://nic.br/sobre/" },
      { label: "CGI.br release, December 2025: twenty years since NIC.br began receiving the revenue from .br operation, reinvested in CERT.br, Cetic.br, Ceptro.br, Ceweb.br and IX.br", url: "https://cgi.br/noticia/releases/nic-br-celebra-20-anos-de-atuacao-pelo-desenvolvimento-da-internet-no-brasil/" },
    ],
    tags: ["standards", "services"],
    relationships: ["worked-with-directly"],
    group: "other",
    name: "NIC.br - the registry that funds the plumbing",
    founded: 2003,
    tagline: "Runs .br, allocates the country's addresses, and spends the proceeds on infrastructure everyone uses.",
    intro: "The Nucleo de Informacao e Coordenacao do Ponto BR was established as a legal entity in 2003 and took over the .br registry in December 2005, implementing the decisions of CGI.br - the multistakeholder committee created in 1995 that governs the internet in Brazil.",
    body: [
      "Its origin is worth keeping: the work began inside the network team at Fapesp, the Sao Paulo state research foundation, which is where the Brazilian internet started. A national registry grew out of a university networking group, and the continuity of the people is part of why it behaves the way it does.",
      "The funding model is the unusual part, and it is what most countries did not do. Registration fees for .br domains do not go to a shareholder; they fund CERT.br for incident response, Cetic.br for measurement, Ceptro.br for network engineering, Ceweb.br for web technologies, and IX.br for traffic exchange. A registry is a licence to collect a small rent from every domain in a country, and this one was pointed back at the network.",
      "IX.br is the clearest consequence. CGI.br argued from 1998 that traffic exchange points mattered, and the reason given was operational rather than political: before them, data sent between two points in the same city on different networks routinely travelled abroad and back, which cost money, added delay, and exposed the traffic on the way.",
      "The governance model is the other export. CGI.br brings government, industry, academia and civil society into one body with a defined composition, at a time when most countries had either a ministry or a contractor. Whether that model is better is argued about; that it is unusual is not.",
    ],
    externalUrl: "https://nic.br/",
    externalLabel: "NIC.br",
  },
{
    slug: "petrobras",
    sources: [
      { label: "Lei 2.004 of 3 October 1953 (Wikipedia, with the text of article 1): created Petroleo Brasileiro S.A. and the state monopoly over exploration, refining and transport", url: "https://pt.wikipedia.org/wiki/Lei_Federal_do_Brasil_2004_de_1953" },
      { label: "Fundacao Getulio Vargas, Atlas Historico: the bill spent almost 22 months in Congress and the monopoly was added during passage, not proposed", url: "https://atlas.fgv.br/verbete/6293" },
      { label: "Wikipedia - Petrobras: founded 3 October 1953, headquartered in Rio de Janeiro, production of about 3.4 million barrels of oil equivalent per day (2023)", url: "https://en.wikipedia.org/wiki/Petrobras" },
    ],
    tags: ["services"],
    relationships: ["worked-with-directly"],
    group: "other",
    name: "Petrobras - the network that follows the oil",
    founded: 1953,
    tagline: "State oil company created in 1953, and one of the largest private networks in the country.",
    intro: "Petroleo Brasileiro S.A. was created by Law 2.004 of 3 October 1953, which also established the state monopoly over exploration, refining and transport - a monopoly that was not in the original bill and was added during almost twenty-two months of passage through Congress.",
    body: [
  ...
  },
  {
    slug: "embraer",
    sources: [
      { label: "Wikipedia - Embraer: founded 19 August 1969 by Ozires Silva with Brazilian government funding, headquartered in Sao Jose dos Campos, privatised in 1994", url: "https://en.wikipedia.org/wiki/Embraer" },
      { label: "Wikipedia - Privatizacao no Brasil: Embraer among the companies privatised in the programme of the Itamar Franco government (1992-1995)", url: "https://pt.wikipedia.org/wiki/Privatiza%C3%A7%C3%A3o_no_Brasil" },
    ],
    tags: ["services"],
    relationships: ["worked-with-directly"],
    group: "other",
    name: "Embraer - the state built an aerospace company and then sold it",
    founded: 1969,
    tagline: "Founded 1969 as a national champion, privatised 1994, third largest producer of civil aircraft.",
    intro: "Embraer was founded on 19 August 1969 at Sao Jose dos Campos by Ozires Silva with government funding, as a deliberate attempt to create domestic aerospace capability. It supplied the air force first, moved to regional airliners for export in the 1980s, was privatised in 1994, and is now the third largest producer of civil aircraft.",
    body: [
      "The arc is the interesting part, and it is unusual: a state-funded national champion that survived privatisation and then competed internationally on engineering rather than on protection. Most attempts at that sequence fail at the second step.",
      "The computing behind it is the reason it belongs here. Aircraft design is decades of engineering data that must remain readable and traceable for the service life of the airframe - which is longer than the life of any format, any vendor and most operating systems. Configuration management on that timescale is a records problem before it is a storage problem.",
      "It is also an export-controlled manufacturer with suppliers on several continents, which makes the network a compliance surface as much as a transport: what may cross which border, in which direction, is a question about data as much as about parts.",
    ],
  ...
  },
{
  ...
  // one was checked. ----
  {
    ...
    sources: [
      ...
      { label: "Brazilian federal tax registry via multiple aggregators - CONVERSYS IT SOLUTIONS COMERCIO E SERVICOS DE TECNOLOGIA LTDA, CNPJ 24.235.348/0001-26, registered 22 February 2016 in Sao Paulo, with a branch in Itajai registered 2024", url: "https://cnpj.biz/24235348000126", sourceNote: "This is the CNPJ registration date and no earlier founding date was found. One aggregator carrying the same registry data also states in its own prose that the company was founded in 2022, which contradicts the registration date it publishes on the same page; that prose is disregarded as generated filler rather than treated as a competing source." },
    ],
    tags: ["reseller", "services"],
    group: "contemporary",
    founded: 2016,
  ...
  },
  {
    ...
    sources: [
      ...
      { label: "Gantech describes itself as a technology and information security company founded in 2006 by specialists in IT", url: "https://www.gantech.com.br/" },
    ],
    tags: ["services", "reseller"],
    group: "contemporary",
    founded: 2006,
  ...
  },
  {
    ...
    sources: [
      ...
      { label: "Contacta company page - a history marked by results, trust and partnership, founded in 1988", url: "https://www.contacta.com.br/a-contacta", sourceNote: "The company states 1988; the federal registry records CONTACTA SEGURANCA EM CONECTIVIDADE LTDA, CNPJ 40.175.986/0001-55, Rio de Janeiro, with activity beginning 24 January 1991. The business is recorded here rather than the legal entity, following the same treatment as Teltec, whose trade press history predates its CNPJ by eleven years." },
    ],
    tags: ["services", "reseller"],
    relationships: ["worked-with-directly"],
    group: "contemporary",
  ...
  // the instruction is not something I can assert. ----
  {
    ...
    sources: [
      ...
      { label: "Wikipedia (Portuguese) - Elgin, a Brazilian manufacturer of appliances and electronics within Grupo Elgin, founded 1952 in Mogi das Cruzes, Sao Paulo; it acquired Bematech Hardware in 2019 for R$25 million", url: "https://pt.wikipedia.org/wiki/Elgin_(empresa)" },
      { label: "Museu Angelo Spricigo, sewing machine archive - the company began operations in 1952 in Mogi das Cruzes and produced its first sewing machine a year later. Its founders had visited the British Museum in the late 1940s and been struck by the Elgin Marbles; deciding the company should work to a similar standard, they took the name Elgin. Building the cast-iron machine body required its own foundry, which became a division of the company in its own right", url: "http://www.angelospricigo.com.br/informativos/2545-marca-elgin" },
    ],
    tags: ["vendor"],
    group: "other",
    founded: 1952,
  ...
  },
  {
    ...
    sources: [
      ...
      { label: "IT-ONE states on its own about page that it was founded in 2002 in Belo Horizonte", url: "https://itone.com.br/sobre-nos/" },
    ],
    tags: ["reseller", "services"],
    group: "contemporary",
    founded: 2002,
  ...
  },
  {
    ...
    sources: [
      ...
      { label: "Altasnet states on its own site that it has operated as an IT solutions integrator for private companies and government since 2002", url: "https://altasnet.com.br/" },
    ],
    tags: ["reseller", "services"],
    group: "contemporary",
    founded: 2002,
  ...
  },
  {
    ...
    sources: [
      ...
      { label: "Brazilian federal tax registry via the public CNPJ service - E SAFER CYBERSECURITY SOLUCOES E SERVICOS EM SEGURANCA, CNPJ 15.304.440/0001-00, Barueri, Sao Paulo, activity beginning 5 March 2012", url: "https://brasilapi.com.br/api/cnpj/v1/15304440000100" },
    ],
    tags: ["services"],
    group: "contemporary",
    founded: 2012,
...

  {
    ...
    sources: [
      ...
      { label: "Brazilian federal tax registry - GOLDNET T I S/A, CNPJ 01.536.701/0001-02, registered 15 July 1996, headquartered in Jundiai, Sao Paulo", url: "https://www.informecadastral.com.br/cnpj/goldnet-t-i-sa-01536701000102", sourceNote: "Identity confirmed before recording: goldnet.com.br gives its address in Jundiai, Sao Paulo, matching this registration. Two unrelated Brazilian companies share the Goldnet name - an internet provider in Araruama registered 2023 and Gold Telecom in Sao Gotardo registered 2009 - and neither is this company." },
    ],
    tags: ["reseller", "services"],
    group: "contemporary",
    founded: 1996,
  ...
  },
  {
    ...
    sources: [
      ...
      { label: "Brazilian federal tax registry - UNENTEL SOLUCOES TECNOLOGICAS LTDA, CNPJ 19.557.079/0001-84, registered 21 January 2014, headquartered in Salvador, Bahia", url: "https://www.informecadastral.com.br/cnpj/unentel-solucoes-tecnologicas-ltda-19557079000184", sourceNote: "This is the head office registration. The branches carry later dates - 2016 and 2017 in Bahia and Espirito Santo, 2019 in Sao Paulo - and are not founding dates. One aggregator’s generated prose claims more than forty years in the market, which contradicts the registration it publishes on the same page and is disregarded." },
    ],
    tags: ["reseller", "services"],
    group: "contemporary",
    founded: 2014,
...

  {
    ...
    sources: [
      ...
      { label: "Junta Comercial do Distrito Federal filing, reproduced in a public procurement dossier - NTSEC SOLUCOES EM TELEINFORMATICA LTDA, CNPJ 09.137.728/0001-34, contrato social registered under number 5320143069.3 by despatch of 18 October 2007, established in Brasilia", url: "https://www.prodam.am.gov.br/wp-content/uploads/2015/08/24-Documentos-de-Habilitacao-NTSEC.pdf", sourceNote: "A primary legal filing rather than a company database. The 0001 suffix confirms this is the head office; the branches carry later dates - Fortaleza and Sao Paulo 2019, Recife 2024. A separate company trading as Ntsec Network Security in Brasilia holds a different CNPJ root, 22.675.357, registered 2015, and is not this registration." },
    ],
    tags: ["reseller", "services", "training"],
    relationships: ["worked-with-directly"],
    group: "contemporary",
    ...
    body: [
      ...
      "Its constitutive act is a matter of public record: the contrato social was registered at the Junta Comercial do Distrito Federal by despatch of 18 October 2007. That the document is readable at all is an accident of procurement - it survives inside a bidding dossier lodged with a state technology company, which is where a good deal of Brazilian corporate history is quietly preserved.",
    ],
...

  {
    ...
    sources: [
      ...
      { label: "Diario Oficial do Estado de Sao Paulo, 24 March 2016, publishing CPM Braxis S.A.’s administration report and financial statements for 2015: the company was founded in 2007 through the merger of two Brazilian service providers, CPM, constituted in 1982, and Braxis, established in 2006; Capgemini acquired most of the shares and became the controlling shareholder in October 2010, and the Capgemini brand was adopted in October 2012", url: "https://www.jusbrasil.com.br/diarios/111791075/dosp-empresarial-24-03-2016-pg-28", sourceNote: "The company’s own filed annual report in the state official gazette, which is why the lineage is precise. The founding year recorded here is CPM Braxis itself, formed by merger in 2007; CPM dates to 1982 and Braxis to 2006, and both are predecessors rather than earlier names of the same entity." },
    ],
    tags: ["services"],
    group: "other",
    founded: 2007,
...

  {
    ...
    sources: [
      ...
      { label: "NovaRed states on its own about page that it has been delivering since 1995, with offices in Chile, Argentina, Brazil and Spain", url: "https://www.novared.net/nosotros/" },
    ],
  ...
  },
  {
    ...
    sources: [
      ...
      { label: "Suno, October 2021, reporting Patria Investimentos acquiring two digital security companies to form the largest specialised information security platform in Latin America: NeoSecure was founded in 1999 in Chile, and the combined operation spans Brazil, Chile, Argentina, Peru and Colombia", url: "https://www.suno.com.br/noticias/patria-investimentos-pax-seguranca-digital-alta-do-setor/" },
    ],
    tags: ["services"],
    group: "other",
    founded: 1999,
    ...
    body: [
      ...
      "Founded in Chile in 1999, it was acquired alongside Proteus in 2021 by an investment fund assembling what it described as the largest specialised information security platform in Latin America, spanning Brazil, Chile, Argentina, Peru and Colombia. The pattern is the one this timeline records repeatedly in the 2020s: national specialists with twenty years behind them, combined into a regional group by capital rather than by merger of equals.",
    ],
  },
  {
    slug: "proteus",
  ...
  },
  {
    ...
    sources: [
      ...
      { label: "Global Knowledge states on its own about page that it has been delivering training since 1995, from a corporate headquarters in Cary, North Carolina; it merged with Skillsoft in June 2021", url: "https://www.globalknowledge.com/en/company/about-us" },
    ],
    tags: ["training"],
    group: "contemporary",
    founded: 1995,
  ...
  },
  {
    ...
    sources: [
      ...
      { label: "ACATE, March 2021 - marking thirty years of Teltec Solutions: the company was born on 18 March 1991, initially as Santec, founded by Glauco Brites Ramos with two partners in Florianopolis, starting in a furniture warehouse belonging to one of them with two employees. Santec took part in implementing telephony for 110 municipalities of Santa Catarina, grew to 180 employees, and had to reinvent itself for the first time when the telephony sector was privatised in 1998", url: "https://www.acate.com.br/blog-da-acate/relembre-os-30-anos-de-teltec-solutions-so-faz-historia-quem-ousa-transformar/" },
      { label: "Brazilian federal tax registry - TELTEC SOLUTIONS LTDA, CNPJ 04.892.991/0001-15, registered 14 February 2002, headquartered in Florianopolis, Santa Catarina", url: "https://monitorcnpj.com.br/cnpj/04892991000115/", sourceNote: "The business dates to 1991 as Santec; the current legal entity was registered in 2002. The founding year here is the business, not the CNPJ." },
    ],
    tags: ["reseller", "services"],
    relationships: ["worked-with-directly"],
    group: "contemporary",
    ...
    body: [
      ...
      "The company did not begin as Teltec. It was born on 18 March 1991 as Santec, founded in Florianopolis by Glauco Brites Ramos with two partners, working out of a furniture warehouse belonging to one of them with two employees. Santec took part in bringing telephony to 110 municipalities of Santa Catarina and grew to 180 people, and when the sector was privatised in 1998 the business had to reinvent itself for the first time. The current legal entity dates only to 2002, which is a reminder that a Brazilian company is often considerably older than the CNPJ it trades under.",
    ],
...

  {
    slug: "oi",
    sources: [
      { label: "Oi (Wikipedia): formed as Tele Norte Leste to merge sixteen state-owned incumbent local exchange carriers during the privatisation of the Brazilian telecommunications system, each serving a state in the north, northeast or southeast; largest fixed-line operator in Brazil; announced a merger with Portugal Telecom in 2013, which Altice acquired in June 2015; on 20 June 2016 filed for bankruptcy protection of R$65 billion, about US$19 billion, the largest on record in Brazil", url: "https://en.wikipedia.org/wiki/Oi_(telecommunications)" },
      { label: "Eu Quero Investir, 2025 - the company was born in the 1998 Telebras privatisation as Tele Norte Leste Participacoes, one of twelve companies created by the break-up; the winning consortium led by Andrade Gutierrez paid R$3.4 billion; in April 1999 it adopted the commercial name Telemar, from TELE for telephony and MAR for the coastline where it began; the Oi brand was created in 2002 for the mobile service, and a 2007 restructuring unified everything under that name", url: "https://euqueroinvestir.com/acoes/historia-da-oi-como-a-empresa-foi-de-supertele-a-falencia" },
    ],
    tags: ["carrier"],
    relationships: ["worked-with-directly"],
    group: "other",
    founded: 1998,
    name: "Oi - sixteen companies assembled into one, then unassembled",
    tagline: "Brazilian carrier created by the 1998 Telebras privatisation; filed the largest bankruptcy protection in Brazilian history in 2016.",
    intro: "Oi began in 1998 as Tele Norte Leste, one of twelve companies created when the state telecommunications system was broken up and sold. It merged sixteen state-owned local operators covering the north, northeast and southeast, traded as Telemar from 1999, took the Oi name for its mobile service in 2002, and applied it to everything from 2007.",
    body: [
    ...
    externalUrl: "https://en.wikipedia.org/wiki/Oi_(telecommunications)",
    externalLabel: "Oi",
  },
  {
    slug: "algar-telecom",
    sources: [
      { label: "Algar Telecom (Wikipedia): founded 15 February 1954 in Uberlandia by Alexandrino Garcia, predecessor CTBC; the only operator that remained private after the creation of Telebras under the military regime; present in nine states and the Federal District", url: "https://en.wikipedia.org/wiki/Algar_Telecom" },
      { label: "Meios no Brasil - CTBC incorporated telephone companies in eight cities in 1967, extending its network into Sao Paulo, Minas Gerais and Mato Grosso do Sul; in 1969 the group founded a printing company for telephone directories; when Telebras was created in 1972 and most operators passed to state control, CTBC kept private control, its concessions being technically fit for integration with the rest of the system; it was the first telecommunications company to deploy cellular technology in the interior of Brazil, in 1993", url: "http://www.meiosnobrasil.com.br/?page_id=214" },
      { label: "Memoria Algar - the company\u2019s own history: Alexandrino Garcia mobilised the Uberlandia commercial association over a crisis in local telephone service, which resulted in the creation of the company in February 1954; he took control of it in 1958 in order to expand beyond Uberlandia", url: "https://memoriaalgar.com.br/1950-1959/", sourceNote: "Sources give different expansions of the CTBC acronym - Companhia de Telefones do Brasil Central, Companhia de Telecomunicacoes do Brasil Central and Companhia Telefonica da Borda do Campo all appear. The company\u2019s own history uses the first. The acronym is stable; the expansion is not, and none is asserted here." },
    ],
    tags: ["carrier"],
    group: "other",
    founded: 1954,
    name: "Algar Telecom - the operator the state never took",
    tagline: "Brazilian carrier founded 1954 as CTBC in Uberlandia, and the only one to stay private through nationalisation.",
    intro: "Algar Telecom was founded in February 1954 in Uberlandia, Minas Gerais, as CTBC, and Alexandrino Garcia took control of it in 1958 to expand beyond the city. It is the only Brazilian telephone operator that remained in private hands when the state took over the sector, and it carries the Algar name from 2013.",
    body: [
      "That single fact is why it belongs beside Oi on this timeline. When Telebras was created in 1972 and telephony passed to state control, this company did not - and it is still family-controlled seventy years after it started. Oi was assembled out of sixteen state companies by privatisation and filed the largest bankruptcy in Brazilian history; the operator that never entered the state system at all is still operating.",
      "Its origin is unusually specific for a utility. A local businessman in the vehicle trade, faced with a telephone service that did not work, organised the city\u2019s commercial association around fixing it, and the company came out of that. It is a reminder that infrastructure in the interior arrived because somebody local decided it should, rather than because a plan reached them.",
      "The interior is also the whole strategy. It reached eight more cities by 1967, printed the telephone directories itself from 1969, and was the first operator to put cellular service into the interior of Brazil, in 1993 - consistently early in places that national accounts of this industry describe as arriving late.",
    ],
    externalUrl: "https://www.algartelecom.com.br/",
    externalLabel: "Algar Telecom",
  },

  {
    slug: "d-link",
    sources: [
      { label: "D-Link (Wikipedia): Taiwanese manufacturer of networking hardware, formerly Datex Systems from 1986 to 1992, headquartered in Taipei and listed on the Taiwan Stock Exchange as 2332", url: "https://en.wikipedia.org/wiki/D-Link" },
      { label: "HandWiki: Datex Systems was founded in 1986 in Taipei and renamed D-Link in 1992; the company became the first networking company on the Taiwan Stock Exchange in 1994; in 1988 it released LANSmart, a peer-to-peer network operating system able to run concurrently with Novell NetWare and TCP/IP, which most small network operating systems could not do at the time; in 2007 it led the small and medium business segment worldwide with 21.9% share, and in March 2008 led Wi-Fi product shipments with 33%", url: "https://handwiki.org/wiki/Company:D-Link" },
      { label: "D-Link corporate brand story: founded 1986 by Ken Kao and six friends as Datex Systems, with D-Link Corporation formally established in 1987 at Hsinchu Science Park and listed on the Taiwan Stock Exchange in 1994 under code 2332", url: "https://company.dlink.com/en/about/brand-story" },
      { label: "Network Headlines - the name Datex combined data and exchange, and the rename kept the D and added Link for the network at the core of the business; Kao wanted a company that produced its own devices rather than depending on an original equipment manufacturer; the first product was a 1-Mbps network interface card, followed in 1987 by the DE-001, the first Ethernet adapter for the PC; from 1989 the company designed and mass-produced its own Ethernet controller chips", url: "https://networkheadlines.com/d-link-company-history/" },
    ],
    tags: ["vendor"],
    group: "contemporary",
    founded: 1986,
    name: "D-Link - the adapter in the machine, not the rack",
    tagline: "Taiwanese networking manufacturer founded 1986 as Datex Systems; first networking company listed in Taiwan.",
    intro: "D-Link was founded in Taipei in 1986 by Ken Kao and six others as Datex Systems - data and exchange - selling network adapters. It renamed itself in 1992, keeping the D and adding Link, and in 1994 became the first networking company to list on the Taiwan Stock Exchange.",
    body: [
      "It entered the industry from the opposite end to most of the vendors on this timeline. The companies that dominate these pages sold to carriers and large enterprises; this one sold the card that went into the personal computer, then the hub, then the small-office router. That is the half of the network nobody writes histories about and most people have actually touched.",
      "One 1989 decision is worth placing against the making milestones here. It began designing and manufacturing its own Ethernet controller chips rather than buying them, to cut cost and dependence - the exact opposite of the direction the industry later took, when merchant silicon made buying the chip the cheaper option and building it the expensive one. Both choices were correct in their decade, which is the point.",
      "The founder\u2019s stated aim was a company that made its own products rather than manufacturing under somebody else\u2019s badge, in a country whose electronics industry was largely built on doing exactly that. The timeline records the Irish and Brazilian versions of that question elsewhere; this is the Taiwanese one, answered by a company that put its own name on the box.",
    ],
    externalUrl: "https://www.dlink.com/",
    externalLabel: "D-Link",
  },

  {
    slug: "sagemcom",
    sources: [
      { label: "Sagemcom (Wikipedia): the activities descend from Sagem, which merged with Snecma in 2005 to form Safran; in 2008, following a leveraged management buyout, Safran sold Sagem Communications to The Gores Group and the company became majority-owned by the investment fund and its employees; Charterhouse Capital Partners later took the majority; in 2020 it unveiled a Wi-Fi 6 box for Bouygues Telecom after developing a new box for SFR", url: "https://en.wikipedia.org/wiki/Sagemcom" },
      { label: "Sagemcom - about us: a French industrial group supplying communicating terminals for the broadband, audio video and energy markets, designing and manufacturing through its own factories and industrial partners; 6,500 employees across more than 50 countries; 30% of the capital is owned by its employees; in leveraged buyout since the 2008 carve-out from Safran, and in its fifth such phase from 2024 with Charterhouse as major shareholder", url: "https://www.sagemcom.com/en/about-us?language_content_entity=en" },
      { label: "The Gores Group case study: in January 2008 Gores carved Sagem Communications out of Safran; the company specialises in digital television set-top boxes, broadband residential terminals and printing terminals", url: "https://www.gores.com/case-study-sagem-communications/" },
    ],
    tags: ["vendor"],
    group: "contemporary",
    founded: 2008,
    name: "Sagemcom - the box in the house nobody chose",
    tagline: "French manufacturer of broadband gateways, set-top boxes and meters, carved out of Safran in 2008.",
    intro: "Sagemcom builds customer premises equipment: the broadband gateway an operator installs in a home, the television set-top box beside it, and the smart meter outside. It was carved out of Safran in 2008 in a leveraged management buyout, and descends from Sagem, a French manufacturer dating to 1924.",
    body: [
    ...
    externalUrl: "https://www.sagemcom.com/",
    externalLabel: "Sagemcom",
  },

  {
    slug: "procera-networks",
    sources: [
    ...
    group: "other",
    founded: 2002,
    name: "Procera Networks - the company that reads the traffic",
    tagline: "Deep packet inspection vendor, taken private in 2015 and merged into Sandvine in 2017.",
    intro: "Procera Networks built deep packet inspection systems - PacketLogic - which identify what an application flow actually is, so that an operator can measure it, prioritise it, charge for it or block it. Francisco Partners took the company private in 2015 for US$240 million and merged it with its long-standing rival Sandvine in 2017, keeping the Sandvine name.",
    body: [
      "Deep packet inspection is the same capability described elsewhere on this site under filtering, and it raises the same question. A system that can tell a video stream from a voice call so the voice call is not delayed, is the identical system that can tell a person is using a particular messaging application. The engineering does not distinguish between those uses; only policy and law do.",
      "That is not an abstract observation about this company. In 2016 an engineer resigned over a proposed deployment, and Forbes reported on the use of the technology in Turkey the same year. Both are cited here because a timeline that records what equipment does should record what it has been used for, and because the people who build these systems are sometimes the first to say so.",
      "The commercial history is briefer. Public through a reverse merger in 2003, on NASDAQ from 2011, bought under pressure from activist shareholders in 2015, then merged with the competitor it had spent a decade against - both by then owned by the same investor. Two rivals in one market end up as one company because one buyer wanted both, which is a pattern this timeline records repeatedly.",
    ],
    externalUrl: "https://en.wikipedia.org/wiki/Procera_Networks",
    externalLabel: "Procera Networks",
  },

  {
    slug: "quest-software",
    sources: [
      { label: "Quest Software (Wikipedia): founded 1987 in Newport Beach, California, with high-availability and middleware products for HP Multi-Programming Executive; known for Toad; acquired by Dell in 2012 for US$2.36 billion to form Dell Software; in June 2016 Dell announced the sale of its software division, including Quest, SonicWall and One Identity, to Francisco Partners and Elliott Management, completed 1 November 2016, and the company relaunched as Quest Software; One Identity was announced as an independent brand on 1 June 2017 while remaining part of the Quest family", url: "https://en.wikipedia.org/wiki/Quest_Software" },
      { label: "Blocks & Files, November 2021 - Quest was started in 1987 and grew to 100,000 customers before Dell bought it and combined it with SonicWall; Dell, needing money to help buy EMC, sold the group to Francisco Partners and Elliott Management in mid-2016; Clearlake Capital then bought Quest from Francisco Partners for US$5.4 billion including debt", url: "https://blocksandfiles.com/2021/11/29/quest-software-gets-flipped-from-one-private-equity-owner-to-another/" },
      { label: "Francisco Partners announcement of the sale of Quest Software, November 2021 - describing the portfolio across One Identity and OneLogin, platform management for Microsoft environments, information management and erwin by Quest including Toad for Oracle, Foglight and SharePlex, and data protection with NetVault and Kace", url: "https://www.franciscopartners.com/media/francisco-partners-announces-sale-of-quest-software" },
    ],
    tags: ["vendor"],
    group: "contemporary",
    founded: 1987,
    name: "Quest Software - sold to buy something else",
    tagline: "Systems and database management vendor founded 1987, bought by Dell, then sold onward twice.",
    intro: "Quest Software was founded in 1987 in California, initially writing high-availability and middleware software for Hewlett-Packard minicomputers, and became widely known for Toad, a tool database administrators use daily. Dell bought it in 2012 for US$2.36 billion; four years later it was sold again, and again in 2021.",
    body: [
    ...
    externalUrl: "https://www.quest.com/",
    externalLabel: "Quest Software",
  },

  {
    slug: "skytap",
    sources: [
      { label: "Skytap (Wikipedia): founded as Illumita in 2006 in Seattle by Brian Bershad, Hank Levy and Steve Gribble, University of Washington professors who had researched virtualisation and cloud computing, with graduate student David Richardson; renamed Skytap in 2008, launching Skytap Virtual Lab in April of that year; early funding from the Washington Research Foundation, later Insight, Madrona, Ignition, Bezos Expeditions and OpenView; acquired by Kyndryl in 2024", url: "https://en.wikipedia.org/wiki/Skytap" },
      { label: "Skytap - about: purpose-built to run IBM Power Systems in the public cloud, partnering with Microsoft Azure and IBM Cloud; used for production, disaster recovery, virtual training labs and development; supports AIX, IBM i and Linux on IBM Power together with x86; acquired by Kyndryl in 2024", url: "https://www.skytap.com/about-us/" },
      { label: "Skytap - virtual IT labs: each environment is a software-defined data centre supporting Linux and Windows on x86, AIX, IBM i and Linux on IBM Power, including complex Layer 2 and Layer 3 network requirements; labs can be built, updated and retired in minutes, with pre-built templates, and the platform supports the LTI standard for integration with learning management systems", url: "https://www.skytap.com/course-manager-cma/" },
    ],
    tags: ["training", "datacentre"],
    group: "contemporary",
    founded: 2006,
    name: "Skytap - the laboratory is the hard part",
    tagline: "Cloud environment platform founded 2006 by university researchers, widely used for virtual training labs.",
    intro: "Skytap was founded in Seattle in 2006 as Illumita, by three University of Washington professors who had researched virtualisation and a graduate student. It provides self-service cloud environments used for development, testing and virtual training laboratories, and was acquired by Kyndryl in 2024.",
    body: [
    ...
    externalUrl: "https://www.skytap.com/",
    externalLabel: "Skytap",
  },
  {
    slug: "readytech",
    sources: [
      { label: "ReadyTech - a virtual training platform for browser-based information technology laboratories, instructor-led training and self-paced learning, with continuous human support and no long-term contracts; it can also turn existing classroom computers into managed virtual training environments; customer statements on the site describe scaling instructor-led class sizes and releasing unused lab environments when students do not attend, and one describes a solution adopted during the pandemic that became a permanent part of their training offering", url: "https://www.readytech.com/", sourceNote: "The company\u2019s own site is the reachable source for this entry. Independent coverage of it is thin, which is itself typical of the training-infrastructure category." },
      { label: "ReadyTech’s own about page records that it launched in 2003", url: "https://www.readytech.com/about-rt-training-delivery" },
    ],
    tags: ["training"],
    group: "contemporary",
    founded: 2003,
    name: "ReadyTech - the class starts whether the lab is ready or not",
    tagline: "Virtual training platform for hands-on laboratories in instructor-led and self-paced delivery.",
    intro: "ReadyTech provides browser-based laboratory environments for technical training, for instructor-led classes and self-paced courses alike, and can also bring existing classroom machines under the same management.",
    body: [
      "Two details in its own material describe the economics of this business better than any description of the technology. Class sizes have to scale from a few students to dozens, and unused environments have to be released when students do not appear - because a laboratory is provisioned before anyone knows who is actually coming, and somebody pays for the ones nobody uses.",
      "The other is the support commitment. A laboratory failure during a live class is not a ticket; it is an hour of a room full of people, and there is no version of it that gets rescheduled quietly. That is why platforms in this category advertise the response time of their humans rather than the specification of their machines.",
      "Its customers describe adopting it during the pandemic as a temporary measure and keeping it afterwards, which is the honest history of virtual delivery in this industry: it was a substitute that turned out to be a format.",
    ],
    externalUrl: "https://www.readytech.com/",
    externalLabel: "ReadyTech",
  },

  {
    slug: "agility",
    sources: [
      { label: "Agility - company site: describes itself as an integrator of high strategic value information technology services and solutions, centred on the customer, and as specialists in InfraSec; four solution areas are AI First, infrastructure, cybersecurity and cloud; the infrastructure practice names DHCP, load balancing, application stack and DNS; managed and professional services include managed SASE, managed detection and response, deployment projects, sustaining support and a 24/7 network operations centre; premium partnerships include F5 Networks, Palo Alto Networks, Amazon Web Services, Infoblox, CyberArk, Qualys, Gigamon, ExtraHop, Firemon, Riverbed, Veracode, Rainforest, Inetco, Thales and Veeam; based in Sao Paulo on Avenida Doutora Ruth Cardoso; it publishes semi-annual salary transparency reports and a blog with several articles on DNS security", url: "https://somosagility.com.br/" },
      { label: "Agility states on its own about page that it has been in the market since 1991", url: "https://somosagility.com.br/sobre-nos/" },
    ],
    tags: ["services", "reseller"],
    relationships: ["worked-with-directly"],
    group: "contemporary",
    founded: 1991,
    name: "Agility - the infrastructure half of security",
    tagline: "Sao Paulo integrator specialising in infrastructure and cybersecurity for critical environments.",
    intro: "Agility is a Sao Paulo integrator that describes its speciality as InfraSec: infrastructure and cybersecurity treated as one practice rather than two, for mission-critical and high-complexity environments across on-premises, cloud, multi-cloud and hybrid.",
    body: [
      "Its infrastructure practice names four things: DHCP, load balancing, application stack and DNS. That list is worth reading slowly, because it is exactly the set of services that nobody notices until one of them stops and everything appears to break at once. An integrator that leads with DNS rather than with a firewall brand is describing a different kind of work.",
      "The partner list says the rest. F5 and Infoblox for the delivery and naming layers, Palo Alto and CyberArk on the security side, Gigamon and ExtraHop for visibility, and a managed practice built on top - managed detection and response, managed secure access, and a continuously staffed operations centre. The pattern this timeline records repeatedly is that Brazilian integrators sell the operating of the thing more than the thing.",
      "It also publishes, which is unusual enough to note. Its blog carries several pieces on DNS threats and DNS in industrial and connected-device environments - the same subject the Learn articles on this site cover, written from the operator\u2019s side of the same market.",
    ],
    externalUrl: "https://somosagility.com.br/",
    externalLabel: "Agility",
  },
...

  {
    slug: "cyble",
    sources: [
      { label: "Cyble - company site: a threat intelligence company whose platform spans cyber threat intelligence, attack surface management, dark web monitoring, brand intelligence and protection, vulnerability intelligence, takedown and disruption, third-party risk management, executive monitoring, cloud security posture management, endpoint security and digital forensics and incident response; products include Cyble Vision, Cyble Hawk for federal bodies, Cyble Titan for endpoints, Cyble Strato for cloud and the Blaze agentic assistant; it publishes research through Cyble Research and Intelligence Labs and operates the news title The Cyber Express, and offers free public tools including AmIBreached, Odin and a malware analyzer; certifications listed are ISO/IEC 27001 and SOC 2 Type I and II; it names Y Combinator among its backers, states offices across the United States, Europe and the United Kingdom, the Middle East and Africa, ASEAN, India and Oceania, and reports first inclusion as a Challenger in the 2026 Gartner Magic Quadrant for Cyberthreat Intelligence Technologies published March 2026", url: "https://cyble.com/" },
      { label: "Y Combinator company page - Cyble was founded in 2019 by Beenu Arora and Manish Chachada", url: "https://www.ycombinator.com/companies/cyble" },
    ],
    tags: ["vendor"],
    group: "contemporary",
    founded: 2019,
    name: "Cyble - selling what it also gives away",
    tagline: "Threat intelligence company covering dark web monitoring, attack surface management and takedowns.",
    intro: "Cyble is a threat intelligence company whose platform covers cyber threat intelligence, dark web monitoring, attack surface management, brand protection and takedown services, with a research laboratory publishing regional threat landscape reports.",
    body: [
      "It illustrates something structural about this category rather than anything unique to itself. Threat intelligence cannot be demonstrated the way a firewall can: the product is a claim about what the vendor knows, and a prospective buyer has no way to test that claim from outside. So the companies in it publish - research reports, threat actor profiles, and in this case a news title of its own - and give away lookup tools that answer a single question against the same data the paid product runs on.",
      "That arrangement is worth understanding before reading any vendor\u2019s threat research, including the good ones. The publication is genuine work and it is also the demonstration, and both things are true at once.",
      "The service list is also a map of where security work has moved. Alongside the expected intelligence feeds sit brand protection, executive monitoring, and takedown and disruption - having fraudulent domains and impersonating accounts removed. That is closer to enforcement than to engineering, and it is now sold beside the technical products on the same platform.",
    ],
    externalUrl: "https://cyble.com/",
    externalLabel: "Cyble",
  },

  {
    ...
    sources: [
      ...
      { label: "Jusbrasil, reporting the federal prosecution service - the six convicted received 5 years and 2 months in closed regime for contrabando or descaminho and criminal association, and were acquitted of the charge of using false documents; a former Cisco executive, one of Mude\u2019s partners, the company\u2019s lawyer and three employees were acquitted of all charges; the prosecution appealed seeking conviction of those acquitted", url: "https://pr-sp.jusbrasil.com.br/noticias/2636040/operacao-persona-mpf-recorre-e-pede-a-condenacao-de-seis-executivos-da-mude" },
    ],
    tags: ["distributor"],
    group: "other",
    ended: {
      year: 2007,
      note: "Operacao Persona was launched on 16 October 2007. The company does not trade; this timeline records it because of the case rather than in spite of it.",
    },
    name: "Mude - the distributor at the centre of Operacao Persona",
    tagline: "Brazilian Cisco importer investigated from 2007 in a federal foreign-trade fraud case.",
    intro: "Mude Comercio e Servicos Ltda was the Brazilian importer of Cisco equipment at the centre of Operacao Persona, a joint action by the federal prosecution service, federal police and tax authority launched on 16 October 2007. This entry reports what the cited sources report and does not reach beyond them.",
    body: [
...

  {
    slug: "q13",
    sources: [
      { label: "RTI / Aranda, 2023 - Quantum13 Solucoes em Tecnologia, an integrator specialising in cloud, security, networks, collaboration and professional services, updated its name to Q13; founded in 2018, half its revenue comes from government and half from enterprise accounts including Volkswagen, Alerj, Furnas, Proderj, the Rio de Janeiro city council, Funarte, BNDES and Taesa; its offerings cover private, hybrid and public cloud with migration and sustaining services, data security, collaboration including private and cloud videoconferencing and voice over IP, and professional services spanning installation, maintenance, consultancy, network and security operations centres, cabling and infrastructure", url: "https://www.arandanet.com.br/revista/rti/noticia/6364-Integradora-Quantum13-se-transforma-em-Q13.html" },
      { label: "Serasa Experian company register - Quantum13 Solucoes em Tecnologia Ltda, trading as Q13 Tecnologia, CNPJ 30.161.238/0001-60, headquartered in Sao Paulo, founded 10 April 2018, registration active, principal activity wholesale of computing equipment", url: "https://empresas.serasaexperian.com.br/consulta-gratis/QUANTUM13-SOLUCOES-EM-TECNOLOGIA-LTDA-30161238000160" },
    ],
    tags: ["services", "reseller"],
    group: "contemporary",
    founded: 2018,
    name: "Q13 - half the revenue is public money",
    tagline: "Brazilian integrator founded 2018, working across cloud, security, networks and collaboration.",
    intro: "Q13, formerly Quantum13 Solucoes em Tecnologia, is a Sao Paulo integrator founded in April 2018, covering cloud, data security, networks, collaboration and professional services including network and security operations centres.",
    body: [
      "The detail that makes it worth an entry is the revenue split: about half from government and half from enterprise. The named public clients are concentrated around Rio de Janeiro - a state legislative assembly, the state data-processing company, a municipal council, a national development bank, an electricity generator - and that mix describes a real career path in this industry that almost nothing written in English acknowledges.",
      "Public-sector work is a distinct discipline rather than the same work with different paperwork. It runs on published tenders, price registers and defined scopes, so the winning argument is technical specification and demonstrable compliance rather than a relationship. Engineers who spend their careers in it become unusually precise about what a requirement actually says.",
      "It is also a recent company, founded in 2018 on this timeline of firms dating to the 1960s and 1970s. The integrator model that Grupo IHC and its contemporaries invented is still being started fresh, which is the more interesting fact about it.",
    ],
    externalUrl: "https://q13.tech/",
    externalLabel: "Q13",
  },

  {
    slug: "qd7",
    sources: [
      { label: "QD7 - company site: a cybersecurity company presenting itself under the heading of security in the post-quantum era, offering a complete authentication platform; customer statements on the site describe adapting to the Lei Geral de Protecao de Dados by implementing a cybersecurity structure to protect customer information, and dealing with the challenges of remote working and uncontrolled devices on the network", url: "https://qd7.com.br/" },
      { label: "QD7 blog - describes itself as a cybersecurity company in Sao Paulo offering consultancy, protection services against cyberattacks and security awareness training, together with continuous monitoring of corporate systems and networks using intrusion detection and network security, and incident response covering identification, containment and mitigation; its consultancy combines cybersecurity expertise with an understanding of the Brazilian regulatory landscape", url: "https://blog.qd7.com.br/empresas-de-ciberseguranca-no-brasil/" },
      { label: "Brazilian federal tax registry via the public CNPJ service - NGX NETWORKS SERVICES LTDA, CNPJ 43.024.467/0001-84, Sao Jose do Rio Preto, activity beginning 6 August 2021", url: "https://brasilapi.com.br/api/cnpj/v1/43024467000184", sourceNote: "QD7 is the trading name; the registered company is NGX Networks Services. It is registered in Sao Jose do Rio Preto, the same interior city as WZTech." },
    ],
    tags: ["services", "training"],
    group: "contemporary",
    founded: 2021,
    name: "QD7 - the regulation is the way in",
    tagline: "Sao Paulo cybersecurity consultancy combining monitoring, incident response and awareness training with LGPD work.",
    intro: "QD7 is a Sao Paulo cybersecurity company offering consultancy, continuous monitoring, incident response and security awareness training, and it positions its practice around the Brazilian regulatory landscape as much as around the technology.",
    body: [
      "Its own customer statements point at something this timeline has not otherwise recorded: the data protection law is how security work reaches many Brazilian organisations. The conversation starts as compliance and becomes an inventory, a monitoring arrangement and an incident response plan. That is a less satisfying origin than a breach and a considerably better one, because the work happens before rather than after.",
      "Awareness training sits in the same service list as monitoring and incident response, which is the honest placement. Most incidents begin with a person doing something reasonable at the wrong moment, and no amount of detection changes that; training is a control alongside the technical ones rather than a courtesy offered after they are sold.",
      "Its public positioning also names post-quantum cryptography, which is early for a consultancy of this size and worth noting for what it says about the market rather than the company: the migration is being discussed with ordinary enterprises in Brazil, not only in standards bodies.",
    ],
    externalUrl: "https://qd7.com.br/",
    externalLabel: "QD7",
  },

  {
    slug: "penso",
    sources: [
      { label: "TI Inside, March 2026 - the company\u2019s history goes back to the 1990s, when its founders took part in the creation of the provider STI Internet, one of the first in Brazil after the service was released for commercial use; it serves around 1,600 clients, focused on organisations with annual revenue between R$100 million and R$500 million, with an average client relationship of about eight years; it operates across five Tier III data centres in different regions and from different suppliers, and its disaster recovery offering is built on Veeam", url: "https://tiinside.com.br/30/03/2026/penso-tecnologia-aposta-em-resiliencia-de-dados-para-impulsionar-crescimento-no-mercado-corporativo/" },
      { label: "Penso Tecnologia - the company\u2019s own tenth-anniversary post: Penso was founded in 2003 as an information technology services provider, beginning with support for small companies and differentiating itself by going deep into each client\u2019s activity, becoming specialists not only in technology but in each client\u2019s kind of business; it later repositioned as a cloud computing specialist", url: "https://www.penso.com.br/penso-tecnologia-10-anos-historia/" },
      { label: "Company profile - Penso acquired Inova Tecnologias, one of the largest global Zimbra partners, its second acquisition in eighteen months, consolidating its position in corporate email and collaboration with more than one million corporate mailboxes under management; internal practice includes a monthly technical and behavioural training programme", url: "https://www.infojobs.com.br/penso-tecnologia" },
    ],
    tags: ["services"],
    group: "contemporary",
    founded: 2003,
    name: "Penso - a million mailboxes and an early provider behind it",
    tagline: "Brazilian IT services company founded 2003, whose founders helped create one of the country\u2019s first internet providers.",
    intro: "Penso Tecnologia is a Sao Paulo services company founded in 2003, now working in cloud, corporate email and collaboration, backup and disaster recovery. Its founders had earlier taken part in creating STI Internet, one of the first Brazilian providers after the service was opened to commercial use.",
    body: [
      "That earlier involvement is the part that places it on this timeline. The people who built the first commercial internet access in Brazil did not stop working when that phase ended; they started the next companies, and the connection between the mid-1990s arrival of the commercial internet and the services market that followed runs through individuals rather than through institutions.",
      "The business it grew into is unusual in one respect worth recording. It manages more than a million corporate mailboxes, built substantially on Zimbra and consolidated through acquisitions - a national email and collaboration practice at a moment when almost every organisation of that size had moved to one of two American suites instead. Somebody has to run the alternative, and there is more of it than the market narrative suggests.",
      "Two numbers from its own account describe the services model better than any description of it: around sixteen hundred clients, and an average client relationship of about eight years. In a market where the technology is replaced every few years, the relationship outlasts almost everything installed under it.",
    ],
    externalUrl: "https://www.penso.com.br/",
    externalLabel: "Penso Tecnologia",
  },

  {
    slug: "netbr",
    sources: [
      { label: "Netbr - company page: founded in 2003, delivering critical infrastructure, security and IT automation projects for large companies, and recognised for services and integration of identity management solutions in critical environments with security, governance and automation", url: "https://www.netbr.com.br/empresa/" },
      { label: "Netbr - partnerships page: on becoming a Ping Identity delivery partner, the Brazilian company became the first identity and access management consultancy and integrator in Latin America to operate with Ping\u2019s guaranteed backing in the region; before that nomination it was already delivering identity projects on Ping technology for segments including open banking and open insurance, and had built projects across around fifteen industry sectors covering workforce and third-party onboarding and customer access administration in retail, telecommunications, utilities, education, government and health", url: "https://www.netbr.com.br/parcerias/" },
      { label: "Forbes Brasil, September 2025 - SEK agreed to acquire Netbr, which develops identity and digital security solutions; Netbr adds more than 100 specialists and a client portfolio including the ten largest Brazilian banks, large telecommunications companies and corporations in strategic sectors; SEK projected revenue above R$300 million in Brazil in 2025", url: "https://forbes.com.br/forbes-money/2025/09/empresa-de-ciberseguranca-sek-investida-do-patria-compra-netbr/" },
      { label: "Netbr careers page: in 2025 SEK, the Latin American cybersecurity company backed by Patria, acquired 55% of Netbr, positioning it as the group\u2019s identity management speciality", url: "https://netbr.gupy.io/", sourceNote: "Reports of the 2025 transaction differ: press coverage describes an acquisition of the company, while Netbr\u2019s own careers page states 55%. Both are recorded and neither is asserted as the complete picture." },
    ],
    tags: ["services"],
    group: "contemporary",
    founded: 2003,
    name: "Netbr - identity, before anybody called it that",
    tagline: "Brazilian identity and access management specialist founded 2003, acquired by SEK in 2025.",
    intro: "Netbr was founded in 2003 in Sao Paulo delivering critical infrastructure, security and automation projects, and became the Brazilian specialist in identity and access management - governance, privileged access and customer identity - for banks, telecommunications operators and large retailers. SEK acquired it in 2025.",
    body: [
      "Its client list is the argument for the entry: the ten largest Brazilian banks. Identity work at that scale is not a product installation. It is deciding who may do what across systems accumulated over decades, in an institution where the answer has regulatory consequences, and then automating the joining, moving and leaving of tens of thousands of people without breaking any of it.",
      "It also became the first identity consultancy and integrator in Latin America to hold Ping Identity delivery-partner status, having already delivered Ping projects for open banking and open insurance. That places it directly alongside the vendor authorisations this site itself carries, and it is a reminder that a manufacturer entering a market depends on somebody local having already learned the product properly.",
      "Its ending is the pattern this timeline has recorded repeatedly in the last three years. A specialist built over twenty years is absorbed into a group assembled by an investment fund - here SEK, itself created from a Chilean and a Brazilian company - and the brand becomes a speciality inside somebody else\u2019s ecosystem. The knowledge stays in the country; the ownership does not stay in the company.",
    ],
    externalUrl: "https://www.netbr.com.br/",
    externalLabel: "Netbr",
  },

  {
    slug: "seal",
    sources: [
      { label: "Seal Sistemas - company site: solutions in mobility, automation and enterprise visibility, organised around modern environments and organisational transformation", url: "https://www.seal.com.br/" },
      { label: "Brazilian federal tax registry via the public CNPJ service - SEAL SISTEMAS E TECNOLOGIA DE INFORMACAO LTDA, CNPJ 04.709.662/0001-96, Sao Paulo, activity beginning 4 October 2001, principal activity development and licensing of non-customisable computer programs", url: "https://brasilapi.com.br/api/cnpj/v1/04709662000196" },
    ],
    tags: ["services", "reseller"],
    group: "contemporary",
    founded: 2001,
    name: "Seal Sistemas - the barcode is an interface",
    tagline: "Brazilian integrator in mobility, automation and enterprise visibility, founded 2001.",
    intro: "Seal Sistemas is a Sao Paulo company working in mobility, automation and what it calls enterprise visibility: the equipment and software that let an organisation know where its things are.",
    body: [
      "This is a corner of the industry that networking rarely looks at directly and depends on constantly. Handheld terminals, barcode and radio-frequency identification, industrial printing and the wireless coverage they all assume are the layer where a warehouse or a shop floor becomes legible to the systems above it.",
      "The visibility framing is the accurate one. A barcode is not a label, it is an interface: the point at which a physical object is allowed to make an assertion about itself to software. Everything downstream, from stock accuracy to a delivery notification, rests on that assertion having been captured correctly on a device somebody carried.",
      "It also explains why this work sits beside networking rather than inside logistics. The coverage has to be continuous where people walk, the devices have to authenticate, and the failure mode is not a dropped page but a pallet that the system believes is somewhere it is not.",
    ],
    externalUrl: "https://www.seal.com.br/",
    externalLabel: "Seal Sistemas",
  },

  {
    slug: "sage-networks",
    sources: [
      { label: "Sage Networks - company site: founded in 2018 and headquartered in Campinas, working in network engineering with on-premises anti-DDoS, network consultancy, automatic detection, cloud mitigation and a security operations centre; the site gives its CNPJ as 29.767.200/0001-56", url: "https://sagenetworks.com.br/" },
      { label: "Brazilian federal tax registry via the public CNPJ service - SAGE NETWORKS SERVICOS DE TELECOMUNICACOES LTDA, CNPJ 29.767.200/0001-56, activity beginning 23 February 2018, registered under other telecommunications activities", url: "https://brasilapi.com.br/api/cnpj/v1/29767200000156", sourceNote: "The site says Campinas and the registry records Sumare, an adjacent municipality in the same metropolitan region. Both are reported rather than one being chosen." },
    ],
    tags: ["services"],
    group: "contemporary",
    founded: 2018,
    name: "Sage Networks - mitigation is a network problem",
    tagline: "Brazilian network engineering firm founded 2018, specialising in denial-of-service defence.",
    intro: "Sage Networks is a network engineering company founded in 2018 in the Campinas region, working on distributed denial-of-service defence: on-premises appliances, automatic detection, cloud mitigation and a continuously staffed operations centre.",
    body: [
      "Choosing denial-of-service as the speciality says something about where the difficulty actually is. Mitigation is not a product decision, it is a routing decision: the question is where the traffic is absorbed and how quickly the path can be changed, which makes it a network engineering problem wearing a security label.",
      "The combination it sells reflects that. On-premises equipment handles what fits on the link; cloud mitigation handles what does not, because no amount of local capacity survives an attack larger than the circuit. Deciding which is which, in the seconds available, is what the operations centre is for.",
      "It is also a young company in a market whose incumbents are large and long-established. Denial-of-service defence rewards that: the decisions are operational and made in seconds, and a small team that owns its own mitigation path can answer faster than a process that has to cross three departments.",
    ],
    externalUrl: "https://sagenetworks.com.br/",
    externalLabel: "Sage Networks",
  },
...

  {
    slug: "tecnocomp",
    sources: [
      { label: "Brazilian federal tax registry via the public CNPJ service - TECNOCOMP TECNOLOGIA E SERVICOS LTDA, CNPJ 54.892.252/0001-00, Sao Bernardo do Campo, Sao Paulo, activity beginning 4 September 1985", url: "https://brasilapi.com.br/api/cnpj/v1/54892252000100", sourceNote: "The 0001 suffix is the head office; a Rio de Janeiro establishment carries a 2013 registration. A company database publishes generated prose claiming the company was founded in 1983 while displaying this 1985 registration on the same page, so that claim is not adopted here. A business older than its own registration is a real pattern on this timeline - Teltec predates its CNPJ by eleven years - so 1983 would be worth adopting if an independent source appears." },
      { label: "Tecnocomp - company description: more than forty years in information and communications technology services, a wholly Brazilian company working with large enterprises and government; the portfolio is organised into digital transformation, managed services, IT infrastructure and data centre technology, with headquarters in Sao Paulo, a Rio de Janeiro branch and technical attendance across more than 200 cities, certified to ISO 20000", url: "https://www.tecnocomp.com.br/" },
    ],
    tags: ["services"],
    group: "contemporary",
    founded: 1985,
    name: "Tecnocomp - the network that reaches 200 cities",
    tagline: "Brazilian IT services company founded 1985, working in managed services, infrastructure and data centres.",
    intro: "Tecnocomp is a Brazilian information and communications technology services company, registered in 1985 in Sao Bernardo do Campo, working across managed services, IT infrastructure and data centres for large enterprises and government.",
    body: [
      "The detail that separates this kind of company from a consultancy is the field attendance across more than two hundred cities. That is not a sales territory, it is an obligation: somebody has to be able to reach a failed device in a place with no local office, within whatever the contract says, and the cost of that promise is a permanent network of technicians and spares rather than a project team.",
      "It is the unglamorous half of the industry and the half that decides whether the rest works. Service desk, field services, asset management and network monitoring are the functions that keep equipment running long after the installation project closed, and in a country of continental scale the logistics of doing so are a genuine engineering problem in their own right.",
      "Government work sits alongside the enterprise side, which brings the same discipline this timeline records elsewhere: published tenders, defined scopes, and the requirement to demonstrate compliance rather than argue a relationship.",
    ],
    externalUrl: "https://www.tecnocomp.com.br/",
    externalLabel: "Tecnocomp",
  },
];
