...
imageEnd:
    ...
    alt: "Grafico de logotipos ligados por setas, mostrando aquisicoes convergindo para a Extreme Networks: SynOptics para Bay Networks para Nortel para Avaya; Lucent para Avaya; Foundry para Brocade; Digital para Cabletron Systems para Enterasys; Symbol para Motorola para Zebra; e Aerohive - todas chegando a Extreme."
    caption: "Para onde as pecas foram. A Cabletron vira Enterasys vira Extreme, no mesmo quadro que Nortel, Foundry, Symbol e as demais - uma industria de rivais desabando num logotipo so."
    credit: "Diagrama de Stamau, Wikimedia Commons, CC BY-SA 4.0. Reproduzido sem modificacao. As marcas pertencem aos seus donos."
---
