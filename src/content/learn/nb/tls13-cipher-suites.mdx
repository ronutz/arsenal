...
For å se alt dette på en ekte forbindelse annoterer [The Illustrated TLS 1.3 Connection](https://tls13.xargs.org/) hver byte av et ekte TLS 1.3-handshake, record for record og felt for felt.
