...
For at se alt dette på en rigtig forbindelse annoterer [The Illustrated TLS 1.3 Connection](https://tls13.xargs.org/) hver byte af et rigtigt TLS 1.3-handshake, record for record og felt for felt.
