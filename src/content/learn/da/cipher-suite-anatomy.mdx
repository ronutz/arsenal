...
For at se hvor hver del af en suite faktisk lander på ledningen, annoterer [The Illustrated TLS 1.2 Connection](https://tls12.xargs.org/) og [The Illustrated TLS 1.3 Connection](https://tls13.xargs.org/) rigtige handshakes byte for byte – én for de lange bundtede navne, én for de korte moderne.
