...
Om te zien waar elk deel van een suite werkelijk op de draad belandt, annoteren [The Illustrated TLS 1.2 Connection](https://tls12.xargs.org/) en [The Illustrated TLS 1.3 Connection](https://tls13.xargs.org/) echte handshakes byte voor byte – één voor de lange gebundelde namen, één voor de korte moderne.
