...
Om dit alles op een echte verbinding te zien, annoteert [The Illustrated TLS 1.3 Connection](https://tls13.xargs.org/) elke byte van een echte TLS 1.3-handshake, record voor record en veld voor veld.
