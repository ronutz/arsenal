...
Bir paketin her parçasının telde gerçekte nereye düştüğünü görmek için [The Illustrated TLS 1.2 Connection](https://tls12.xargs.org/) ve [The Illustrated TLS 1.3 Connection](https://tls13.xargs.org/) gerçek el sıkışmalarını bayt bayt açıklar — biri uzun paketlenmiş adlar, biri kısa modern adlar için.
