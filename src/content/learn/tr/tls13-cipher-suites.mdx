...
Tüm bunları gerçek bir bağlantıda görmek için [The Illustrated TLS 1.3 Connection](https://tls13.xargs.org/) gerçek bir TLS 1.3 el sıkışmasının her baytını kayıt kayıt ve alan alan açıklar.
