...
För att se var varje del av en svit faktiskt hamnar på tråden annoterar [The Illustrated TLS 1.2 Connection](https://tls12.xargs.org/) och [The Illustrated TLS 1.3 Connection](https://tls13.xargs.org/) riktiga handskakningar byte för byte – en för de långa buntade namnen, en för de korta moderna.
