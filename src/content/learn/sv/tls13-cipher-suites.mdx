...
För att se allt detta på en riktig anslutning annoterar [The Illustrated TLS 1.3 Connection](https://tls13.xargs.org/) varje byte av en riktig TLS 1.3-handskakning, record för record och fält för fält.
