...
concepts: ["extreme", "exos", "voss", "fabric engine", "spbm", "fabric attach", "is-is", "cli", "universal hardware"]
...
The full sequence in which a fabric service comes into existence, of which this choice is the first step, is in **[one service, edge to edge](/learn/extreme-fabric-connect-one-service-edge-to-edge)**.
