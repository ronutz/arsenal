...
Producing an HMAC (hash-based message authentication code) correctly is well understood. The mistakes cluster on the *verifying* side, where two issues catch people who got the cryptography right but the surrounding logic wrong: how you compare the tags, and what a valid tag actually proves.
