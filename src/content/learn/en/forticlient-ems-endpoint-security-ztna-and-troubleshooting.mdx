...
ZTNA replaces "you are on the network, therefore you may reach the application" with "this session, from this device, for this user, may reach this application".
