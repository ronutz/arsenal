...
Higher detail is more useful for diagnosing how BIG-IP handled a flow, at the cost of a larger trailer on every packet. For most LTM troubleshooting, `:nnn` is the level to reach for.
