...
The control that decides which segment a device is placed in when it connects has its own lineage, in **[the network access control lineage](/learn/nac-family-history)** - the idea that was right too early, twice.
