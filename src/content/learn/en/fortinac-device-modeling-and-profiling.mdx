...
FortiNAC needs to know about the **network devices** — switches, wireless controllers, firewalls — because those are what it reads endpoint information from and what it instructs to move a port into a different VLAN (virtual local area network).
