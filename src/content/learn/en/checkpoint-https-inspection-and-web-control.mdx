...
concepts: ["check point", "ccsa", "https inspection", "outbound inspection", "inbound inspection", "certificate", "application control", "url filtering", "appwiki", "bypass", "categories"]
relatedTools: []
sub: checkpoint
