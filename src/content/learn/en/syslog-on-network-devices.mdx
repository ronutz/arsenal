...
concepts: ["syslog", "fortigate", "cisco", "facility", "network devices"]
...
- **F5 BIG-IP** logs its BIG-IP LTM - Local Traffic Manager traffic to `local0` (facility 16) by default.
