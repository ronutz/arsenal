...
concepts: ["checkpoint", "check point", "ccsa", "smartconsole", "administrator", "permission profile", "session", "publish", "install policy", "objects", "network object", "service object"]
relatedTools: []
sub: checkpoint
