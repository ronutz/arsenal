...
A **VPN (virtual private network)** moves your trust: your ISP no longer sees your traffic, and the VPN operator does. That is a real improvement in some threat models and no improvement at all in others, because you have swapped one observer for another and the new one is a single company with logs and a jurisdiction.
