...
The most common and most secure way to obtain an ID token is the authorization code flow. It keeps tokens off the browser URL and delivers them through a direct back-channel call, and with PKCE (Proof Key for Code Exchange) it is safe even for public clients like single-page and mobile apps.
