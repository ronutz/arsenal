...
relatedTools: ["x509"]
sub: fortigate
relatedArticles: ["ssl-forward-proxy-interception", "http-proxy-forward-and-reverse", "certificate-validation", "hsts-and-https", "fortiappsec-advanced-protection-and-availability", "fortiddos-policies-proxies-and-operations", "fortisase-operations-onboarding-and-reporting", "fortinet-ot-security"]
category: security
order: 42
status: reviewed
updated: "2026-07-06"
