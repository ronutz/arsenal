...
The sorting rules, the score-assignment model and the worked behaviors in this article come from the BIG-IP GTM Load Balancing manual's Topology chapter and F5's K10721, as linked from the tool's source list; the ladder is implemented exactly as far as those sources verify it, and the tool flags rather than guesses anything outside it.
