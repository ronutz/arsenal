...
**API access** to detections and events, so a SIEM can ingest them and correlate with endpoint and identity telemetry. This is what puts network findings alongside the rest of the picture.
