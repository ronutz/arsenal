...
A cloud security platform generates its logs *in the cloud* - which immediately poses the operator's question: how do they get to *my* SIEM (security information and event management)? Zscaler's answer has one storage layer and three delivery paths, and knowing which path fits which log family is the whole design. Grounded in Zscaler's NSS and deployment documentation, verified 2026-07-21.
