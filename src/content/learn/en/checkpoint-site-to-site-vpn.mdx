...
concepts: ["checkpoint", "check point", "ccse", "site-to-site vpn", "vpn community", "meshed", "star", "encryption domain", "ike", "phase 1", "phase 2", "link selection", "isp redundancy", "permanent tunnel"]
relatedTools: []
sub: checkpoint
