...
**FortiClient** runs on the endpoint. Depending on licensing and profile it provides the VPN client, endpoint protection, web filtering, application firewall, vulnerability scanning and ZTNA agent.
