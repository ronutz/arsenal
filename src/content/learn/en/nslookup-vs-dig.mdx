...
Both tools print the same answer; how to read that answer from the first line to the last is laid out in **[reading a DNS answer](/learn/reading-a-dns-answer)**.
