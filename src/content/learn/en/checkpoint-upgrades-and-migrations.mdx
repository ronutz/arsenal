...
concepts: ["checkpoint", "check point", "ccse", "upgrade", "in-place upgrade", "cpuse", "central deployment tool", "hotfix", "migration", "migrate export", "snapshot", "backup", "compatibility"]
relatedTools: []
sub: checkpoint
