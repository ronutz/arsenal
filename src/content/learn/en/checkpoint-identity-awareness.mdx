...
concepts: ["checkpoint", "check point", "ccsa", "identity awareness", "access role", "identity collector", "ad query", "browser-based authentication", "captive portal", "identity agent", "identity sharing"]
relatedTools: []
sub: checkpoint
