...
**IPS** inspects traffic for exploitation of known vulnerabilities. It is the engine that stops an attack against a service you have not patched, which is most of the reason it exists.
