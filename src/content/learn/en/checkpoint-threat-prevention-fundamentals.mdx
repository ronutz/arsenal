...
concepts: ["check point", "ccsa", "threat prevention", "ips", "anti-bot", "anti-virus", "threat emulation", "threat extraction", "profile", "prevent", "detect", "autonomous threat prevention"]
relatedTools: []
sub: checkpoint
