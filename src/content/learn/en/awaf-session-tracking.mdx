...
A WAF policy blocks individual bad requests. Session tracking answers a different question: which client is behind the bad requests, and what should we do about that client? It is how Advanced WAF moves from stopping a request to stopping an actor.
