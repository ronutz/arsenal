...
That makes **exceptions** part of running a WAF (web application firewall) rather than a sign of failure. The discipline is to scope them narrowly — this signature, on this URL, on this parameter — because a signature disabled globally to fix one page removes protection everywhere.
