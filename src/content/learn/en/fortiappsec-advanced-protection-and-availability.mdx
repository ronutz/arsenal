...
A WAF inspects requests arriving at your application. Three categories of risk sit outside that, and a cloud service is positioned to address them in a way an appliance in your rack is not.
...
**GSLB** decides which region answers, and it does so through DNS: a resolver asks where the hostname lives, and the answer depends on where the client is and which regions are healthy.
