...
| LDAP (Lightweight Directory Access Protocol) | Bind against a directory | Existing Active Directory or other LDAP |
| RADIUS (Remote Authentication Dial-In User Service) | RADIUS exchange, often with MFA (multi-factor authentication) behind it | Where a central AAA already exists |
