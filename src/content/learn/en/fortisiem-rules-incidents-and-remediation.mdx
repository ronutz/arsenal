...
The point of a SIEM rule is to express something a search cannot: a relationship between events over time. Understanding how that is constructed is most of what makes rule writing tractable.
...
The CMDB earns its keep here. Notification scoped by asset criticality and business unit is precise; notification scoped by severity alone treats a lab machine and a domain controller identically.
