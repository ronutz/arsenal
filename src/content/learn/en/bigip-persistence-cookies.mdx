...
The key point is that the encoding is not encryption. It is a reversible transformation documented publicly by F5 in article [K6917](https://my.f5.com/manage/s/article/K6917). Anyone who can read the cookie, which is anyone who receives the HTTP response, can reverse it.
