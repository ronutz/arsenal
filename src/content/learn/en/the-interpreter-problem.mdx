...
The tooling built to find this class before it ships - static analysis of the code, dynamic testing of the running system - has its own history in the **[SAST and DAST lineage](/learn/sast-dast-family-history)**, including why neither reliably catches the join.
...
The formats where two implementations can disagree about the same bytes are collected in **[the formats in between](/learn/the-formats-in-between)**.
