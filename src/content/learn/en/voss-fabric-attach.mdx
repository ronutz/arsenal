...
summary: "How Fabric Attach lets an edge device signal the service it needs so the fabric provisions the I-SID automatically, the FA Server / Proxy / Client roles, how it rides LLDP, and how an EXOS switch attaches to a VOSS fabric without running SPBM itself."
