...
There is a specific kind of Check Point silence worth recognising on sight. The NAT rule is there. The policy installed without complaint. The server behind it is healthy and answers locally. And the firewall logs show nothing at all — not a drop, not a reject, nothing.
