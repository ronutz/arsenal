...
Most published CVSS (Common Vulnerability Scoring System) scores are Base only, because the base is constant. But the framework was designed to be refined, and the two optional groups are where a score becomes specific to a moment in time and to a particular environment.
...
- [CVSS v3.1 Specification Document - Temporal and Environmental metric groups](https://www.first.org/cvss/v3.1/specification-document)
