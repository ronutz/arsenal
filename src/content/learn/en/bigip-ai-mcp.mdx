...
Alongside the protocol work, 21.0 added S3 data-storage integrations aimed at AI workloads, the data-plane side of RAG (retrieval-augmented generation) pipelines, embeddings, fine-tuning, batch inference, and model-artifact distribution, so the same box that fronts the MCP endpoints can also sit in the storage path with controlled egress.
...
- [New Features in BIG-IP 21.0.0 - F5 Technical Documentation](https://techdocs.f5.com/en-us/bigip-21-0-0/big-ip-release-notes/big-ip-new-features/)
- [New Features in BIG-IP 21.1.0 - MCP Protocol Protection and MCP session persistence](https://techdocs.f5.com/en-us/bigip-21-1-0/big-ip-release-notes/big-ip-new-features.html)
- [Model Context Protocol on BIG-IP - profiles reference](https://techdocs.f5.com/en-us/bigip-21-0-0/big-ip-local-traffic-management-profiles-reference/model-context-protocol.html)
- [What's new in BIG-IP v21.1 - DevCentral (the aimcp persistence profile)](https://community.f5.com/kb/technicalarticles/whats-new-in-big-ip-v21-1/346637)
