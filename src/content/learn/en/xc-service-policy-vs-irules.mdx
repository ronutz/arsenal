...
Engineers who know BIG-IP often reach for iRules to express request-time logic, and then look for the same thing in F5 Distributed Cloud and do not find it. XC service policies solve a large part of what iRules are used for, but the model is different enough that a direct translation helps.
