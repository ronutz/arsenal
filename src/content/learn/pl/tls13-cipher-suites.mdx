...
Aby zobaczyć to wszystko na prawdziwym połączeniu, [The Illustrated TLS 1.3 Connection](https://tls13.xargs.org/) opisuje każdy bajt prawdziwego handshake'u TLS 1.3, rekord po rekordzie i pole po polu.
