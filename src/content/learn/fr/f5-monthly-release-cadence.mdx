...
Pour la politique sous-jacente, la politique de divulgation des vulnérabilités de F5 est publiée sous forme de l'article de base de connaissances [K4602](https://my.f5.com/manage/s/article/K4602), et le détail de chaque version renforcée est publié au fur et à mesure qu'il devient disponible. Le changement d'état d'esprit essentiel est celui vers lequel F5 revient sans cesse : la découverte s'accélérant des deux côtés, appliquer rapidement la dernière version n'est plus une bonne pratique réservée aux prudents, c'est la base pour rester protégé.
