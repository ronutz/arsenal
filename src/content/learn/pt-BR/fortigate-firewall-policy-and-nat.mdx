...
|---|---|---|
| Verificações de entrada | Admissão na interface, marcação de VLAN | VLAN errada ou interface fora |
| Política de DoS | Limiares de anomalia, limite por origem | Tráfego descartado antes de qualquer política |
| NAT de destino (VIP) | Reescreve o endereço de destino | Aplicado **antes** da consulta de rota |
