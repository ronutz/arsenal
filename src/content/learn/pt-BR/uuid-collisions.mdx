...
A única ressalva real é a **qualidade da aleatoriedade**. A matemática só vale se o gerador for uma fonte criptograficamente segura adequada. Uma fonte aleatória fraca ou mal semeada pode produzir repetições muito mais cedo, então o risco prático é um RNG (gerador de números aleatórios, do inglês random number generator) ruim, não o design do UUID.
