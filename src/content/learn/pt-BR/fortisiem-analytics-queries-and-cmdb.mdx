...
Buscar bem num SIEM (security information and event management) é uma habilidade de curva curta e retorno grande. A maior parte dela é saber sobre o que se pode filtrar, por que se pode agrupar, e qual contexto está disponível para cruzar.
...
É essa a diferença entre um SIEM e uma busca de logs. Um evento diz que um endereço fez algo. O CMDB (configuration management database) diz que aquele endereço é um controlador de domínio no ambiente financeiro classificado como crítico, e isso muda tanto a prioridade do evento quanto o que se faz a respeito.
