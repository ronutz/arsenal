...
Cada regra carrega, na ordem de quanto importam: **Source**, **Destination**, **Services & Applications**, **Action**, **Track** e **Install On**, mais os campos VPN, Content, Time e Comment.
