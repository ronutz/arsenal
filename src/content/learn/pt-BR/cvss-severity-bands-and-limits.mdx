...
- **Controles compensatórios.** Uma mitigação apenas de rede, uma regra de WAF (web application firewall), ou o fato de um serviço ser inacessível pela internet não muda a base em nada.
