...
O modelo mental que mantém tudo claro: **a ordem de eventos é ao longo da conexão; a prioridade é dentro de um evento.** [Explicador da ordem de eventos de iRules](/tools/f5-irules-event-order) mostra a primeira; a prioridade controla a segunda, e só importa quando você tem múltiplos handlers disputando o mesmo momento.
