...
**WAF (web application firewall)** — a mesma proteção por assinatura e comportamento do produto local, administrada como serviço.

**Mitigação de DDoS (negação de serviço distribuída)** nas camadas de rede e de aplicação, com a capacidade que é o ponto do modelo.
...
**Exportação de logs** para o seu próprio SIEM (security information and event management), para que eventos do WAF em nuvem fiquem ao lado de todo o resto em vez de num console separado que é consultado depois de um incidente, e não durante.
