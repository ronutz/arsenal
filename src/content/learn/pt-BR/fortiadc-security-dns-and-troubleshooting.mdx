...
A troca é conhecida de qualquer WAF (web application firewall). Assinaturas produzem falsos positivos onde a entrada legítima se parece com cargas de ataque, e a disciplina é delimitar exceções com estreiteza — esta assinatura, esta URL, este parâmetro — em vez de desabilitar uma regra globalmente para corrigir uma página.
