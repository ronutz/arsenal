...
O OIDC reaproveita a maquinaria do OAuth. O fluxo recomendado é o **fluxo de código de autorização com PKCE (Chave de Prova para Troca de Código, do inglês Proof Key for Code Exchange)**:
