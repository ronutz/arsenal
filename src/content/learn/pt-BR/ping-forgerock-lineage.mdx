...
A história começa na **Sun Microsystems**, que abriu o código da sua pilha de identidade no fim dos anos 2000: **OpenSSO** para gestão de acesso e federação, **OpenDS** como diretório LDAP (Lightweight Directory Access Protocol) em Java, e os começos do **OpenIDM** para provisionamento de identidade. Quando a Oracle adquiriu a Sun em 2010 e o interesse nos projetos abertos esfriou, um grupo de ex-Sun fundou a **ForgeRock** para levá-los adiante - o clássico movimento de bifurcar e fundar, e a razão de os produtos ForgeRock sempre terem parecido irmãos: nasceram na mesma casa.
