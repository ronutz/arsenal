...
concepts: ["check point", "ccsa", "identity awareness", "access role", "identity collector", "ad query", "autenticação por navegador", "portal cativo", "identity agent", "compartilhamento de identidade"]
relatedTools: []
sub: checkpoint
