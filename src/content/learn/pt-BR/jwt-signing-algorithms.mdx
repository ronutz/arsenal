...
relatedTools: ["jwt"]
relatedArticles: ["jwt-anatomy", "hmac", "jwt-security", "jwt-algorithm-confusion"]
category: identity
order: 2
status: reviewed
updated: "2026-08-10"
...
O cabeçalho de um JWT (Token Web JSON, do inglês JSON Web Token) nomeia o algoritmo usado para assiná-lo, por exemplo `"alg": "HS256"`. Esse único valor determina que tipo de chave o verificador precisa e o que a assinatura de fato prova. Os algoritmos se dividem em duas famílias, simétrica e assimétrica, e a escolha entre elas é, na verdade, uma escolha sobre *quem precisa verificar o token*.
