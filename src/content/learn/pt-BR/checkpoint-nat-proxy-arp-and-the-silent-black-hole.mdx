...
Existe um tipo específico de silêncio no Check Point que vale reconhecer de imediato. A regra de NAT está lá. A política instalou sem reclamar. O servidor atrás dela está saudável e responde localmente. E os logs do firewall não mostram nada — nem drop, nem reject, nada.
