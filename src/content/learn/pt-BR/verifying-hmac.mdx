...
Produzir um HMAC (código de autenticação de mensagem baseado em hash, do inglês hash-based message authentication code) corretamente é bem compreendido. Os erros se concentram no lado da *verificação*, onde dois problemas pegam quem acertou a criptografia mas errou a lógica ao redor: como você compara as tags, e o que uma tag válida realmente prova.
