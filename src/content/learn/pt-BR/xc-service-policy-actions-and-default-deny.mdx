...
## Negar por padrão é uma afirmação sobre as regras que você não escreveu

O valor de uma política com negação padrão está inteiramente na lacuna que ela cobre: requisições que ninguém previu. Isso a torna a única configuração cujo benefício **nunca aparece em teste**, porque teste exercita os caminhos em que alguém pensou.

A consequência prática é que a negação padrão costuma ser removida por um bom motivo e nunca reposta. Algo legítimo quebrou, o padrão foi trocado para permitir enquanto se diagnosticava, e o diagnóstico deu certo. **A mudança temporária sobrevive porque nada falha depois** — e a política passa a aplicar apenas o que suas regras negam explicitamente, que é outra postura de segurança com o mesmo nome.

**Vale conferir periodicamente se o padrão ainda é negar**, não porque muda com frequência, mas porque, quando muda, muda em silêncio e por um motivo que pareceu sensato na hora.
