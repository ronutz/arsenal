...
Cada item aponta para o mesmo lado: autenticação delegada a onde ela é mais forte (o navegador do sistema, o autenticador de plataforma), matrícula automatizada onde humanos eram o gargalo (DCR), escolha de transporte restaurada (IPsec ao lado do SSL-VPN) e o motor de políticas alcançando para fora (HTTP Connector). Para as variáveis de sessão e a mecânica de SSO (single sign-on) que tudo isso aciona no fim, a [referência de variáveis de sessão](/tools/f5-apm-session-variable-reference) e o [explicador de SSO](/tools/f5-apm-sso-explainer) continuam de onde as release notes param, e a [visão geral do 21.x](/learn/bigip-21x-whats-new) guarda o contexto completo.
