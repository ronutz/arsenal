...
O ponto central é que a codificação não é criptografia. É uma transformação reversível documentada publicamente pela F5 no artigo [K6917](https://my.f5.com/manage/s/article/K6917). Qualquer um que consiga ler o cookie, ou seja, qualquer um que receba a resposta HTTP, consegue revertê-la.
