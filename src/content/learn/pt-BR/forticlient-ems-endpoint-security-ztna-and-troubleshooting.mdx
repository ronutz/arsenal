...
O ZTNA substitui "você está na rede, portanto pode alcançar a aplicação" por "esta sessão, deste equipamento, para este usuário, pode alcançar esta aplicação".
