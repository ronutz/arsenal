...
- **Base32** usa `A`-`Z` e `2`-`7`, insensível a maiúsculas, com os caracteres confundíveis `0`, `1` e `8` removidos. É feita para valores que uma pessoa vai digitar, ditar ou armazenar sem distinguir maiúsculas, como os segredos TOTP (senha de uso único baseada em tempo, do inglês time-based one-time password) e os endereços onion.
