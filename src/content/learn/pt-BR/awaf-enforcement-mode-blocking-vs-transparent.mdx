...
Toda política do BIG-IP Advanced WAF tem um `enforcementMode`, e ele é a primeira coisa a verificar ao lê-la, porque decide se a política de fato *protege* a aplicação ou apenas a *observa*.
