...
- Quer diversidade de algoritmo ou imunidade à extensão de comprimento sem HMAC (código de autenticação de mensagem baseado em hash, do inglês hash-based message authentication code): **SHA-3** ou **SHA-512/256**.
