...
relatedTools: []
relatedArticles: ["bigip-acme-certificate-automation", "nist-pqc-standards", "quantum-threat-to-cryptography", "bigip-21x-access-identity", "bigip-tmos-version-timeline"]
category: networking
order: 1
status: reviewed
updated: "2026-07-07"
...
| 21.1.0 | 5 mai 2026 | A grande onda de recursos: PQC, persistência e proteção WAF (web application firewall) para MCP, upgrade in-place, migração para 64 bits, WAF para HTTP/3, multi-RPZ, identidade no APM | Versão long-term-stability; Standard Support reduzido para 3 anos (antes eram 4) |
...
Tudo acima foi extraído das fontes primárias da F5, recuperadas e cruzadas em 7 de julho de 2026: as notas de versão New Features do BIG-IP 21.0.0 e 21.1.0 no techdocs.f5.com, o anúncio de disponibilidade geral do 21.1 pela F5, o artigo do DevCentral "What's new in BIG-IP v21.0" e os artigos de conhecimento de ciclo de vida e descontinuação [K5903](https://my.f5.com/manage/s/article/K5903), [K9412](https://my.f5.com/manage/s/article/K9412) e [K000152956](https://my.f5.com/manage/s/article/K000152956), com o [K4309](https://my.f5.com/manage/s/article/K4309) cobrindo a posição sobre vCMP.
