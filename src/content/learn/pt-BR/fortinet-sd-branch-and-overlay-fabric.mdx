...
O **SD-Branch** é o FortiGate num site gerenciando tudo o mais naquele site: os switches por FortiLink, os pontos de acesso por CAPWAP, e a WAN por SD-WAN.
...
Duzentos sites produzem mais estado do que qualquer um lê, então a postura útil é por exceção: o que está diferente do seu modelo, o que está falhando seu SLA de desempenho, o que não se reportou.
