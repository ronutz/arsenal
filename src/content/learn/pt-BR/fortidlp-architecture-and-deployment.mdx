...
Esse segundo uso é o que separa uma implantação moderna de DLP (data loss prevention) de um motor de regras produzindo ruído, e depende inteiramente de ter histórico suficiente para saber qual era o normal.
