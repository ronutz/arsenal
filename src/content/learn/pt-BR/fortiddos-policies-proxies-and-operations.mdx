...
Uma **política de proteção** liga um conjunto de limiares e comportamentos a uma fatia definida do tráfego: tipicamente um serviço, uma sub-rede, ou uma VLAN.
...
A defesa baseada em origem pressupõe que um endereço identifica uma origem. Atrás de um CDN, de um proxy corporativo, de um NAT de operadora ou de um gateway de saída em nuvem, milhares de usuários compartilham um punhado de endereços. Todo limiar por origem passa a medir uma população, e a premissa básica do appliance é violada.
