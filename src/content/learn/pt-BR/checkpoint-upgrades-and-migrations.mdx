...
concepts: ["check point", "ccse", "atualização", "atualização in-place", "cpuse", "central deployment tool", "hotfix", "migração", "migrate export", "snapshot", "backup", "compatibilidade"]
relatedTools: []
sub: checkpoint
