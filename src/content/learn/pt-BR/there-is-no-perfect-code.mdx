...
## Onde está a evidência disto

As afirmações acima não são asserções; cada uma vem de um caso descrito neste catálogo. Duas páginas companheiras as reúnem para que possam ser lidas como conjunto e não achadas uma a uma: **[como os sistemas falham](/learn/how-systems-fail)** ordena os incidentes por onde a falha de fato morava - uma salvaguarda removida, uma premissa vencida, uma fronteira, um rollback, um alerta não lido - e **[o registro da divulgação](/learn/the-disclosure-record)** reúne os casos em que o intervalo entre saber e dizer decidiu o desfecho.
