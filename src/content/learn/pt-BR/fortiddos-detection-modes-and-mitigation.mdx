...
O raciocínio vale entender, porque é o que separa isso de uma ACL (lista de controle de acesso):

**Endereços são compartilhados e forjados.** Um bloqueio permanente num endereço que se revela um gateway NAT (tradução de endereços de rede) de operadora derruba um grande número de usuários legítimos, e o bloqueio sobrevive ao ataque por meses.
