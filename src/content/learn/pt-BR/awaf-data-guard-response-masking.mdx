...
A maior parte de uma política de WAF (web application firewall) inspeciona o que *entra*. O Data Guard é diferente: ele inspeciona o que *sai*. É a defesa do F5 AWAF - Advanced WAF (antigo BIG-IP ASM - Application Security Manager) contra o vazamento de dados sensíveis em uma resposta do servidor.
