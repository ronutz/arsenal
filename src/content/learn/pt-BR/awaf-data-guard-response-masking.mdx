...
A maior parte de uma política de WAF inspeciona o que *entra*. O Data Guard é diferente: ele inspeciona o que *sai*. É a defesa do Advanced WAF contra o vazamento de dados sensíveis em uma resposta do servidor.
