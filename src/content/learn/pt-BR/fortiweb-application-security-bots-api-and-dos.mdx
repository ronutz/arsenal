...
Isso faz das **exceções** parte de operar um WAF (web application firewall), e não sinal de falha. A disciplina é delimitá-las com estreiteza — esta assinatura, nesta URL, neste parâmetro — porque uma assinatura desabilitada globalmente para corrigir uma página remove proteção de toda parte.
