...
Um serviço SASE (secure access service edge) só protege o tráfego que chega até ele. Tudo na operação decorre disso, começando por como os usuários entram.
...
Onde o SASE carrega tráfego com requisitos de desempenho, acordos de nível de serviço medem os caminhos — latência, jitter, perda de pacotes — e direcionam o tráfego conforme. É a mesma mecânica do SLA (acordo de nível de serviço) de desempenho do SD-WAN (software-defined WAN), aplicada ao caminho entre o usuário e o ponto de presença.
