...
**Esse relato se apoia nas entrevistas dele.** Diferente da Interop, o evento deixou pouco registro acessível de forma independente — o que já é, em si, uma pequena evidência sobre como os dois são lembrados, e uma razão para atribuir a comparação à [obra de onde ela vem](/blog/the-interviews-that-caught-an-industry-in-time) em vez de apresentá-la como conhecimento comum.
