...
Um hash criptográfico comum como o SHA-256 é a ferramenta certa para integridade, mas a ferramenta **errada** para armazenar senhas, e o motivo é justamente a propriedade que o torna bom em outros lugares: ele é rápido. Um atacante que rouba um banco de dados de hashes SHA (Algoritmo de Hash Seguro, do inglês Secure Hash Algorithm)-256 de senhas pode tentar **bilhões de tentativas por segundo** em hardware comum, porque cada tentativa é apenas um hash rápido. Senhas comuns caem quase instantaneamente. A velocidade, a virtude de um hash de propósito geral, é uma desvantagem aqui.
