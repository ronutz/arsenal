...
Dentro do LTM, os eventos L7 e SSL são produzidos por **perfis** anexados ao virtual server. Essa é a dependência que o [Explicador da ordem de eventos de iRules](/tools/f5-irules-event-order) modela, e a regra é consistente:
...
É por isso que o [Explicador da ordem de eventos de iRules](/tools/f5-irules-event-order) lista esses como eventos condicionais, e não como parte do fluxo automático.
