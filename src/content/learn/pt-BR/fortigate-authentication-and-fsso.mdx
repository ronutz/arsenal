...
| LDAP (Lightweight Directory Access Protocol) | Bind contra um diretório | Active Directory ou outro LDAP existente |
| RADIUS (Remote Authentication Dial-In User Service) | Troca RADIUS, muitas vezes com MFA (autenticação multifator) atrás | Onde já existe um AAA central |
