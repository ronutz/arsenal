...
- **request** — o BIG-IP pede um certificado de cliente, mas o handshake **se completa mesmo que nenhum seja apresentado**. O resultado (presente / ausente / válido / inválido) fica disponível para um iRule ou uma política do APM agir sobre ele. Use quando quiser uma verificação leve ou lógica condicional em vez de uma barreira rígida.
