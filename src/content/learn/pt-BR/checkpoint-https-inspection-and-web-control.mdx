...
concepts: ["checkpoint", "check point", "ccsa", "https inspection", "inspeção de saída", "inspeção de entrada", "certificado", "application control", "url filtering", "appwiki", "bypass", "categorias"]
relatedTools: []
sub: checkpoint
