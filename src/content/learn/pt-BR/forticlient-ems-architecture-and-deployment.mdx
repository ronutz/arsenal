...
O **FortiClient** roda no endpoint. Conforme o licenciamento e o perfil, ele fornece o cliente VPN, proteção de endpoint, filtragem web, firewall de aplicações, varredura de vulnerabilidades e o agente ZTNA.
