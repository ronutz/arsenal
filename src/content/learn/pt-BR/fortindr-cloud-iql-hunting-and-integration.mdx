...
**Acesso por API** a detecções e eventos, para que um SIEM os ingira e correlacione com telemetria de endpoint e identidade. É isso que põe achados de rede ao lado do resto do quadro.
