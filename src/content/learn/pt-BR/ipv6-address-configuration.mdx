...
- O **EUI-64 modificado** deriva o identificador do endereço MAC (controle de acesso ao meio, do inglês media access control) da interface, o que a ferramenta pode demonstrar. Ele é estável e conveniente, mas embute o endereço de hardware em todo endereço IPv6 que o host usa, deixando um servidor remoto rastrear o dispositivo através de redes.
