...
concepts: ["checkpoint", "check point", "ccsa", "prevenção de ameaças", "ips", "anti-bot", "antivírus", "threat emulation", "threat extraction", "perfil", "prevenir", "detectar", "autonomous threat prevention"]
relatedTools: []
sub: checkpoint
...
O **IPS (sistema de prevenção de intrusão)** inspeciona o tráfego procurando exploração de vulnerabilidades conhecidas. É o motor que barra um ataque contra um serviço que você não corrigiu, que é a maior parte da razão de ele existir.
