...
Uma **VPN (rede privada virtual)** desloca sua confiança: seu provedor de acesso deixa de ver seu tráfego, e o operador da VPN passa a ver. Isso é uma melhoria real em alguns modelos de ameaça e nenhuma melhoria em outros, porque você trocou um observador por outro e o novo é uma empresa única, com logs e uma jurisdição.
