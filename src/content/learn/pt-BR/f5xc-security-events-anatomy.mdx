...
O F5 Distributed Cloud roda vários serviços de segurança na frente da sua aplicação - o WAF, Bot Defense, service policies, e proteção de API - e todos escrevem no mesmo stream de eventos de segurança. Isso é conveniente para monitoramento mas significa que um único evento pode ter vindo de qualquer um deles, com uma estrutura diferente dependendo de qual disparou. Saber ler um é a diferença entre "algo foi bloqueado" e "a signature de SQL-injection 200021069 bloqueou um GET para /search deste IP."
