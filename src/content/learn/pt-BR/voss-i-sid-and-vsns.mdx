...
concepts: ["extreme", "i-sid", "spbm", "fabric connect", "layer 2 vsn", "layer 3 vsn", "ip shortcuts", "mac-in-mac", "beb"]
...
- **Layer 3 VSN** - uma VRF (instância de Roteamento e Encaminhamento Virtual, do inglês Virtual Routing and Forwarding) é mapeada para um I-SID. É um serviço roteado em full-mesh: uma tabela de roteamento virtualizada carregada pela fabric.
