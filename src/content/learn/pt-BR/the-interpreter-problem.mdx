...
As ferramentas construídas para achar esta classe antes de ela sair - análise estática do código, teste dinâmico do sistema em execução - têm história própria na **[linhagem de SAST e DAST](/learn/sast-dast-family-history)**, inclusive por que nenhuma delas pega a junção com confiança.
...
Os formatos em que duas implementações podem discordar sobre os mesmos bytes estão reunidos em **[os formatos do meio](/learn/the-formats-in-between)**.
