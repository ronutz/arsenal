...
Decisões de acesso zero trust produzem um fluxo rico de eventos: qual usuário, qual equipamento, qual aplicação, qual postura, permitido ou negado. Alimentar isso no SIEM (security information and event management) acrescenta uma dimensão que a rede sozinha não carrega.
...
**Alinhamento com o CMDB (configuration management database).** O equipamento na fonte nova precisa ser reconhecível como o mesmo que o SIEM já conhece, ou a correlação não consegue uni-los.
