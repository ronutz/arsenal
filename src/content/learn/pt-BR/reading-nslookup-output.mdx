...
Um resolvedor trocado por DHCP, uma VPN (rede privada virtual) que instalou o próprio, um contêiner herdando outro `resolv.conf`: cada um produz respostas corretas para um resolvedor que ninguém pretendia consultar. **A resposta não está errada; a pergunta foi para um lugar inesperado**, e a saída parece inteiramente normal.
