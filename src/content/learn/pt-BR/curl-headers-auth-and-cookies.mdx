...
O [tradutor de requisições HTTP](/tools/curl-command-explainer) nunca envia a requisição, então qualquer token, senha ou cookie colado nele é decodificado no navegador e não vai a lugar nenhum.
