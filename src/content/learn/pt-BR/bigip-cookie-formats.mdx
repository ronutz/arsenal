...
Um cookie de persistência do BIG-IP sempre codifica a mesma coisa: o endereço e a porta de um membro do pool. Como ele é organizado depende de o membro ser IPv4 ou IPv6 e de estar ou não em um route domain não padrão. Os quatro formatos estão documentados no artigo [K6917](https://my.f5.com/manage/s/article/K6917) da F5. O detalhe traiçoeiro, e o que mais confunde, é que a ordem dos bytes não é a mesma em todos os formatos.
