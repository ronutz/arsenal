...
Per vedere tutto questo su una connessione reale, [The Illustrated TLS 1.3 Connection](https://tls13.xargs.org/) annota ogni byte di un vero handshake TLS 1.3, record per record e campo per campo.
