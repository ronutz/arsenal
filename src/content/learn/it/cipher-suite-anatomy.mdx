...
Per vedere dove ogni pezzo di una suite finisce davvero sul filo, [The Illustrated TLS 1.2 Connection](https://tls12.xargs.org/) e [The Illustrated TLS 1.3 Connection](https://tls13.xargs.org/) annotano handshake reali byte per byte — uno per i nomi lunghi e impacchettati, uno per quelli corti e moderni.
