...
Para makita ang lahat ng ito sa isang totoong koneksyon, ina-annotate ng [The Illustrated TLS 1.3 Connection](https://tls13.xargs.org/) ang bawat byte ng isang totoong TLS 1.3 handshake, isa-isang record at isa-isang field.
