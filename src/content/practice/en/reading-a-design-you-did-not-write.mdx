...
thesis: "You will spend more of your career inside systems somebody else designed than inside ones you designed, and the first act is not to judge the design but to recover the constraints it was answering. Most of what looks wrong is a decision whose reason has left the building — and the parts that are genuinely wrong are indistinguishable from those until you can tell the difference."
stance: practised
part: before
order: 1
