...
It answers one question: will traffic to the translated address actually reach the gateway? Not whether the policy permits it, but whether the packet arrives at all.
